...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $adb->pquery($tom);
        $tom = "INSERT INTO `vtiger_fieldmodulerel` (`fieldid`, `module`, `relmodule`, `status`, `sequence`) VALUES ('$id', 'ServiceReports', 'ServiceEngineer', NULL, NULL)";
        $adb->pquery($tom);
    } else {
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $fieldInstance->setPicklistValues(array(
            'Availability Under Reconciliation',
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array(
            'Return Sale Order Created', 'STO Awaited', 'Waiting for Shipment',
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array(
            'EM Division', 'H&P Division', 'Truck Division',
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array(
            'Under assesssment by Vendor', 'Warranty Rejected',
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array(
            'Availibilty Reconciliation Under Progress',
...
$blockInstance = Vtiger_Block::getInstance('Shortages_And_Damages', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('comment_other', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'comment_other';
        $field->column = 'comment_other';
        $field->uitype = 21;
        $field->table = 'vtiger_inventoryproductrel_other';
        $field->label = 'Description';
        $field->readonly = 1;
        ...
        echo "field is present -- comment_other In ServiceReports Module --- <br>";
    }
} else {
    echo "Block Does not exits -- Shortages_And_Damages -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('SYSTEM INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('is_recommisionreport', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'is_recommisionreport';
        $field->column = 'is_recommisionreport';
        $field->table = $invoiceModule->basetable;
        $field->label = 'Is Recommission Report';
        $field->uitype = 56;
        $field->columntype = 'INT(1) DEFAULT 0';
        $field->typeofdata = 'I~O';
        $field->displaytype = 3;
        ...
        echo "field is present -- is_recommisionreport In ServiceReports Module --- <br>";
    }
} else {
    echo "Block Does not exits -- SYSTEM INFORMATION in ServiceReports -- <br>";
}
...
$emm = null;
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('RecommissioningReports', 'SyncToExternalOnSERCreateRR'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("RecommissioningReports", "SyncToExternalOnSERCreateRR", "modules/RecommissioningReports/SyncToExternalOnSERCreateRR.php", "SyncToExternalOnSERCreateRR");
} else {
    print_r("already exits --- workflow function -- SyncToExternalOnSERCreateRR in RecommissioningReports Module <br> ");
}
$emm = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- is_submitted In RecommissioningReports Module --- <br>";
    }
} else {
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('plant_code', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'plant_code';
        $field->column = 'plant_code';
        $field->uitype = 2;
        $field->table = $invoiceModule->basetable;
        $field->label = 'Plant Code';
        $field->summaryfield = 1;
        ...
        echo "field is present -- plant_code FunctionalLocations --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_BLOCK_GENERAL_INFORMATION in FunctionalLocations -- <br>";
}
...
$blockInstance = null;
$fieldInstance = null;
$invoiceModule = Vtiger_Module::getInstance('MaintenancePlant');
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('plant_desc', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'plant_desc';
        $field->column = 'plant_desc';
        $field->uitype = 2;
        $field->table = $invoiceModule->basetable;
        $field->label = 'Plant Description';
        $field->readonly = 1;
        $field->presence = 2;
        $field->typeofdata = 'V~O';
        $field->columntype = 'VARCHAR(100)';
        ...
        echo "field is present -- plant_desc MaintenancePlant --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_BLOCK_GENERAL_INFORMATION in MaintenancePlant -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- so_creatable_qty in SalesOrder Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_ITEM_DETAILS in SalesOrder -- <br>";
}
...
$fieldName = 'usr_log_plat';
$result = $adb->pquery("SELECT $fieldName FROM vtiger_$fieldName WHERE $fieldName in (?,?)", array('Both', 'None'));
if ($adb->num_rows($result) == 0) {
    $moduleInstance = Vtiger_Module::getInstance('Contacts');
    $fieldInstance = Vtiger_Field::getInstance($fieldName, $moduleInstance);
    $fieldInstance->setPicklistValues(array('Both', 'None'));
} else {
    print_r("already exits --- 'Both', 'None' -- drop down value ");
}
$emm = null;
...
$blockInstance = Vtiger_Block::getInstance('SYSTEM INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('is_recc_submitted', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'is_recc_submitted';
        $field->column = 'is_recc_submitted';
        $field->table = $invoiceModule->basetable;
        $field->label = 'Is Recommission Report Submitted';
        $field->uitype = 56;
        $field->columntype = 'INT(1) DEFAULT 0';
        $field->typeofdata = 'I~O';
        $field->displaytype = 3;
        ...
        echo "field is present -- is_recc_submitted In ServiceReports Module --- <br>";
    }
} else {
    echo "Block Does not exits -- SYSTEM INFORMATION in ServiceReports -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_CUSTOM_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('manual_company_name', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'manual_company_name';
        $fieldInstance->label = 'Organisation Name';
        $fieldInstance->table = 'vtiger_ticketcf';
        $fieldInstance->column = 'manual_company_name';
        $fieldInstance->uitype = '2';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(250)';
        $fieldInstance->defaultvalue = NULL;
        ...
        echo "field is already Present --- manual_company_name in HelpDesk Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_CUSTOM_INFORMATION  in HelpDesk -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- manual_company_name in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Ticket Details  in ServiceReports -- <br>";
}
...
$emm = null;
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('ReturnSaleOrders', 'updateConsignmentNoAndDate'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("ReturnSaleOrders", "updateConsignmentNoAndDate", "modules/ReturnSaleOrders/updateConsignmentNoAndDate.php", "updateConsignmentNoAndDate");
} else {
    print_r("already exits --- workflow function -- updateConsignmentNoAndDate in ReturnSaleOrders Module <br> ");
}
$emm = null;
...
$blockInstance = Vtiger_Block::getInstance('SYSTEM INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('total_breakdown_hours', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'total_breakdown_hours';
        $fieldInstance->column = 'total_breakdown_hours';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable . 'cf';
        $fieldInstance->label = 'Total BreakDown Hours';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'NN~O';
        $fieldInstance->columntype = 'DECIMAL(10,5)';
        ...
        echo "field is already Present --- total_breakdown_hours in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- SYSTEM INFORMATION -- <br>";
}
...
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('EquipmentAvailability');
$blockInstance = Vtiger_Block::getInstance('System_BreakDown_Calculation', $moduleInstance);
if ($blockInstance) {
    echo " block does exits --- System_BreakDown_Calculation   -- <br>";
} else {
    $blockInstance = new Vtiger_Block();
    $blockInstance->label = 'System_BreakDown_Calculation';
    $moduleInstance->addBlock($blockInstance);
}
$moduleInstance = null;
$blockInstance = null;
...
$blockInstance = Vtiger_Block::getInstance('System_BreakDown_Calculation', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('system_equi_avail_percent', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'system_equi_avail_percent';
        $fieldInstance->column = 'system_equi_avail_percent';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'System Equipment Availability %';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'N~O';
        $fieldInstance->columntype = 'DECIMAL(7,3)';
        ...
        echo "field is already Present --- system_equi_avail_percent  in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- System_BreakDown_Calculation -- <br>";
}
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
...
$blockInstance = Vtiger_Block::getInstance('System_BreakDown_Calculation', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('system_beml_total_breakdown', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'system_beml_total_breakdown';
        $fieldInstance->column = 'system_beml_total_breakdown';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'System BreakDown Under BEML Account';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'NN~O';
        $fieldInstance->columntype = 'DECIMAL(10,5)';
        ...
        echo "field is already Present --- system_beml_total_breakdown in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- System_BreakDown_Calculation -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('System_BreakDown_Calculation', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('system_cust_total_breakdown', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'system_cust_total_breakdown';
        $fieldInstance->column = 'system_cust_total_breakdown';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'System BreakDown Under Customer Account';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'NN~O';
        $fieldInstance->columntype = 'DECIMAL(10,5)';
        ...
        echo "field is already Present --- system_cust_total_breakdown in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- System_BreakDown_Calculation -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('System_BreakDown_Calculation', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('system_total_breakdown', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'system_total_breakdown';
        $fieldInstance->column = 'system_total_breakdown';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'System Total BreakDown';
        $fieldInstance->summaryfield = 1;
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'NN~O';
        ...
        echo "field is already Present --- system_total_breakdown in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- System_BreakDown_Calculation -- <br>";
}
...
$emm = null;
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('RecommissioningReports', 'copyAllLineItemAfterCreation'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("RecommissioningReports", "copyAllLineItemAfterCreation", "modules/RecommissioningReports/copyAllLineItemAfterCreation.php", "copyAllLineItemAfterCreation");
} else {
    print_r("already exits --- workflow function -- copyAllLineItemAfterCreation in RecommissioningReports Module <br> ");
}
$emm = null;
...
$blockInstance = Vtiger_Block::getInstance('Sub_Assembly_Details', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('sad_aggregate_serial_no', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'sad_aggregate_serial_no';
        $fieldInstance->label = 'Aggregate Serial No';
        $fieldInstance->table = "vtiger_servicereports_other";
        $fieldInstance->column = 'sad_aggregate_serial_no';
        $fieldInstance->uitype = '999';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('AVAILABLE', 'NOT AVAILABLE'));
    } else {
        echo "field is already Present --- sad_aggregate_serial_no in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Sub_Assembly_Details -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('Sub_Assembly_Spares_Parts_Details', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('saspd_aggregate_serial_no', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'saspd_aggregate_serial_no';
        $field->column = 'saspd_aggregate_serial_no';
        $field->table = "vtiger_servicereports_other";
        $field->label = 'Aggregate Serial No.';
        $field->readonly = 1;
        $field->displaytype = 1;
        $field->uitype = '999';
        $field->presence = '0';
        ...
        $blockInstance->addField($field);
        $field->setPicklistValues(array('AVAILABLE', 'NOT AVAILABLE'));
    } else {
        echo "field is present -- saspd_aggregate_serial_no in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Sub_Assembly_Spares_Parts_Details in ServiceReports -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_ITEM_DETAILS', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('analysis_done_doc', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'analysis_done_doc';
        $field->column = 'analysis_done_doc';
        $field->uitype = 69;
        $field->table = 'vtiger_inventoryproductrel';
        ...
        echo "field is present -- analysis_done_doc in ReturnSaleOrders --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_ITEM_DETAILS in ReturnSaleOrders -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_CUSTOM_INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('org_code', $invoiceModule);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'org_code';
        $fieldInstance->label = 'Organisation Code';
        $fieldInstance->table = $invoiceModule->basetable;
        $fieldInstance->column = 'org_code';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array("CCL"));
    } else {
        echo "field is present -- org_code in Accounts --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_CUSTOM_INFORMATION in Accounts -- <br>";
}
...
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('MaintenancePlant');
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('region_code', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'region_code';
        $fieldInstance->label = 'Region Code';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'region_code';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('MA', 'MB', 'MC', 'MF', 'MG', 'MH', "ML", "MN", 'MR', "MS", "MV", "MW"));
    } else {
        echo "field is already Present --- region_code in MaintenancePlant Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION in MaintenancePlant -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_SYSTEM_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('eq_division', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'eq_division';
        $fieldInstance->label = 'DIVISION';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'eq_division';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('EM DIVISION', 'TRUCK DIVISION'));
    } else {
        echo "field is already Present --- eq_division in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_SYSTEM_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('SYSTEM INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('pdc_date', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'pdc_date';
        $fieldInstance->label = 'PDC';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'pdc_date';
        $fieldInstance->uitype = 5;
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'D~O';
        $fieldInstance->columntype = 'DATE';
        ...
        echo "field is already Present --- pdc_date in ServiceReports Module --- <br>";
    }
} else {
    echo "block does not exits --- SYSTEM INFORMATION in ServiceReports-- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('SYSTEM INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('servicereportsid', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'servicereportsid';
        $field->column = 'servicereportsid';
        $field->uitype = 10;
        $field->table = $invoiceModule->basetable.'cf';
        $field->label = 'Service Report NUmber';
        $field->readonly = 1;
        ...
        $tom = "INSERT INTO `vtiger_fieldmodulerel` (`fieldid`, `module`, `relmodule`, `status`, `sequence`) VALUES ('$id', 'RecommissioningReports', 'ServiceReports', NULL, NULL)";
        $adb->pquery($tom);
    } else {
        echo "field is present -- servicereportsid  in RecommissioningReports--- <br>";
    }
} else {
    echo "Block Does not exits -- SYSTEM INFORMATION in RecommissioningReports -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('ACTION_TAKEN', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('off_on_account_of_sys', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'off_on_account_of_sys';
        $fieldInstance->label = 'Off Road on Account of System Field';
        $fieldInstance->table = $moduleInstance->basetable . 'cf';
        $fieldInstance->column = 'off_on_account_of_sys';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        ...
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('TRUCK','H&P','EM', 'ENGINE', 'CUSTOMER', 'VENDOR'));
    } else {
        echo "field is already Present --- off_on_account_of_sys in ServiceReports Module --- <br>";
    }
} else {
    echo "Block does not exits --- ACTION_TAKEN -- <br>";
}
...
$emm = null;
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('ServiceReports', 'calSystemField'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("ServiceReports", "calSystemField", "modules/ServiceReports/calSystemField.php", "calSystemField");
} else {
    print_r("already exits --- workflow function -- calSystemField in ServiceReports Module <br> ");
}
$emm = null;

$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('ServiceEngineer', 'SendSMSOnRejection'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("ServiceEngineer", "SendSMSOnRejection", "modules/ServiceEngineer/SendSMSOnRejection.php", "SendSMSOnRejection");
} else {
    print_r("already exits --- workflow function -- SendSMSOnRejection <br> ");
}
$emm = null;
...
$blockInstance = Vtiger_Block::getInstance('Customer_Warranty', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('last_sr_status', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'last_sr_status';
        $fieldInstance->label = 'Last Service Request Equipment Status';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'last_sr_status';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->displaytype = 2;
        ...
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('On Road', 'Running with Problem', 'Off Road'));
    } else {
        echo "field is already Present --- last_sr_status in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- Customer_Warranty in Equipment -- <br>";
}
...
//Add new field in Announcements module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('Announcements');
$blockInstance = Vtiger_Block::getInstance('Announcements Information', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('anno_flashtext', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'anno_flashtext';
        $fieldInstance->label = 'Flash Text';
        $fieldInstance->table = 'vtiger_announcements';
        $fieldInstance->column = 'anno_flashtext';
        $fieldInstance->uitype = '21';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'TEXT';
        ...
        echo "field is already Present --- anno_flashtext in Announcements Module --- <br>";
    }
} else {
    echo "Block does not exits --- ACTION_TAKEN -- <br>";
}
...
$blockInstance = null;
$fieldInstance = null;
$invoiceModule = Vtiger_Module::getInstance('InternalTickets');
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('service_engineerid', $invoiceModule);
    if (!$fieldInstance) {
        ...
        // ------------------------invoga
        $tom = "INSERT INTO `vtiger_fieldmodulerel` (`fieldid`, `module`, `relmodule`, `status`, `sequence`) VALUES ('$id', 'InternalTickets', 'ServiceEngineer', NULL, NULL)";
        $adb->pquery($tom);
    } else {
        echo "field is present -- service_engineerid  in InternalTickets--- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_BLOCK_GENERAL_INFORMATION in InternalTickets -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
$blockInstance = Vtiger_Block::getInstance('LBL_ITEM_DETAILS', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('manual_part_no', $moduleInstance);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'manual_part_no';
        $field->column = 'manual_part_no';
        $field->uitype = 2;
        $field->table = 'vtiger_inventoryproductrel';
        $field->label = 'Manual Part Number';
        $field->readonly = 1;
        $field->presence = 2;
        $field->typeofdata = 'V~O';
        $field->columntype = 'VARCHAR(250)';
        ...
        echo "field is present -- manual_part_no In ServiceReports Module --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_ITEM_DETAILS in ServiceReports -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('PARTS_FROM_SR', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('manual_part_no', $invoiceModule);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'manual_part_no';
        $fieldInstance->column = 'manual_part_no';
        $fieldInstance->uitype = 2;
        $fieldInstance->table = 'vtiger_inventoryproductrel_other';
        $fieldInstance->label = 'Manual Part Number';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(250)';
        ...
        echo "field is present -- manual_part_no In ServiceOrders Module --- <br>";
    }
} else {
    echo "Block Does not exits -- PARTS_FROM_SR in ServiceOrders -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_ITEM_DETAILS', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('manual_part_no_so', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'manual_part_no_so';
        $field->column = 'manual_part_no_so';
        $field->uitype = 2;
        $field->table = 'vtiger_inventoryproductrel';
        $field->label = 'Manual Part Number';
        $field->readonly = 1;
        ...
        echo "field is present -- manual_part_no_so in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- ServiceOrders in ServiceReports -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('Announcements Information', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('anno_youtubeurl', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'anno_youtubeurl';
        $fieldInstance->label = 'You Tube URL';
        $fieldInstance->table = 'vtiger_announcements';
        $fieldInstance->column = 'anno_youtubeurl';
        $fieldInstance->uitype = '2';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        ...
        echo "field is already Present --- anno_youtubeurl in Announcements Module --- <br>";
    }
} else {
    echo "Block does not exits --- ACTION_TAKEN -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('SYSTEM INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('report_status', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'report_status';
        $fieldInstance->label = 'Report Status';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'report_status';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '2';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('Submitted', 'In Progress'));
    } else {
        echo "field is already Present --- report_status in RecommissioningReports Module --- <br>";
    }
} else {
    echo "Block does not exits --- SYSTEM INFORMATION -- <br>";
}
...
if (!Vtiger_Utils::CheckTable('vtiger_crm_sqlmigrater')) {
    Vtiger_Utils::CreateTable(
        'vtiger_crm_sqlmigrater',
        '(id int(25) NOT NULL AUTO_INCREMENT,
        sqlquerynumber int(19) NOT NULL,
        PRIMARY KEY (id))',
        true
    );
    echo '<br> vtiger_crm_sqlmigrater table is created <br>';
} else {
    echo '<br> vtiger_crm_sqlmigrater table is already exits <br>';
}

$sqlQuryNumber = 1;
$result = $adb->pquery("SELECT sqlquerynumber FROM vtiger_crm_sqlmigrater WHERE sqlquerynumber=?", array($sqlQuryNumber));
if ($adb->num_rows($result) == 0) {
    $sql = 'update vtiger_recommissioningreports set report_status = "In Progress" where is_submitted = 0';
    $adb->pquery($sql, array());

    $sql = 'update vtiger_recommissioningreports set report_status = "Submitted" where is_submitted = 1';
    $adb->pquery($sql, array());

    $sql = 'insert into vtiger_crm_sqlmigrater(sqlquerynumber) values(?)';
    $adb->pquery($sql, array($sqlQuryNumber));
} else {
    print_r("Query Already Executred ------> $sqlQuryNumber");
}
$emm = NULL;
...
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('InternalTickets');
$blockInstance = Vtiger_Block::getInstance('Description Details', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('inthelp_description', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'inthelp_description';
        $fieldInstance->label = 'Issue Solved Description';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'inthelp_description';
        ...
        echo "field is already Present --- inthelp_description in InternalTickets Module --- <br>";
    }
} else {
    echo "Block does not exits --- SYSTEM INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('inthelp_status', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'inthelp_status';
        $fieldInstance->label = 'Status';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'inthelp_status';
        $fieldInstance->uitype = '15';
        $fieldInstance->presence = '2';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues( Array ('Open','Closed','Re-Open') );
    } else {
        echo "field is already Present --- inthelp_status in InternalTickets Module --- <br>";
    }
} else {
    echo "Block does not exits --- SYSTEM INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('SYSTEM INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('is_enginereport', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'is_enginereport';
        $field->column = 'is_enginereport';
        $field->table = $invoiceModule->basetable;
        $field->label = 'Is Engine Report';
        $field->uitype = 56;
        $field->columntype = 'INT(1) DEFAULT 0';
        $field->typeofdata = 'I~O';
        $field->displaytype = 3;
        ...
        echo "field is present -- is_enginereport In ServiceReports Module --- <br>";
    }
} else {
    echo "Block Does not exits -- SYSTEM INFORMATION in ServiceReports -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_USERLOGIN_ROLE', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('req_for_del', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'req_for_del';
        $field->column = 'req_for_del';
        $field->table = $invoiceModule->basetable;
        $field->label = 'Is Profile Delete Requested?';
        $field->uitype = 56;
        $field->columntype = 'INT(1) DEFAULT 0';
        $field->typeofdata = 'I~O';
        $field->displaytype = 1;
        ...
        echo "field is present -- req_for_del In ServiceEngineer Module --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_USERLOGIN_ROLE in ServiceEngineer -- <br>";
}
...
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('HelpDesk');
$blockInstance = Vtiger_Block::getInstance('Feedback And Rating', $moduleInstance);
if ($blockInstance) {
    echo " block does exits --- Feedback And Rating  -- <br>";
} else {
    $blockInstance = new Vtiger_Block();
    $blockInstance->label = 'Feedback And Rating';
    $moduleInstance->addBlock($blockInstance);
}
$moduleInstance = null;
$blockInstance = null;
...
$fieldInstance = null;
$invoiceModule = Vtiger_Module::getInstance('HelpDesk');
$blockInstance = Vtiger_Block::getInstance('Feedback And Rating', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('rating', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'rating';
        $field->column = 'rating';
        ...
        echo "field is present -- rating HelpDesk --- <br>";
    }
} else {
    echo "Block Does not exits -- Feedback And Rating in HelpDesk -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- req_for_del In Contacts Module --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_CUSTOM_INFORMATION in Contacts -- <br>";
}
...
WHERE module_name=? AND method_name=?", array('HelpDesk', 'SendNotification'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("HelpDesk", "SendNotification", 
    "modules/HelpDesk/SendNotification.php", "SendNotification");
} else {
    print_r("already exits --- workflow function -- SendNotification in
    HelpDesk Module <br> ");
}
$emm = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- chargeable_outside_war In Accounts Module --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_ACCOUNT_INFORMATION in Accounts -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
$blockInstance = null;
$fieldInstance = null;
$invoiceModule = Vtiger_Module::getInstance('Documents');
$blockInstance = Vtiger_Block::getInstance('LBL_NOTE_INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('show_to_customer', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'show_to_customer';
        $field->column = 'show_to_customer';
        $field->table = $invoiceModule->basetable;
        $field->label = 'Show For Customer';
        $field->uitype = '999';
        $field->columntype = 'VARCHAR(100)';
        $field->typeofdata = 'V~O';
        $field->displaytype = 1;
        ...
        echo "field is present -- show_to_customer In Documents Module --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_NOTE_INFORMATION in Sales Order -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('eq_availabilty_status', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'eq_availabilty_status';
        $fieldInstance->label = 'Availabilty Status';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'eq_availabilty_status';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        ...
        echo "field is already Present --- eq_availabilty_status in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION in EquipmentAvailability -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_NOTE_INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('show_to_customer_new', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'show_to_customer_new';
        $field->column = 'show_to_customer_new';
        $field->table = $invoiceModule->basetable;
        $field->label = 'Show For Customer';
        $field->uitype = '999';
        $field->columntype = 'VARCHAR(100)';
        ...
        $field->displaytype = 1;
        $blockInstance->addField($field);
        $field->setPicklistValues(array('Customer', 'BEML User', 'Both'));
    } else {
        echo "field is present -- show_to_customer_new In Documents Module --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_NOTE_INFORMATION in Sales Order -- <br>";
}
...
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('folder_type', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'folder_type';
        $fieldInstance->label = 'Folder Type';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'folder_type';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $field->quickcreate = 3;
        ...
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('Service Bulletin', 'Equipment Manual', 
        'Product Catalog','Trouble Shooting', 'Scheduled Maintenance Check'));
    } else {
        echo "field is already Present --- folder_type in Contacts Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_NOTE_INFORMATION -- <br>";
}
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
...
$blockInstance = Vtiger_Block::getInstance('SYSTEM INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('customer_sign', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'customer_sign';
        $field->column = 'customer_sign';
        $field->uitype = 69;
        $field->table = $invoiceModule->basetable;
        ...
        echo "field is present -- customer_sign in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- VISUAL_CHECKS in ServiceReports -- <br>";
}
...
// ALTER TABLE `vtiger_equipment` ADD INDEX `vtiger_equipment_functional_loc_index` (`functional_loc`)
// ALTER TABLE `vtiger_crmentityrel` ADD INDEX `vtiger_crmentityrel_module_index` (`module`);
// ALTER TABLE `vtiger_crmentityrel` ADD INDEX `vtiger_crmentityrel_relmodule_index` (`relmodule`);
...
$blockInstance = Vtiger_Block::getInstance('SYSTEM INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('service_eng_sign', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'service_eng_sign';
        $field->column = 'service_eng_sign';
        $field->uitype = 69;
        $field->table = $invoiceModule->basetable;
        $field->label = 'Service Engineer Signature';
        $field->presence = 2;
        $field->typeofdata = 'V~O';
        $field->columntype = 'VARCHAR(150)';
        $field->displaytype = 1;
        ...
        echo "field is present -- service_eng_sign in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- VISUAL_CHECKS in ServiceReports -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('SYSTEM INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('customer_designaion', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'customer_designaion';
        $fieldInstance->label = 'Customer Designation';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'customer_designaion';
        ...
        echo "field is already Present --- customer_designaion in ServiceReports Module --- <br>";
    }
} else {
    echo "Block does not exits --- SYSTEM INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('SYSTEM INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('customer_sign_name', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'customer_sign_name';
        $fieldInstance->label = 'Customer Name';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'customer_sign_name';
        $fieldInstance->uitype = '1';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        ...
        echo "field is already Present --- customer_sign_name in ServiceReports Module --- <br>";
    }
} else {
    echo "Block does not exits --- SYSTEM INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('SYSTEM INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('customer_remarks', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'customer_remarks';
        $fieldInstance->label = 'Customer Remarks';
        $fieldInstance->table = $moduleInstance->basetable . "cf";
        $fieldInstance->column = 'customer_remarks';
        $fieldInstance->uitype = '21';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'TEXT';
        $fieldInstance->defaultvalue = NULL;
        ...
        echo "field is already Present --- customer_remarks in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- SYSTEM INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_TICKET_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('ticket_close_date', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'ticket_close_date';
        $fieldInstance->label = 'Ticket Close Date';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'ticket_close_date';
        $fieldInstance->uitype = 5;
        $fieldInstance->typeofdata = 'D~O';
        $fieldInstance->columntype = 'DATE';
        $fieldInstance->displaytype = 2;
        ...
        echo "field is already Present --- ticket_close_date in HelpDesk Module --- <br>";
    }
} else {
    echo "block does not exits --- LBL_TICKET_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_TICKET_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('ticket_recommision_date', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'ticket_recommision_date';
        $fieldInstance->label = 'Ticket Recommision Date';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'ticket_recommision_date';
        $fieldInstance->uitype = 5;
        $fieldInstance->typeofdata = 'D~O';
        $fieldInstance->displaytype = 2;
        $fieldInstance->columntype = 'DATE';
        ...
        echo "field is already Present --- ticket_recommision_date in HelpDesk Module --- <br>";
    }
} else {
    echo "block does not exits --- LBL_TICKET_INFORMATION -- <br>";
}
...
if (Vtiger_Utils::CheckTable('vtiger_ticket_mttr')) {
    print_r("================Table Exits vtiger_ticket_mttr ===============");
} else {
    print_r("================Table Does Not Exits vtiger_ticket_mttr ===============");
    Vtiger_Utils::CreateTable(
        'vtiger_ticket_mttr',
        '(
        `id` int(19) DEFAULT NULL,
        `lineitem_id` int(11) NOT NULL AUTO_INCREMENT,
        `from_val` VARCHAR(100) NULL DEFAULT NULL,
        `to_val` VARCHAR(100) NULL DEFAULT NULL,
        PRIMARY KEY (`lineitem_id`),
        KEY `vtiger_ticket_mttr_id_idx` (`id`),
        CONSTRAINT `fk_crmid_vtiger_ticket_mttr` FOREIGN KEY (`id`) REFERENCES `vtiger_crmentity` (`crmid`) ON DELETE CASCADE
      ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8',
        false
    );
}

// ALTER TABLE `vtiger_ticket_mttr` ADD `minutes_val` INT(19) NOT NULL AFTER `to_val`;

$emm = null;
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod 
WHERE module_name=? AND method_name=?", array('HelpDesk', 'InsertStatsChangeEvent'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("HelpDesk", "InsertStatsChangeEvent",
     "modules/HelpDesk/InsertStatsChangeEvent.php", "InsertStatsChangeEvent");
} else {
    print_r("already exits --- workflow function --
     InsertStatsChangeEvent in Accounts Module <br> ");
}
$emm = null;

if (Vtiger_Utils::CheckTable('status_history')) {
    print_r("================ Table Exits status_history ===============");
} else {
    print_r("================Table Does Not Exits status_history ===============");
    Vtiger_Utils::CreateTable(
        'status_history',
        '(
            `id` int(11) NOT NULL AUTO_INCREMENT,
            `entity_id` int(11) NOT NULL,
            `old_status` varchar(50) COLLATE utf8_bin DEFAULT NULL,
            `new_status` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
$result = $adb->pquery("SELECT sqlquerynumber FROM vtiger_crm_sqlmigrater WHERE sqlquerynumber=?", array($sqlQuryNumber));
if ($adb->num_rows($result) == 0) {
    $sql = 'ALTER TABLE `vtiger_users` ADD `session_name` TEXT NOT NULL AFTER `unique_id`';
    $adb->pquery($sql, array());
...
if ($adb->num_rows($result) == 0) {
    ...
    if ($fieldInstance) {
        $fieldInstance->setPicklistValues(array('Closed after Re-commissioning'));
    } else {
        echo "field is already Present --- ticketstatus in HelpDesk Module --- <br>";
    }
    $moduleInstance = null;
    $blockInstance = null;
    $fieldInstance = null;
...
$blockInstance = Vtiger_Block::getInstance('LBL_TICKET_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('time_insec_to_resp', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'time_insec_to_resp';
        $fieldInstance->column = 'time_insec_to_resp';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Time In Minutes To Respond';
        $fieldInstance->typeofdata = 'I~O';
        $fieldInstance->columntype = 'INT(15)';
        $fieldInstance->displaytype = 2;
        $blockInstance->addField($fieldInstance);
    } else {
        echo "field is already Present --- time_insec_to_resp in HelpDesk Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_TICKET_INFORMATION in HelpDesk -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_TICKET_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('time_insec_to_repair', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'time_insec_to_repair';
        $fieldInstance->column = 'time_insec_to_repair';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Time In Minutes To Repair';
        $fieldInstance->typeofdata = 'I~O';
        $fieldInstance->columntype = 'INT(15)';
        $fieldInstance->displaytype = 2;
        $blockInstance->addField($fieldInstance);
    } else {
        echo "field is already Present --- time_insec_to_repair in HelpDesk Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_TICKET_INFORMATION in HelpDesk -- <br>";
}
...
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod 
WHERE module_name=? AND method_name=?", array('ServiceReports', 'UpdateResponseTime'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("ServiceReports", "UpdateResponseTime",
     "modules/ServiceReports/UpdateResponseTime.php", "UpdateResponseTime");
} else {
    print_r("already exits --- workflow function --
     UpdateResponseTime in Accounts Module <br> ");
}
$emm = null;
$emm = null;
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod 
WHERE module_name=? AND method_name=?", array('ServiceReports', 'InsertStatsChangeEventSR'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("ServiceReports", "InsertStatsChangeEventSR",
     "modules/ServiceReports/InsertStatsChangeEventSR.php", "InsertStatsChangeEventSR");
} else {
    print_r("already exits --- workflow function --
    InsertStatsChangeEventSR in Accounts Module <br> ");
}
$emm = null;