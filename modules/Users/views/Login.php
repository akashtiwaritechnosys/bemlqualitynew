	...
	function process (Vtiger_Request $request) {
		...
		if ($error) {
			switch ($error) {
				...
				case 'sessionHijackmsg'	:	$message = 'Session Access Denied';	break;
				case 'sessionExipired'	:	$message = 'Session Expired';	break;
				case 'sessionLifeExipired'	:	$message = 'Session lifetime exceeded.';	break;
				case 'concurrent'	:	$message = 'Concurrent Login Detected ';	break;
				case 'fingerprintdoestexists'	:	$message = 'Finger Print Not Detected ';	break;
			}
		} else if ($mailStatus) {
