...
class Vtiger_Record_Model extends Vtiger_Base_Model {
	...
	public function getDetailViewUrl() {
		$module = $this->getModule();
		return 'index.php?module='.$this->getModuleName().'&view='.$module->getDetailViewName().'&record='.$this->getId() . '&fingerprint='.$_REQUEST['fingerprint'];
	}
	...
	public function getImageDetails() {
		...
		if ($recordId) {
			$sql = "SELECT vtiger_attachments.*, vtiger_crmentity.setype FROM vtiger_attachments
						...
						WHERE vtiger_crmentity.setype In (?,?) and vtiger_seattachmentsrel.crmid = ?";

			$result = $db->pquery($sql, array($this->getModuleName().' Attachment',$this->getModuleName().' Image',$recordId));
