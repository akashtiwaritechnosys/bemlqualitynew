...
class Vtiger_Module_Model extends Vtiger_Module {
	...
	public function getDefaultUrl() {
		return 'index.php?module='.$this->get('name').'&view='.$this->getDefaultViewName() . '&fingerprint='.$_REQUEST['fingerprint'];
	}
	...
	public function getDetailViewUrl($id) {
		return 'index.php?module='. $this->get('name').'&view='.$this->getDetailViewName().'&record='.$id . '&fingerprint='.$_REQUEST['fingerprint'];
	}
	/**
