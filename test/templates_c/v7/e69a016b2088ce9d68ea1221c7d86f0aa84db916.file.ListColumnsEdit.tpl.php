<?php /* Smarty version Smarty-3.1.7, created on 2024-12-15 13:59:21
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Vtiger/ListColumnsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1369356727675ee0b9eefd98-95093959%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e69a016b2088ce9d68ea1221c7d86f0aa84db916' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Vtiger/ListColumnsEdit.tpl',
      1 => 1733391286,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1369356727675ee0b9eefd98-95093959',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_675ee0b9f06fb',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_675ee0b9f06fb')) {function content_675ee0b9f06fb($_smarty_tpl) {?>
...
</span></div><?php } ?></div></div></div><?php } ?><div class="instafilta-target item-dummy hide"><span class="fieldLabel"></span></div></div></div></div></div></div></div></div><div class="modal-footer "><button class="btn btn-soft-success saveButton" type="submit" name="saveButton"><strong><?php echo vtranslate('LBL_UPDATE_LIST');?>
