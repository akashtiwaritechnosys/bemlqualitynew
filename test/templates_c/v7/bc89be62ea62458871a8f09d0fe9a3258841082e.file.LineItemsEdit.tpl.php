<?php /* Smarty version Smarty-3.1.7, created on 2023-11-30 05:54:34
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/ReturnSaleOrders/partials/LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:828653090639c54693cb6c8-31444063%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bc89be62ea62458871a8f09d0fe9a3258841082e' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/ReturnSaleOrders/partials/LineItemsEdit.tpl',
      1 => 1699267091,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '828653090639c54693cb6c8-31444063',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_639c54694090c',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_639c54694090c')) {function content_639c54694090c($_smarty_tpl) {?><?php  $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->_loop = false;
...
</strong></td><?php }?><?php if ($_smarty_tpl->tpl_vars['PRODUCT_EDITABLE']->value){?><td><span class="redColor">*</span><strong><?php echo vtranslate('Item Name',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></td><?php }?><td><strong><?php echo vtranslate('LBL_QTY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></td><?php if ($_smarty_tpl->tpl_vars['PRODUCT_EDITABLE']->value){?><td><strong><?php echo vtranslate('Description',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></td><?php if (($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['fieldlabel']=='Present Status'&&count($_smarty_tpl->tpl_vars['SUB_LINEITEM_CUSTOM_FIELDS']->value)>0)||($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['fieldlabel']=='Action Taken by DSM'&&count($_smarty_tpl->tpl_vars['SUB2_LINEITEM_CUSTOM_FIELDS']->value)>0)){?><td> <?php echo $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['fieldlabel'];?>
 Qty </td><?php }?><?php } ?></tr><tr id="row0" class="hide lineItemCloneCopy" data-row-num="0"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsContent.tpl",'ReturnSaleOrders'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>0,'data'=>array(),'IGNORE_UI_REGISTRATION'=>true), 0);?>
