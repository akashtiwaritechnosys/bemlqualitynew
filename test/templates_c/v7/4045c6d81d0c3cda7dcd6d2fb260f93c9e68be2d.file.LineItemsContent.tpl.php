<?php /* Smarty version Smarty-3.1.7, created on 2023-11-30 05:53:53
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/SalesOrder/partials/LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:193865059463a4b6743d62f6-20652842%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4045c6d81d0c3cda7dcd6d2fb260f93c9e68be2d' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/SalesOrder/partials/LineItemsContent.tpl',
      1 => 1699267091,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '193865059463a4b6743d62f6-20652842',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_63a4b67444bd6',
  'variables' => 
  array (
    'row_no' => 0,
    'entityIdentifier' => 0,
...
" /></br></br><button class="duplicate">Duplicate</button></td><?php if ($_smarty_tpl->tpl_vars['IMAGE_EDITABLE']->value){?><td class='lineItemImage' style="text-align:center;"><?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['image']->value]){?>	<img src='<?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['image']->value];?>
...
"data-rule-required=true <?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['productName']->value])){?> disabled="disabled" <?php }?>><input type="hidden" id="<?php echo $_smarty_tpl->tpl_vars['hdnProductId']->value;?>
...
<?php }?></div><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['COMMENT_EDITABLE']->value){?><div><br><textarea readonly style="background-color:#eeeeee!important" id="<?php echo $_smarty_tpl->tpl_vars['comment']->value;?>
...
" type="text" class="qty smallInputBox inputElement"data-rule-required=true data-extraname="qty" style="pointer-events: none;background-color:#eeeeee" readonly data-rule-positive=true data-rule-greater_than_zero=true value="<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value])){?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value];?>
...
<?php }else{ ?>0<?php }?></span><?php }?></td><?php $_smarty_tpl->tpl_vars["dateFormat"] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('date_format'), null, 0);?><?php  $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->_loop = false;
...
?><td  <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value["hiddenSpecial"]==true){?> class="hide" <?php }?>><?php $_smarty_tpl->tpl_vars["fieldName"] = new Smarty_variable($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['fieldname'], null, 0);?><?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='5'){?><div class="input-group inputElement" style="margin-bottom: 3px"><input  id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
...
'<?php }?><?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value["isMandatory"]==true){?> data-rule-required="true" <?php }?><?php if (count($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['validator'])){?>data-specific-rules='<?php echo ZEND_JSON::encode($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value["validator"]);?>
'<?php }?>  data-rule-date="true" /><span class="input-group-addon"><i class="fa fa-calendar "></i></span></div><?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='21'||$_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='2'){?><?php if ($_smarty_tpl->tpl_vars['fieldName']->value=='part_description'){?><div><textarea readonly style="background-color:#eeeeee!important" <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['editable']==0){?> readonly style="pointer-events: none;background-color:#eeeeee" <?php }?> <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value["isMandatory"]==true){?> data-rule-required="true" <?php }?> id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" class="<?php echo $_smarty_tpl->tpl_vars['fieldName']->value;?>
"><?php echo decode_html($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value]);?>
</textarea></div><?php }else{ ?><div><textarea <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['editable']==0){?> readonly style="pointer-events: none;background-color:#eeeeee" <?php }?> <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value["isMandatory"]==true){?> data-rule-required="true" <?php }?> id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" class="<?php echo $_smarty_tpl->tpl_vars['fieldName']->value;?>
"><?php echo decode_html($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value]);?>
</textarea></div><?php }?><?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='7'){?><div id="DivCla<?php echo $_smarty_tpl->tpl_vars['fieldName']->value;?>
"><input  <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value["hiddenSpecial"]==true){?> type="hiden" <?php }?><?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value["isMandatory"]==true){?> data-rule-required="true" <?php }?>id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
...
"<?php if ($_smarty_tpl->tpl_vars['fieldName']->value=='final_qty'){?>class="inputElement <?php echo $_smarty_tpl->tpl_vars['fieldName']->value;?>
...
"<?php }?><?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['editable_special']==true){?> readonly <?php }?>data-extraname="<?php echo $_smarty_tpl->tpl_vars['fieldName']->value;?>
" style="min-width: 100px;<?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['editable_special']==true){?>pointer-events: none;background-color:#eeeeee"<?php }?>"></div><?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='16'){?><select <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value["isMandatory"]==true){?> data-rule-required="true" <?php }?>style="min-width: 150px;" id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" data-fieldname="<?php echo $_smarty_tpl->tpl_vars['fieldName']->value;?>
"class="select2-container inputElement <?php if ($_smarty_tpl->tpl_vars['row_no']->value!=0){?>select2<?php }?> inputElement picklistfield lineitempicklistfield"name="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" class="inputElement picklistfield" data-fieldtype="picklist"><option value=""><?php echo vtranslate('LBL_SELECT_OPTION','Vtiger');?>
...
</option><?php } ?></select><?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='56'){?><input class="inputElement" id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
