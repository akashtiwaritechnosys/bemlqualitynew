<?php /* Smarty version Smarty-3.1.7, created on 2026-01-14 06:53:18
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Calendar/TaskManagementContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:76933369569673d5e573f09-18700418%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '247b998c78a99207ec9e33894fb3d9559185a078' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Calendar/TaskManagementContents.tpl',
      1 => 1733391283,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '76933369569673d5e573f09-18700418',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69673d5e58d21',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69673d5e58d21')) {function content_69673d5e58d21($_smarty_tpl) {?>
...
</a></span></span><?php }?></div><div class="more pull-right cursorPointer task-actions"><a href="#" class="quickTask" id="taskPopover"><i class="fa fa-pencil-square-o icon"></i></a>&nbsp;&nbsp;<a href="#" class="taskDelete"><i class="fa fa-trash icon"></i></a></div></div></div></div><?php } ?><?php if ($_smarty_tpl->tpl_vars['PAGING_MODEL']->value->get("nextPageExists")==true){?><div class="row moreButtonBlock"><button class="btn btn-soft-secondary moreRecords" style="width:100%;"> <?php echo vtranslate("LBL_MORE",$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </button></div><?php }?><?php }} ?>