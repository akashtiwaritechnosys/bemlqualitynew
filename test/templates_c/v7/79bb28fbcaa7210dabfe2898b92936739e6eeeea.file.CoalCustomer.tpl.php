<?php /* Smarty version Smarty-3.1.7, created on 2023-11-06 06:15:29
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Leads/CoalCustomer.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17115168426524326607b191-23284876%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '79bb28fbcaa7210dabfe2898b92936739e6eeeea' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Leads/CoalCustomer.tpl',
      1 => 1698924404,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17115168426524326607b191-23284876',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_65243266083dd',
  'variables' => 
  array (
    'REPORT_LABEL' => 0,
    'PickListValues' => 0,
...
$_smarty_tpl->tpl_vars['INNER_VALUE1']->_loop = true;
 $_smarty_tpl->tpl_vars['INNER_KEY1']->value = $_smarty_tpl->tpl_vars['INNER_VALUE1']->key;
?><?php if ($_smarty_tpl->tpl_vars['INNER_VALUE1']->value=='0'){?><th rowspan="1" class="NoBackGround" class="NoBackGround"></th><?php }else{ ?><?php  $_smarty_tpl->tpl_vars['INNER_VALUE2'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['INNER_VALUE2']->_loop = false;
 $_smarty_tpl->tpl_vars['INNER_KEY2'] = new Smarty_Variable;
...
?><?php  $_smarty_tpl->tpl_vars['INNER_VALUE4'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['INNER_VALUE4']->_loop = false;
 $_smarty_tpl->tpl_vars['INNER_KEY4'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['INNER_VALUE3']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['INNER_VALUE4']->key => $_smarty_tpl->tpl_vars['INNER_VALUE4']->value){
$_smarty_tpl->tpl_vars['INNER_VALUE4']->_loop = true;
 $_smarty_tpl->tpl_vars['INNER_KEY4']->value = $_smarty_tpl->tpl_vars['INNER_VALUE4']->key;
?><th rowspan="1" class="NoBackGround" class="NoBackGround"><a target="_blank"href='index.php?module=Equipment&view=List&app=INVENTORY&search_params=[[["<?php echo $_smarty_tpl->tpl_vars['RowColIgKey']->value;?>
","e","<?php echo $_smarty_tpl->tpl_vars['INNER_KEY']->value;?>
"],["<?php echo $_smarty_tpl->tpl_vars['ColColMainKey']->value;?>
","e","<?php echo $_smarty_tpl->tpl_vars['INNER_KEY2']->value;?>
"],["<?php echo $_smarty_tpl->tpl_vars['ColColSubKey']->value;?>
","e","<?php echo $_smarty_tpl->tpl_vars['INNER_KEY4']->value;?>
"],["equip_category","e","S"]]]'><?php echo $_smarty_tpl->tpl_vars['INNER_VALUE4']->value;?>
</a></th><?php } ?><?php } ?><?php } ?><?php }?><?php } ?></tr><?php } ?><?php } ?></table></div><script type="text/javascript" src="libraries/assets/xlsx.full.min.js"></script><script src="libraries/assets/jquery.min.js"></script><script src="libraries/assets/jspdf.min.js"></script><script src="libraries/assets/jspdf.plugin.autotable.min.js"></script><script>function ExportToExcel(type, fn, dl) {var elt = document.getElementById('data_table');var wb = XLSX.utils.table_to_book(elt, { sheet: "sheet1" });return dl ?XLSX.write(wb, { bookType: type, bookSST: true, type: 'base64' }) :XLSX.writeFile(wb, fn || ('<?php echo $_smarty_tpl->tpl_vars['REPORT_LABEL']->value;?>
