<?php /* Smarty version Smarty-3.1.7, created on 2024-12-09 10:54:21
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Vtiger/uitypes/Image.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11604371766756cc5de03149-35326814%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e0e45f01f99bbbfeb9a8da963f4f59ef97f3d05f' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Vtiger/uitypes/Image.tpl',
      1 => 1733391379,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11604371766756cc5de03149-35326814',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6756cc5de1cac',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6756cc5de1cac')) {function content_6756cc5de1cac($_smarty_tpl) {?>
...
</span><input type="file"class="inputElement <?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Products'||$_smarty_tpl->tpl_vars['MODULE']->value=='HelpDesk'||$_smarty_tpl->tpl_vars['MODULE']->value=='ServiceReports'||$_smarty_tpl->tpl_vars['MODULE']->value=='InternalTickets'){?>multi max-6<?php }?> <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')&&$_smarty_tpl->tpl_vars['FIELD_INFO']->value["mandatory"]==true){?> ignore-validation <?php }?>"name="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName();?>
...
" /><span><ahref="<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['url'];?>
...
" value="<?php echo vtranslate('LBL_DELETE','Vtiger');?>
"class="imageDelete"></span></span></span><?php }?><?php }?><?php }?></div><?php } ?><?php }?><?php }} ?>