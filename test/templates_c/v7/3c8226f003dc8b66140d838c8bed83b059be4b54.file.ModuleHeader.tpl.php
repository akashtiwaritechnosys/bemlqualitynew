<?php /* Smarty version Smarty-3.1.7, created on 2023-11-04 13:07:05
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/WarrantyDetails/ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9518617806400316782b094-30719273%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c8226f003dc8b66140d838c8bed83b059be4b54' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/WarrantyDetails/ModuleHeader.tpl',
      1 => 1698924406,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9518617806400316782b094-30719273',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_64003167863f8',
  'variables' => 
  array (
    'MODULE' => 0,
    'MODULE_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_64003167863f8')) {function content_64003167863f8($_smarty_tpl) {?><div class="col-sm-11 col-xs-10 padding0 module-action-bar clearfix coloredBorderTop"><div class="module-action-content clearfix <?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
" type="button" class="btn addButton btn-soft-info module-btn"<?php if (stripos($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(),'javascript:')===0){?>onclick='<?php echo substr($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(),strlen("javascript:"));?>
;'<?php }else{ ?>onclick="WarrantyDetails_List_Js.getUpdatedRecods()"<?php }?>><div class="fa <?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getIcon();?>
" aria-hidden="true"></div>&nbsp;&nbsp;Get All Warranty Deatils From SAP</button></li><?php }?><?php }?><?php if (count($_smarty_tpl->tpl_vars['MODULE_SETTING_ACTIONS']->value)>0){?><li><div class="settingsIcon"><button type="button" class="btn btn-soft-dark dropdown-toggle module-btn" data-toggle="dropdown" aria-expanded="false" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
