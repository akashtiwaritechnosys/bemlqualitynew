<?php /* Smarty version Smarty-3.1.7, created on 2025-04-08 13:00:39
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/StockTransferOrders/partials/LineItemsContent1.tpl" */ ?>
<?php /*%%SmartyHeaderCode:46326099367f51df7ddfdd5-00377780%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5d6748b5eb643f5114651f376030f34122fd9df3' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/StockTransferOrders/partials/LineItemsContent1.tpl',
      1 => 1733391378,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '46326099367f51df7ddfdd5-00377780',
  'function' => 
  array (
  ),
  'variables' => 
...
"/><!-- Product Re-Ordering Feature Code Addition ends --><div class="itemNameDiv form-inline"><div class="row"><div class="col-lg-10"><div class="input-group" style="width:100%"><input disabled type="text" id="<?php echo $_smarty_tpl->tpl_vars['productName_other']->value;?>
...
</textarea></div><?php }?></td><?php }?><?php if ($_smarty_tpl->tpl_vars['QUANTITY_VIEWABLE']->value){?><td><input disabled id="<?php echo $_smarty_tpl->tpl_vars['qty_other']->value;?>
...
" style="min-width: 100px;"></input></div><?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='16'){?><select style="min-width: 150px;" id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
...
" data-fieldtype="picklist"><option disabled value=""><?php echo vtranslate('LBL_SELECT_OPTION','Vtiger');?>
...
</option><?php } ?></select><?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='56'){?><input class="inputElement" data-rownum="<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
