<?php /* Smarty version Smarty-3.1.7, created on 2025-02-04 12:00:25
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/PDFMaker/EditFree.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18978065967a20159184ca1-68755129%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '49b1723f7b8201e139fbf958a83b2cc567504f0d' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/PDFMaker/EditFree.tpl',
      1 => 1733391284,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18978065967a20159184ca1-68755129',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_67a201591ce8a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_67a201591ce8a')) {function content_67a201591ce8a($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/var/www/html/bemlqualitynew/libraries/Smarty/libs/plugins/function.html_options.php';
...
:
                                                ...
                                                <div class="controls col-sm-9">
                                                    ...
                                                    <select id="memberList" class="select2 col-sm-12 members op" multiple="true" name="members[]" data-placeholder="<?php echo vtranslate('LBL_ADD_USERS_ROLES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
?>
                                                            <?php $_smarty_tpl->tpl_vars['TRANS_GROUP_LABEL'] = new Smarty_variable($_smarty_tpl->tpl_vars['GROUP_LABEL']->value, null, 0);?>
                                                            <?php if ($_smarty_tpl->tpl_vars['GROUP_LABEL']->value=='RoleAndSubordinates'){?>
                                                                <?php $_smarty_tpl->tpl_vars['TRANS_GROUP_LABEL'] = new Smarty_variable('LBL_ROLEANDSUBORDINATE', null, 0);?>
                                                            <?php }?>
                                                            <?php ob_start();?><?php echo vtranslate($_smarty_tpl->tpl_vars['TRANS_GROUP_LABEL']->value);?>
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['TRANS_GROUP_LABEL'] = new Smarty_variable($_tmp1, null, 0);?>
