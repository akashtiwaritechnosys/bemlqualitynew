<?php /* Smarty version Smarty-3.1.7, created on 2025-02-04 12:04:05
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/HelpDesk/FilePreview.tpl" */ ?>
<?php /*%%SmartyHeaderCode:164110933567a20235167a86-13523663%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5cd1abec617ae814c4489cf8854dadf1d4defac0' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/HelpDesk/FilePreview.tpl',
      1 => 1733391284,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '164110933567a20235167a86-13523663',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_67a2023517caa',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_67a2023517caa')) {function content_67a2023517caa($_smarty_tpl) {?>
...
</b></h3></div><?php if ($_smarty_tpl->tpl_vars['FILE_PREVIEW_NOT_SUPPORTED']->value!='yes'){?><div class="col-lg-3"><a class="btn btn-soft-info btn-small pull-right" href="<?php echo $_smarty_tpl->tpl_vars['DOWNLOAD_URL']->value;?>
...
</b><br><br><br><a class="btn btn-soft-secondary btn-large" href="<?php echo $_smarty_tpl->tpl_vars['DOWNLOAD_URL']->value;?>
"><?php echo vtranslate('LBL_DOWNLOAD_FILE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
</pre></div><?php }elseif($_smarty_tpl->tpl_vars['OPENDOCUMENT_FILE_TYPE']->value=='yes'){?><iframe id="viewer" src="libraries/jquery/Viewer.js/#../../../<?php echo $_smarty_tpl->tpl_vars['SITE_URL']->value;?>
...
" height="100%" width="100%"></iframe><?php }elseif($_smarty_tpl->tpl_vars['IMAGE_FILE_TYPE']->value=='yes'){?><div style="overflow:auto;height:100%;width:100%;float:left;background-image: url(<?php echo $_smarty_tpl->tpl_vars['SITE_URL']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['DOWNLOAD_URL']->value;?>
