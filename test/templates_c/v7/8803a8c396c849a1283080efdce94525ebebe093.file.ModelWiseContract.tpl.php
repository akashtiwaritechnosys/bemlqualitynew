<?php /* Smarty version Smarty-3.1.7, created on 2025-12-10 11:21:49
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Leads/ModelWiseContract.tpl" */ ?>
<?php /*%%SmartyHeaderCode:669306646693957cd3d1249-88244899%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8803a8c396c849a1283080efdce94525ebebe093' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Leads/ModelWiseContract.tpl',
      1 => 1747294029,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '669306646693957cd3d1249-88244899',
  'function' => 
  array (
  ),
  'variables' => 
...
$_smarty_tpl->tpl_vars['INNER_VALUE1']->_loop = true;
 $_smarty_tpl->tpl_vars['INNER_KEY100']->value = $_smarty_tpl->tpl_vars['INNER_VALUE1']->key;
?><th rowspan="1" class="NoBackGround"><b style="font-weight: 900"><?php echo $_smarty_tpl->tpl_vars['INNER_VALUE1']->value;?>
...
?><?php if ($_smarty_tpl->tpl_vars['INNER_VALUE2']->value=='0'){?><th rowspan="1" class="NoBackGround" class="NoBackGround"></th><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['INNER_KEY2']->value=='Sub Total'||$_smarty_tpl->tpl_vars['INNER_KEY2']->value=='Grand Total'){?><th rowspan="1" style="font-weight: 900" class="NoBackGround" class="NoBackGround"><a target="_blank"href='index.php?module=Equipment&view=List&app=INVENTORY&search_params=[[["equip_model","e","<?php echo $_smarty_tpl->tpl_vars['KEY_FIELD']->value;?>
"],["eq_run_war_st","e","Contract"],["equip_category","e","S"]]]'><?php echo $_smarty_tpl->tpl_vars['INNER_VALUE2']->value;?>
</a></th><?php }elseif($_smarty_tpl->tpl_vars['KEY_FIELD']->value=='Grand Total'){?><th rowspan="1" style="font-weight: 900" class="NoBackGround" class="NoBackGround"><a target="_blank"href='index.php?module=Equipment&view=List&app=INVENTORY&search_params=[[["eq_type_of_conrt","e","<?php echo $_smarty_tpl->tpl_vars['INNER_KEY2']->value;?>
"],["eq_run_war_st","e","Contract"],["equip_category","e","S"]]]'><?php echo $_smarty_tpl->tpl_vars['INNER_VALUE2']->value;?>
</a></th><?php }else{ ?><th rowspan="1" class="NoBackGround" class="NoBackGround"><a target="_blank"href='index.php?module=Equipment&view=List&app=INVENTORY&search_params=[[["equip_model","e","<?php echo $_smarty_tpl->tpl_vars['KEY_FIELD']->value;?>
"],["eq_type_of_conrt","e","<?php echo $_smarty_tpl->tpl_vars['INNER_KEY2']->value;?>
"],["eq_run_war_st","e","Contract"],["equip_category","e","S"]]]'><?php echo $_smarty_tpl->tpl_vars['INNER_VALUE2']->value;?>
</a></th><?php }?><?php }?><?php } ?><?php } ?></tr><?php } ?></table></div><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("foot.tpl",$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('TITLE'=>$_smarty_tpl->tpl_vars['HEADER_TITLE']->value), 0);?>
<?php }} ?>