<?php /* Smarty version Smarty-3.1.7, created on 2024-05-08 13:28:10
         compiled from "/var/www/html/includes/runtime/../../layouts/v7/modules/InternalTickets/DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1172365389663b7deaee6094-43409273%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3f3754fa458cb61bc609e3aefe179540f86ab109' => 
    array (
      0 => '/var/www/html/includes/runtime/../../layouts/v7/modules/InternalTickets/DetailViewBlockView.tpl',
      1 => 1715174685,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1172365389663b7deaee6094-43409273',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_663b7deaf3457',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_663b7deaf3457')) {function content_663b7deaf3457($_smarty_tpl) {?>
...
"><ul id="imageContainer" class="imageSlider"><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='HelpDesk'||$_smarty_tpl->tpl_vars['MODULE_NAME']->value=='ServiceReports'||$_smarty_tpl->tpl_vars['MODULE_NAME']->value=='InternalTickets'){?><?php  $_smarty_tpl->tpl_vars['IMAGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['IMAGE_INFO']->_loop = false;
...
" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='19'||$_smarty_tpl->tpl_vars['fieldDataType']->value=='reminder'||$_smarty_tpl->tpl_vars['fieldDataType']->value=='recurrence'){?> colspan="3" <?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?> <?php }?>><?php $_smarty_tpl->tpl_vars['FIELD_VALUE'] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue'), null, 0);?><?php if ($_smarty_tpl->tpl_vars['fieldDataType']->value=='multipicklist'||$_smarty_tpl->tpl_vars['fieldDataType']->value=='MultiSelectCheckBox'){?><?php $_smarty_tpl->tpl_vars['FIELD_DISPLAY_VALUE'] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getDisplayValue($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')), null, 0);?><?php }else{ ?><?php $_smarty_tpl->tpl_vars['FIELD_DISPLAY_VALUE'] = new Smarty_variable(Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getDisplayValue($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue'))), null, 0);?><?php }?><span class="value" data-field-type="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType();?>
...
</span><?php if ($_smarty_tpl->tpl_vars['IS_AJAX_ENABLED']->value&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isEditable()=='true'&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isAjaxEditable()=='true'){?><span class="hide edit pull-left"><?php if ($_smarty_tpl->tpl_vars['fieldDataType']->value=='multipicklist'||$_smarty_tpl->tpl_vars['fieldDataType']->value=='MultiSelectCheckBox'){?><input type="hidden" class="fieldBasicData" data-name='<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name');?>
...
" data-displayvalue='<?php echo $_smarty_tpl->tpl_vars['FIELD_DISPLAY_VALUE']->value;?>
' data-value="<?php echo $_smarty_tpl->tpl_vars['FIELD_VALUE']->value;?>
" /><?php }?></span><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')=='inthelp_description'){?><?php if ($_smarty_tpl->tpl_vars['CURRENTUSERNAME']->value=='99999'){?><span class="action pull-right"><a href="#" onclick="return false;" class="editAction fa fa-pencil"></a></span><?php }?><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')!='ticket_description'&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')!='employee_email'&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')!='service_engineerid'){?><span class="action pull-right"><a href="#" onclick="return false;" class="editAction fa fa-pencil"></a></span><?php }?><?php }?><?php }?></td><?php }?><?php if (count($_smarty_tpl->tpl_vars['FIELD_MODEL_LIST']->value)==1&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="19"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="20"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="30"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')!="recurringtype"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="69"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="105"){?><td class="fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></td><td class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
