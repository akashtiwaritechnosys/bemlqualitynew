<?php /* Smarty version Smarty-3.1.7, created on 2023-11-06 11:57:45
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Vtiger/partials/SidebarAppMenu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10387336486346ce870db806-43572620%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f060febe9f70bfecdb615c5774dab571c3e9645c' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Vtiger/partials/SidebarAppMenu.tpl',
      1 => 1699267092,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10387336486346ce870db806-43572620',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_6346ce871030a',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_6346ce871030a')) {function content_6346ce871030a($_smarty_tpl) {?>
...
?>
						...
						<div class="menu-item app-item dropdown-toggle" data-app-name="<?php echo $_smarty_tpl->tpl_vars['APP_NAME']->value;?>
...
_modules_dropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" data-default-url="#">
							<div class="menu-items-wrapper app-menu-items-wrapper">
								<span class="app-icon-list"> <i data-feather="<?php echo $_smarty_tpl->tpl_vars['APP_IMAGE_MAP']->value[$_smarty_tpl->tpl_vars['APP_NAME']->value];?>
"></i> </span>
			...
			<?php if ($_smarty_tpl->tpl_vars['USER_PRIVILEGES_MODEL']->value->hasModulePermission($_smarty_tpl->tpl_vars['DOCUMENTS_MODULE_MODEL']->value->getId())){?>
				<div class="menu-item app-item app-item-misc" data-default-url="index.php?module=Documents&view=List">
					<div class="menu-items-wrapper">
						...
						<span class="app-name textOverflowEllipsis"> <?php echo vtranslate('Download Centre');?>
</span>
					</div>
				</div>
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['USER_PRIVILEGES_MODEL']->value->hasModulePermission($_smarty_tpl->tpl_vars['DOCUMENTS_MODULE_MODEL']->value->getId())){?>
				<div class="menu-item app-item app-item-misc" data-default-url="index.php?module=Leads&view=CustomReportList">
					<div class="menu-items-wrapper">
						...
						<span class="app-name textOverflowEllipsis"> <?php echo vtranslate('Custom Reports');?>
</span>
					</div>
				</div>
			<?php }?>
