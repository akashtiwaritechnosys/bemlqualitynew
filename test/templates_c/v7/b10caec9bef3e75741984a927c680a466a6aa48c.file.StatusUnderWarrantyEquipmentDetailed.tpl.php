<?php /* Smarty version Smarty-3.1.7, created on 2023-11-06 11:58:09
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Leads/StatusUnderWarrantyEquipmentDetailed.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1596042940653a65497aac23-60063426%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b10caec9bef3e75741984a927c680a466a6aa48c' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Leads/StatusUnderWarrantyEquipmentDetailed.tpl',
      1 => 1699267086,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1596042940653a65497aac23-60063426',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_653a65497baa9',
  'variables' => 
  array (
    'MODULE' => 0,
    'HEADER_TITLE' => 0,
...
"><b style="font-weight: 900">DETAILS OF OFF ROAD EQUIPMENTS UNDER AGGREGATE WARRANTY</b></th></tr><?php  $_smarty_tpl->tpl_vars['NAME_FIELD1'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['NAME_FIELD1']->_loop = false;
 $_smarty_tpl->tpl_vars['KEY_FIELD'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['AgResultArray']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['NAME_FIELD1']->key => $_smarty_tpl->tpl_vars['NAME_FIELD1']->value){
$_smarty_tpl->tpl_vars['NAME_FIELD1']->_loop = true;
 $_smarty_tpl->tpl_vars['KEY_FIELD']->value = $_smarty_tpl->tpl_vars['NAME_FIELD1']->key;
?><tr><?php  $_smarty_tpl->tpl_vars['INNER_VALUE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['INNER_VALUE']->_loop = false;
