<?php /* Smarty version Smarty-3.1.7, created on 2023-12-08 05:33:07
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Equipment/partials/EditViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:143569720263b42bd7f40e91-22923753%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd40ca50fa759c25bd22ec94bff3ba6b7a468a3a7' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Equipment/partials/EditViewContents.tpl',
      1 => 1699267090,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '143569720263b42bd7f40e91-22923753',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_63b42bd8034a1',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_63b42bd8034a1')) {function content_63b42bd8034a1($_smarty_tpl) {?><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
...
</td><?php }?><?php }?><?php } ?><?php if ((1 & $_smarty_tpl->tpl_vars['COUNTER']->value)){?><td></td><td></td><?php }?></tr></table><?php if ($_smarty_tpl->tpl_vars['BLOCK_LABEL']->value=='daadcp'){?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsEdit2.tpl",'Equipment'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }?></div><?php }?><?php } ?></div>
<?php }} ?>