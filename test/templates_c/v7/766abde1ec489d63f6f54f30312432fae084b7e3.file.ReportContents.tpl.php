<?php /* Smarty version Smarty-3.1.7, created on 2025-12-10 11:27:36
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Reports/ReportContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1852834683693959289d0c52-24196299%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '766abde1ec489d63f6f54f30312432fae084b7e3' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Reports/ReportContents.tpl',
      1 => 1733391285,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1852834683693959289d0c52-24196299',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69395928a0d13',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69395928a0d13')) {function content_69395928a0d13($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/bemlqualitynew/libraries/Smarty/libs/plugins/modifier.replace.php';
?>
<?php if ($_smarty_tpl->tpl_vars['report_type']->value=='Pivot'){?><div class="contents-topscroll"><div class="topscroll-div"></div></div><?php }else{ ?><div class="contents-topscroll"><div class="topscroll-div"><?php if (!empty($_smarty_tpl->tpl_vars['CALCULATION_FIELDS']->value)){?><table class=" table-bordered table-condensed marginBottom10px" width="100%"><thead><tr class="blockHeader"><th><?php echo vtranslate('LBL_FIELD_NAMES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
