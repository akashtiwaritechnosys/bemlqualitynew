<?php /* Smarty version Smarty-3.1.7, created on 2026-02-27 10:35:03
         compiled from "C:\wamp64\www\bemlqualitynew\includes\runtime/../../layouts/v7\modules\EmailTemplates\ListViewActions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:210383010969a173576db587-96924417%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e6b89928c02e9486143c6c68335c5793c99338ea' => 
    array (
      0 => 'C:\\wamp64\\www\\bemlqualitynew\\includes\\runtime/../../layouts/v7\\modules\\EmailTemplates\\ListViewActions.tpl',
      1 => 1733391283,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '210383010969a173576db587-96924417',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69a17357c46f7',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69a17357c46f7')) {function content_69a17357c46f7($_smarty_tpl) {?>
...
?><?php if ($_smarty_tpl->tpl_vars['LIST_MASSACTION']->value->getLabel()=='LBL_EDIT'){?><?php $_smarty_tpl->tpl_vars['editAction'] = new Smarty_variable($_smarty_tpl->tpl_vars['LIST_MASSACTION']->value, null, 0);?><?php }elseif($_smarty_tpl->tpl_vars['LIST_MASSACTION']->value->getLabel()=='LBL_DELETE'){?><?php $_smarty_tpl->tpl_vars['deleteAction'] = new Smarty_variable($_smarty_tpl->tpl_vars['LIST_MASSACTION']->value, null, 0);?><?php }elseif($_smarty_tpl->tpl_vars['LIST_MASSACTION']->value->getLabel()=='LBL_ADD_COMMENT'){?><?php $_smarty_tpl->tpl_vars['commentAction'] = new Smarty_variable($_smarty_tpl->tpl_vars['LIST_MASSACTION']->value, null, 0);?><?php }else{ ?><?php $_smarty_tpl->tpl_vars['a'] = new Smarty_variable(array_push($_smarty_tpl->tpl_vars['LISTVIEW_MASSACTIONS_1']->value,$_smarty_tpl->tpl_vars['LIST_MASSACTION']->value), null, 0);?><?php }?><?php } ?><div class = "row"><div class="btn-toolbar col-md-3" role="group" aria-label="..."><div class="btn-group" role="group" aria-label="..."><button type="button" class="btn btn-soft-dark viewType" title="<?php echo vtranslate('LBL_LIST_VIEW',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" data-mode="list" <?php if ($_smarty_tpl->tpl_vars['VIEWTYPE']->value=='list'){?> disabled="disabled" <?php }?>><i class="fa fa-th-list"></i></button><button type="button" class="btn btn-soft-dark viewType" title="<?php echo vtranslate('LBL_THUMBNAIL_VIEW',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" data-mode="grid" <?php if ($_smarty_tpl->tpl_vars['VIEWTYPE']->value=='grid'){?> disabled="disabled" <?php }?>><i class="fa fa-th-large"></i></button></div><div class="btn-group"><?php if ($_smarty_tpl->tpl_vars['editAction']->value){?><button type="button" class="btn btn-soft-secondary" id=<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
"><i class="fa fa-pencil"></i></button><?php }?><?php if ($_smarty_tpl->tpl_vars['deleteAction']->value){?><button type="button" class="btn btn-soft-danger <?php if ($_smarty_tpl->tpl_vars['VIEWTYPE']->value=='grid'){?>hide<?php }?>" id=<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
"><i class="fa fa-trash"></i></button><?php }?><?php if ($_smarty_tpl->tpl_vars['commentAction']->value){?><button type="button" class="btn btn-soft-secondary" id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
"><i class="fa fa-comment"></i></button><?php }?><?php if (count($_smarty_tpl->tpl_vars['LISTVIEW_MASSACTIONS_1']->value)>0||count($_smarty_tpl->tpl_vars['LISTVIEW_LINKS']->value['LISTVIEW'])>0){?><div class="btn-group listViewMassActions" role="group"><button type="button" class="btn btn-soft-secondary btn-sm dropdown-toggle" data-toggle="dropdown"><?php echo vtranslate('LBL_MORE','Vtiger');?>
