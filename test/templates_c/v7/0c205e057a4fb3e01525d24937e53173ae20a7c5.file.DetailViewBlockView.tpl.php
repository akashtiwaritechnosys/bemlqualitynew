<?php /* Smarty version Smarty-3.1.7, created on 2022-10-12 11:33:27
         compiled from "/var/www/html/beml/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:167131162363051a64979146-45079522%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0c205e057a4fb3e01525d24937e53173ae20a7c5' => 
    array (
      0 => '/var/www/html/beml/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewBlockView.tpl',
      1 => 1665573252,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '167131162363051a64979146-45079522',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_63051a649b2ee',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_63051a649b2ee')) {function content_63051a649b2ee($_smarty_tpl) {?>
...
?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()==$_smarty_tpl->tpl_vars['IMAGE_INFO']->value['fieldNameFromDB']){?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['orgname'];?>
<?php $_tmp5=ob_get_clean();?><?php if (!empty($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['url'])&&!empty($_tmp5)){?><?php if ((strpos($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'],'.png')>=1||strpos($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'],'.jpeg')>=1||strpos($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'],'.jpg')>=1)){?><li><span><a onclick="openInNewTab('<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['location'];?>
...
');"><?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'];?>
</a></span></li><?php }?><?php }?><?php }?><?php } ?><?php }else{ ?><?php  $_smarty_tpl->tpl_vars['IMAGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['IMAGE_INFO']->_loop = false;
 $_smarty_tpl->tpl_vars['ITER'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['IMAGE_DETAILS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['IMAGE_INFO']->key => $_smarty_tpl->tpl_vars['IMAGE_INFO']->value){
$_smarty_tpl->tpl_vars['IMAGE_INFO']->_loop = true;
...
<?php $_tmp6=ob_get_clean();?><?php if (!empty($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['url'])&&!empty($_tmp6)){?><?php if ((strpos($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'],'.png')>=1||strpos($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'],'.jpeg')>=1||strpos($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'],'.jpg')>=1)){?><li><img src="<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['url'];?>
...
<?php $_tmp7=ob_get_clean();?><?php echo vtranslate("LBL_FILE_URL",$_tmp7);?>
