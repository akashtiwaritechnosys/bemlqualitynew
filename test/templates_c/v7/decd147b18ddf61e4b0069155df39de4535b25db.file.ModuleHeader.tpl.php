<?php /* Smarty version Smarty-3.1.7, created on 2024-12-16 13:27:19
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/BankGuarantee/ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:149166921967602ab77bfe42-00414637%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'decd147b18ddf61e4b0069155df39de4535b25db' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/BankGuarantee/ModuleHeader.tpl',
      1 => 1733391283,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '149166921967602ab77bfe42-00414637',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_67602ab781994',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_67602ab781994')) {function content_67602ab781994($_smarty_tpl) {?><div class="col-sm-11 col-xs-10 padding0 module-action-bar clearfix coloredBorderTop"><div class="module-action-content clearfix <?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
-module-action-content"><div class="col-lg-6 col-md-6 col-sm-5 col-xs-11 padding0 module-breadcrumb module-breadcrumb-<?php echo $_REQUEST['view'];?>
...
">&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
 &nbsp;&nbsp;</a></p><?php }?></div><div class="col-lg-6 col-md-6 col-sm-7 col-xs-1 padding0 pull-right"><div id="appnav" class="navbar-right"><nav class="navbar navbar-inverse border0 margin0"><div class="container-fluid"><div class="navbar-header marginTop5px"><button type="button" class="navbar-toggle collapsed margin0" data-toggle="collapse" data-target="#appnavcontent" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></button></div><div class="navbar-collapse collapse" id="appnavcontent" aria-expanded="false" style="height: 1px;"><ul class="nav navbar-nav"><?php if (count($_smarty_tpl->tpl_vars['MODULE_BASIC_ACTIONS']->value)>0){?><?php  $_smarty_tpl->tpl_vars['BASIC_ACTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BASIC_ACTION']->_loop = false;
...
"'<?php }?>><div class="fa <?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getIcon();?>
" aria-hidden="true"></div>&nbsp;&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button></li><?php }?><?php } ?><?php }?><?php if ($_smarty_tpl->tpl_vars['USER_MODEL']->value->isAdminUser()){?><li><button id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_basicAction_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores('Sync To SAP');?>
" type="button" class="btn addButton btn-soft-info module-btn"onclick="BankGuarantee_List_Js.syncToSAPFunction('BankGuarantee')"><div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;Sync To SAP</button></li><li><button id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_basicAction_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores('Calculate BG Status');?>
" type="button" class="btn addButton btn-soft-info module-btn"onclick="BankGuarantee_List_Js.AutoUpdateBGStatusINPeriodic('BankGuarantee')"><div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;Calculate BG Status</button></li><?php }?><?php if (count($_smarty_tpl->tpl_vars['MODULE_SETTING_ACTIONS']->value)>0){?><li><div class="settingsIcon"><button type="button" class="btn btn-soft-dark dropdown-toggle module-btn" data-toggle="dropdown" aria-expanded="false" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</a></li><?php } ?></ul></div></li><?php }?></ul></div></div></nav></div></div></div><?php if ($_smarty_tpl->tpl_vars['FIELDS_INFO']->value!=null){?><script type="text/javascript">var uimeta = (function () {var fieldInfo = <?php echo $_smarty_tpl->tpl_vars['FIELDS_INFO']->value;?>
