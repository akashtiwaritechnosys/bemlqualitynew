<?php /* Smarty version Smarty-3.1.7, created on 2026-03-02 09:13:45
         compiled from "C:\wamp64\www\bemlqualitynew\includes\runtime/../../layouts/v7\modules\Vtiger\ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:67124607369a540b8cd62b8-30130866%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2b1ad4ac91110822533d2e30990c86264be6c6c7' => 
    array (
      0 => 'C:\\wamp64\\www\\bemlqualitynew\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\ModuleHeader.tpl',
      1 => 1772442503,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '67124607369a540b8cd62b8-30130866',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_69a540b929d86',
  'variables' => 
  array (
    'MODULE' => 0,
    'REQ' => 0,
...
<?php if ($_valid && !is_callable('content_69a540b929d86')) {function content_69a540b929d86($_smarty_tpl) {?>
...
-module-action-content"><div class="col-lg-8 col-md-10 col-sm-12 col-xs-12 padding0 module-breadcrumb module-breadcrumb-<?php echo $_smarty_tpl->tpl_vars['REQ']->value->get('view');?>
...
'><h4 class="module-title pull-left text-uppercase"> <?php echo vtranslate($_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </h4>&nbsp;&nbsp;</a><?php if (isset($_SESSION['lvs'])&&isset($_SESSION['lvs'][$_smarty_tpl->tpl_vars['MODULE']->value])&&isset($_SESSION['lvs'][$_smarty_tpl->tpl_vars['MODULE']->value]['viewname'])){?><?php $_smarty_tpl->tpl_vars['VIEWID'] = new Smarty_variable($_SESSION['lvs'][$_smarty_tpl->tpl_vars['MODULE']->value]['viewname'], null, 0);?><?php }?><?php if (isset($_smarty_tpl->tpl_vars['VIEWID']->value)&&$_smarty_tpl->tpl_vars['VIEWID']->value){?><?php  $_smarty_tpl->tpl_vars['FILTER_TYPES'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FILTER_TYPES']->_loop = false;
...
&nbsp;&nbsp;</a> </p><?php }?><?php $_smarty_tpl->tpl_vars['SINGLE_MODULE_NAME'] = new Smarty_variable(('SINGLE_').($_smarty_tpl->tpl_vars['MODULE']->value), null, 0);?><?php if (isset($_smarty_tpl->tpl_vars['RECORD']->value)&&$_smarty_tpl->tpl_vars['RECORD']->value&&$_smarty_tpl->tpl_vars['REQ']->value->get('view')=='Edit'){?><p class="current-filter-name filter-name pull-left "><span class="fa fa-angle-right pull-left" aria-hidden="true"></span><a title="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
...
&nbsp;&nbsp;</a></p><?php }?><?php if ($_smarty_tpl->tpl_vars['REQ']->value->get('view')=='Detail'){?><p class="current-filter-name filter-name pull-left"><span class="fa fa-angle-right pull-left" aria-hidden="true"></span><a title="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
">&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
 &nbsp;&nbsp;</a></p><?php }?></div><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding0 pull-right"><div id="appnav" class="module-header-btns"><nav class="navbar navbar-inverse border0 margin0"><?php if (php7_count($_smarty_tpl->tpl_vars['MODULE_BASIC_ACTIONS']->value)>0){?><div class="" style="padding: 1px 5px 0px 0px;"><div class="navbar-header bg-white marginTop5px"><button type="button" class="navbar-toggle collapsed margin0" data-toggle="collapse" data-target="#appnavcontent" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></button></div><div class="navbar-collapse collapse" id="appnavcontent" aria-expanded="false" style="height: 1px;"><ul class="nav navbar-nav"><?php  $_smarty_tpl->tpl_vars['BASIC_ACTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BASIC_ACTION']->_loop = false;
...
"'<?php }?>><div class="fa <?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getIcon();?>
" aria-hidden="true"></div>&nbsp;&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button></li><?php }?><?php } ?><?php if (php7_count($_smarty_tpl->tpl_vars['MODULE_SETTING_ACTIONS']->value)>0){?><li><div class="settingsIcon"><button type="button" class="btn btn-default module-buttons dropdown-toggle" data-toggle="dropdown" aria-expanded="false" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
;return {field: {get: function (name, property) {if (name && property === undefined) {return fieldInfo[name];}if (name && property) {return fieldInfo[name][property]}},isMandatory: function (name) {if (fieldInfo[name]) {return fieldInfo[name].mandatory;}return false;},getType: function (name) {if (fieldInfo[name]) {return fieldInfo[name].type}return false;}},};})();</script><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='Home'){?></div>    <?php }?>
<?php }} ?>