<?php /* Smarty version Smarty-3.1.7, created on 2024-12-11 05:45:09
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Documents/ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1954365743675926e55973e3-61166865%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bd080c1af73fc5996be4456f074d21c8c8e497a0' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Documents/ModuleHeader.tpl',
      1 => 1733391283,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1954365743675926e55973e3-61166865',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_675926e55cab5',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_675926e55cab5')) {function content_675926e55cab5($_smarty_tpl) {?>
...
?><?php if ($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel()=='LBL_ADD_RECORD'){?><li><div><button type="button" class="btn btn-soft-blue module-btn dropdown-toggle" data-toggle="dropdown"><span class="fa fa-plus" title="<?php echo vtranslate('LBL_NEW_DOCUMENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</li><li id="VtigerAction"><a href="javascript:Documents_Index_Js.uploadTo('Vtiger')">Upload New Document</a></li><li role="separator" class="divider"></li><li class="dropdown-header"><i class="fa fa-link"></i> <?php echo vtranslate('LBL_LINK_EXTERNAL_DOCUMENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</a></li></ul></div></li><?php }?><?php } ?><?php if (count($_smarty_tpl->tpl_vars['MODULE_SETTING_ACTIONS']->value)>0){?><li><div class="settingsIcon"><button type="button" class="btn btn-soft-dark module-btn dropdown-toggle" data-toggle="dropdown"><span class="fa fa-wrench" aria-hidden="true" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
