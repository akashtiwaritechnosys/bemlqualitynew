<?php /* Smarty version Smarty-3.1.7, created on 2024-05-08 13:35:44
         compiled from "/var/www/html/includes/runtime/../../layouts/v7/modules/InternalTickets/uitypes/Reference.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2026306524663b7fb0c78dc9-59525622%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '550140a7c51bce43ff06ec9b8b32dbe404584817' => 
    array (
      0 => '/var/www/html/includes/runtime/../../layouts/v7/modules/InternalTickets/uitypes/Reference.tpl',
      1 => 1715174691,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2026306524663b7fb0c78dc9-59525622',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_663b7fb0c8fd3',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_663b7fb0c8fd3')) {function content_663b7fb0c8fd3($_smarty_tpl) {?>
...
'<?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')=='service_engineerid'){?> disabled <?php }?> /><a href="#" class="clearReferenceSelection <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')=='service_engineerid'){?> hide <?php }?>  <?php if ($_smarty_tpl->tpl_vars['FIELD_VALUE']->value==0){?>hide<?php }?>"> x </a><span class="input-group-addon relatedPopup cursorPointer <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')=='service_engineerid'){?> hide <?php }?>" title="<?php echo vtranslate('LBL_SELECT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"><i id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_editView_fieldName_<?php echo $_smarty_tpl->tpl_vars['FIELD_NAME']->value;?>
_select" class="fa fa-search"></i></span><?php if ((($_REQUEST['view']=='Edit')||($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='Webforms'))&&!in_array($_smarty_tpl->tpl_vars['REFERENCE_LIST']->value[0],$_smarty_tpl->tpl_vars['QUICKCREATE_RESTRICTED_MODULES']->value)){?><span class="input-group-addon createReferenceRecord cursorPointer clearfix <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')=='service_engineerid'){?> hide <?php }?>" title="<?php echo vtranslate('LBL_CREATE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"><i id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_editView_fieldName_<?php echo $_smarty_tpl->tpl_vars['FIELD_NAME']->value;?>
