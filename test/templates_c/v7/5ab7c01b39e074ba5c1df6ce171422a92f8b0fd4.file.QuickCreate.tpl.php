<?php /* Smarty version Smarty-3.1.7, created on 2023-03-14 10:11:38
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/CallAssistance/QuickCreate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14314832776381a1856a2093-90552808%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5ab7c01b39e074ba5c1df6ce171422a92f8b0fd4' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/CallAssistance/QuickCreate.tpl',
      1 => 1678690367,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14314832776381a1856a2093-90552808',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_6381a1856d0cd',
  'variables' => 
  array (
    'SCRIPTS' => 0,
    'jsModel' => 0,
...
<?php if ($_valid && !is_callable('content_6381a1856d0cd')) {function content_6381a1856d0cd($_smarty_tpl) {?>
...
"></script><?php } ?><div class="modal-dialog modal-lg callassistancemodal"><div class="modal-content"><form class="form-horizontal recordEditView" id="QuickCreate" name="QuickCreate" method="post" action="index.php"><?php ob_start();?><?php echo vtranslate('LBL_QUICK_CREATE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php $_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['BUTTON_LABEL'] = new Smarty_variable($_tmp3, null, 0);?><?php }?><?php $_smarty_tpl->tpl_vars["EDIT_VIEW_URL"] = new Smarty_variable($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getCreateRecordUrl(), null, 0);?><button class="btn btn-soft-secondary" id="goToFullForm" data-edit-view-url="<?php echo $_smarty_tpl->tpl_vars['EDIT_VIEW_URL']->value;?>
...
</strong></button><a href="#" class="cancelLink btn btn-soft-danger" type="reset" data-dismiss="modal"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
;return {field: {get: function(name, property) {if(name && property === undefined) {return fieldInfo[name];}if(name && property) {return fieldInfo[name][property]}},isMandatory : function(name){if(fieldInfo[name]) {return fieldInfo[name].mandatory;}return false;},getType : function(name){if(fieldInfo[name]) {return fieldInfo[name].type}return false;}},};})();</script><?php }?></div><script type="text/javascript" src="<?php echo vresource_url('layouts/v7/modules/Users/resources/intlTelInput.js');?>
"></script><link type="text/css" rel="stylesheet" href="layouts/v7/modules/Users/build/css/intlTelInput.css?v=7.3.0" media="screen"><?php }} ?>