<?php /* Smarty version Smarty-3.1.7, created on 2023-12-05 12:28:15
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Reports/ChartEditStep3.tpl" */ ?>
<?php /*%%SmartyHeaderCode:859005743636d2bed3f43a1-36386000%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a725a6015d9502e94f87a37e7812f60f111716e6' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Reports/ChartEditStep3.tpl',
      1 => 1699267086,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '859005743636d2bed3f43a1-36386000',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_636d2bed4030b',
  'variables' => 
  array (
    'MODULE' => 0,
    'RECORD_ID' => 0,
...
<?php if ($_valid && !is_callable('content_636d2bed4030b')) {function content_636d2bed4030b($_smarty_tpl) {?>
...
"><div class="report_step" style="padding:1%;"><div><h4><strong><?php echo vtranslate('LBL_SELECT_CHART_TYPE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></h4></div><br><div><ul class="nav nav-tabs charttabs" name="charttab" style="text-align:center;font-size:14px;font-weight: bold;margin:0 3%;border:0px"><li class="active marginRight5px" ><a data-type="pieChart" data-toggle="tab"><div><img src="layouts/v7/skins/images/pie.PNG" style=""/></div><div class="chartname"><?php echo vtranslate('LBL_PIE_CHART',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</div></a></li><li class="marginRight5px"><a data-type="verticalbarChart" data-toggle="tab"><div><img src="layouts/v7/skins/images/vbar.PNG" style=""/></div><div class="chartname"><?php echo vtranslate('LBL_VERTICAL_BAR_CHART',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</div></a></li><li class="marginRight5px"><a data-type="horizontalbarChart" data-toggle="tab"><div><img src="layouts/v7/skins/images/hbar.PNG" style=""/></div><div class="chartname"><?php echo vtranslate('LBL_HORIZONTAL_BAR_CHART',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</div></a></li><li class="marginRight5px" ><a data-type="lineChart" data-toggle="tab"><div><img src="layouts/v7/skins/images/line.PNG" style=""/></div><div class="chartname"><?php echo vtranslate('LBL_LINE_CHART',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</div></a></li></ul><div class='tab-content contentsBackground' style="height:auto;padding:4%;border:1px solid #ccc; background-color: #f5f7fb;"><br><div class="row tab-pane active"><div><span class="col-lg-4"><div><span><?php echo vtranslate('LBL_SELECT_GROUP_BY_FIELD',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</div></div><br><div class="modal-overlay-footer border1px clearfix"><div class="row clearfix"><div class="textAlignCenter col-lg-12 col-md-12 col-sm-12 "><button type="button" class="btn btn-soft-secondary backStep"><strong><?php echo vtranslate('LBL_BACK',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button>&nbsp;&nbsp;<button type="submit" class="btn btn-soft-secondary" id="generateReport"><strong><?php echo vtranslate('LBL_GENERATE_REPORT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
