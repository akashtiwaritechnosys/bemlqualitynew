<?php /* Smarty version Smarty-3.1.7, created on 2022-09-02 18:24:04
         compiled from "C:\xampp\htdocs\beml\includes\runtime/../../layouts/v7\modules\Vtiger\RecentComments.tpl" */ ?>
<?php /*%%SmartyHeaderCode:159042795363124a44755fd8-03204723%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '75b6cdf906b78d2e3281a1481fd99a9518a1d3a5' => 
    array (
      0 => 'C:\\xampp\\htdocs\\beml\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\RecentComments.tpl',
      1 => 1651513301,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '159042795363124a44755fd8-03204723',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_63124a4489863',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_63124a4489863')) {function content_63124a4489863($_smarty_tpl) {?>
...
"></i>&nbsp;&nbsp;</div><?php }?><button class="btn btn-soft-success btn-sm detailViewSaveComment" type="button" data-mode="add"><?php echo vtranslate('LBL_POST',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
&nbsp;&nbsp;</label></div><?php }?><button class="btn btn-soft-blue btn-sm detailViewSaveComment" type="button" data-mode="add"><?php echo vtranslate('LBL_POST',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</button><a href="javascript:void(0);" class="cursorPointer closeCommentBlock cancelLink btn btn-soft-danger" type="reset"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
" rows="<?php echo $_smarty_tpl->tpl_vars['COMMENT_TEXTAREA_DEFAULT_ROWS']->value;?>
"></textarea></div></div><input type="hidden" name="is_private"><div class="pull-right row"><button class="btn btn-soft-blue btn-sm detailViewSaveComment" type="button" data-mode="edit"><?php echo vtranslate('LBL_POST',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</button><a href="javascript:void(0);" class="cursorPointer closeCommentBlock cancelLink btn btn-soft-danger" type="reset"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</a></div></div></div>
<?php }} ?>