<?php /* Smarty version Smarty-3.1.7, created on 2025-04-08 13:00:39
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/StockTransferOrders/partials/LineItemsEdit1.tpl" */ ?>
<?php /*%%SmartyHeaderCode:180563324867f51df7d9e1e4-50901322%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4797167321f712553c145e7493424a1564663212' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/StockTransferOrders/partials/LineItemsEdit1.tpl',
      1 => 1733391378,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '180563324867f51df7d9e1e4-50901322',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_67f51df7dd9c2',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_67f51df7dd9c2')) {function content_67f51df7dd9c2($_smarty_tpl) {?><?php  $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->_loop = false;
...
</option></select></div></div></div></div></div><input type="hidden" id="fildNamesOfCustFieldsOther" value=<?php echo ZEND_JSON::encode($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELDNAMES_OTHER']->value);?>
><div class="lineitemTableContainer"><table class="table table-bordered" id="lineItemTab1"><tr><td><strong><?php echo vtranslate('LBL_SLNO',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></td><?php } ?></tr><tr id="anorow0" class="hide lineItemCloneCopy" data-row-num="0"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsContent1.tpl",'StockTransferOrders'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>0,'data'=>array(),'IGNORE_UI_REGISTRATION'=>true), 0);?>
...
<?php }?>><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsContent1.tpl",'StockTransferOrders'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>$_smarty_tpl->tpl_vars['row_no']->value,'data'=>$_smarty_tpl->tpl_vars['data']->value), 0);?>
</tr><?php } ?><?php if (count($_smarty_tpl->tpl_vars['RELATED_PRODUCTS_OTHER']->value)==0&&($_smarty_tpl->tpl_vars['PRODUCT_ACTIVE']->value=='true'||$_smarty_tpl->tpl_vars['SERVICE_ACTIVE']->value=='true')){?><tr id="row1" class="lineItemRow" data-row-num="1"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsContent1.tpl",'StockTransferOrders'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>1,'data'=>array(),'IGNORE_UI_REGISTRATION'=>false), 0);?>
