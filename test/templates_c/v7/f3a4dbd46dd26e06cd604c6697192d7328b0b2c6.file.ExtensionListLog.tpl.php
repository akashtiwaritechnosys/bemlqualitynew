<?php /* Smarty version Smarty-3.1.7, created on 2026-02-19 13:07:43
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Vtiger/ExtensionListLog.tpl" */ ?>
<?php /*%%SmartyHeaderCode:64644531469970b1f7adf36-36491537%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f3a4dbd46dd26e06cd604c6697192d7328b0b2c6' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Vtiger/ExtensionListLog.tpl',
      1 => 1733391286,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '64644531469970b1f7adf36-36491537',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69970b1f7cf2b',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69970b1f7cf2b')) {function content_69970b1f7cf2b($_smarty_tpl) {?>
...
" class="btn addButton btn-soft-dark settingsPage" type="button" id="Contacts_basicAction_LBL_Sync_Settings"><span aria-hidden="true" class="fa fa-cog"></span> <?php echo vtranslate('LBL_SYNC_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a></h3>
                    </span>
                </div>
            </div>
        ...
        <?php if (!$_smarty_tpl->tpl_vars['MODAL']->value){?>
            <div class="col-sm-6 col-xs-6">
                <?php if ($_smarty_tpl->tpl_vars['IS_SYNC_READY']->value){?>
                    <button class="btn addButton btn-soft-blue syncNow" type="button" id="Contacts_basicAction_LBL_Sync_Settings"><span aria-hidden="true" class="fa fa-refresh"></span><strong>&nbsp; <?php echo vtranslate('LBL_SYNC_NOW',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </strong></button>
                        <?php }?>
            </div>
        <?php }?>
