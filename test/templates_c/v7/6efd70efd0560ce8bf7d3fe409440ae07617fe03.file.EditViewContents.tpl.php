<?php /* Smarty version Smarty-3.1.7, created on 2025-04-08 13:00:39
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/StockTransferOrders/partials/EditViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:62619307267f51df7cb20d8-19784785%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6efd70efd0560ce8bf7d3fe409440ae07617fe03' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/StockTransferOrders/partials/EditViewContents.tpl',
      1 => 1733391378,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '62619307267f51df7cb20d8-19784785',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_67f51df7d0bc1',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_67f51df7d0bc1')) {function content_67f51df7d0bc1($_smarty_tpl) {?><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
...
</div></div><?php }?><?php if ($_smarty_tpl->tpl_vars['EXTERNALERRORISTHERE']->value){?><div class="fieldBlockContainer duplicationMessageContainer"><div class="duplicationMessageHeader"><b>StockTransferOrders Is Created/Updated In CRM, But Sync To SAP , Has Failed , Please Fix Following Errors</b></div><div><?php echo $_smarty_tpl->tpl_vars['EXTERNALERROR']->value;?>
...
?><?php if ($_smarty_tpl->tpl_vars['BLOCK_LABEL']->value=='LBL_ITEM_DETAILS'){?><?php continue 1?><?php }?><?php if (count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)>0){?><div class='fieldBlockContainer' id="<?php echo $_smarty_tpl->tpl_vars['BLOCK_LABEL']->value;?>
...
"></script></div><?php if ($_smarty_tpl->tpl_vars['MODE']->value!='edit'){?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsEdit1.tpl",'StockTransferOrders'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsEdit.tpl",'StockTransferOrders'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }} ?>