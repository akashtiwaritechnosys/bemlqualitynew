<?php /* Smarty version Smarty-3.1.7, created on 2024-12-10 09:11:43
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/EquipmentAvailability/ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:322806712675805cfd94bb0-78896557%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '56b8e73b6f2d2b078093ab4b0cebf5c6d0958aef' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/EquipmentAvailability/ModuleHeader.tpl',
      1 => 1733391283,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '322806712675805cfd94bb0-78896557',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_675805cfdbff3',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_675805cfdbff3')) {function content_675805cfdbff3($_smarty_tpl) {?><div class="col-sm-11 col-xs-10 padding0 module-action-bar clearfix coloredBorderTop"><div class="module-action-content clearfix <?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
"'<?php }?>><div class="fa <?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getIcon();?>
" aria-hidden="true"></div>&nbsp;&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button></li><?php }?><?php } ?><?php if (count($_smarty_tpl->tpl_vars['MODULE_SETTING_ACTIONS']->value)>0){?><li><div class="settingsIcon"><button type="button" class="btn btn-soft-dark dropdown-toggle module-btn" data-toggle="dropdown" aria-expanded="false" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</a></li><?php } ?></ul></div></li><?php }?><?php if ($_smarty_tpl->tpl_vars['USER_MODEL']->value->isAdminUser()){?><li><button id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_basicAction_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores('Sync Recently Updated');?>
" type="button" class="btn addButton btn-soft-info module-btn"onclick="EquipmentAvailability_List_Js.calcAvail('')"><div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;Calculate Availability</button></li><?php }?></ul></div><!-- /.navbar-collapse --></div><!-- /.container-fluid --></nav></div></div></div><?php if ($_smarty_tpl->tpl_vars['FIELDS_INFO']->value!=null){?><script type="text/javascript">var uimeta = (function () {var fieldInfo = <?php echo $_smarty_tpl->tpl_vars['FIELDS_INFO']->value;?>
