<?php /* Smarty version Smarty-3.1.7, created on 2025-03-12 10:34:50
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/ServiceOrders/partials/EditViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6666175667d1634a901407-10091126%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '725f953e89223ae93b2ce4590cc1c0f625960b85' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/ServiceOrders/partials/EditViewContents.tpl',
      1 => 1733391377,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6666175667d1634a901407-10091126',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_67d1634a95a69',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_67d1634a95a69')) {function content_67d1634a95a69($_smarty_tpl) {?><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
...
</div></div><?php }?><?php if ($_smarty_tpl->tpl_vars['EXTERNALERRORISTHERE']->value){?><div class="fieldBlockContainer duplicationMessageContainer"><div class="duplicationMessageHeader"><b>Service Order Is Created/Updated In CRM, But Sync To SAP , Has Failed , Please Fix Following Errors</b></div><div><?php echo $_smarty_tpl->tpl_vars['EXTERNALERROR']->value;?>
...
?><?php if ($_smarty_tpl->tpl_vars['BLOCK_LABEL']->value=='LBL_ITEM_DETAILS'||$_smarty_tpl->tpl_vars['BLOCK_LABEL']->value=='PARTS_FROM_SR'){?><?php continue 1?><?php }?><?php if (count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)>0){?><div class='fieldBlockContainer' id="<?php echo $_smarty_tpl->tpl_vars['BLOCK_LABEL']->value;?>
...
<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType()=='image'||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType()=='file'){?><hr style="height:1px;border-width:0;color:gray;background-color:black"><?php }?></td><?php }?><?php } ?><?php if ((1 & $_smarty_tpl->tpl_vars['COUNTER']->value)){?><td></td><td></td><?php }?></tr></table></div><?php }?><?php } ?><script type="text/javascript" src="<?php echo vresource_url('layouts/v7/modules/Users/resources/intlTelInput.js');?>
"></script></div><?php if ($_smarty_tpl->tpl_vars['MODE']->value!='edit'){?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsEdit1.tpl",'ServiceOrders'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsEdit.tpl",'ServiceOrders'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }} ?>