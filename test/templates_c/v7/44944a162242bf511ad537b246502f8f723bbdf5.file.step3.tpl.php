<?php /* Smarty version Smarty-3.1.7, created on 2024-11-29 10:22:14
         compiled from "/var/www/html/includes/runtime/../../layouts/v7/modules/Reports/step3.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4902337365c5f867e83418-96023615%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '44944a162242bf511ad537b246502f8f723bbdf5' => 
    array (
      0 => '/var/www/html/includes/runtime/../../layouts/v7/modules/Reports/step3.tpl',
      1 => 1715174686,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4902337365c5f867e83418-96023615',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_65c5f867ecd98',
  'variables' => 
  array (
    'MODULE' => 0,
    'RECORD_ID' => 0,
...
<?php if ($_valid && !is_callable('content_65c5f867ecd98')) {function content_65c5f867ecd98($_smarty_tpl) {?>
...
" /><!--Pivot Report--><input type="hidden" name="pivot_rows" value="<?php echo $_smarty_tpl->tpl_vars['pivot_rows']->value;?>
" /><input type="hidden" name="pivot_columns" value="<?php echo $_smarty_tpl->tpl_vars['pivot_columns']->value;?>
" /><input type="hidden" name="pivot_datafield" value="<?php echo $_smarty_tpl->tpl_vars['pivot_datafield']->value;?>
" /><!--Pivot Report--><input type="hidden" name="reportname" value="<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['REPORT_MODEL']->value->get('reportname'));?>
...
$_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value[$_smarty_tpl->tpl_vars['key']->value] = $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value;?><?php } ?><?php } ?><div style="padding:2%;" class="report_step"><div class="row"><h4><strong><?php echo vtranslate('LBL_CHOOSE_FILTER_CONDITIONS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</span></div></div><br><div class="modal-overlay-footer border1px clearfix"><div class="row clearfix"><div class="textAlignCenter col-lg-12 col-md-12 col-sm-12 "><button type="button" class="btn btn-soft-secondary backStep"><strong><?php echo vtranslate('LBL_BACK',$_smarty_tpl->tpl_vars['MODULE']->value);?>
