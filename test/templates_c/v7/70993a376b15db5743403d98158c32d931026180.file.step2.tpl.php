<?php /* Smarty version Smarty-3.1.7, created on 2025-04-03 10:58:04
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Reports/step2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:155405159167ee69bc222fb3-35865728%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70993a376b15db5743403d98158c32d931026180' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Reports/step2.tpl',
      1 => 1733391285,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '155405159167ee69bc222fb3-35865728',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'pivotRows' => 0,
    'operationFieldValues' => 0,
    'operationFieldValues_KEY' => 0,
    'pivotDatafield' => 0,
    'operationFieldValues_VALUE' => 0,
  ...
  'unifunc' => 'content_67ee69bc270e1',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_67ee69bc270e1')) {function content_67ee69bc270e1($_smarty_tpl) {?>
...
" /><!--Pivot Report--><input type="hidden" name="type" value="<?php echo $_smarty_tpl->tpl_vars['type']->value;?>
" /><!--Pivot Report--><input type="hidden" name="reportname" value="<?php echo $_smarty_tpl->tpl_vars['REPORT_MODEL']->value->get('reportname');?>
...
"><input type="hidden" class="step" value="2" /><?php if ($_smarty_tpl->tpl_vars['type']->value=='Pivot'){?><div class="" style="border:1px solid #ccc;padding:4%;height: 200px !important;"><div style="position:relative"><div class="form-group" style="float:left; width: 30%;margin-right: 45px;"><label><?php echo vtranslate('LBL_SELECT_ROWS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
(<?php echo vtranslate('LBL_MAX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 3)</label><br><select data-placeholder="<?php echo vtranslate('LBL_ADD_MORE_COLUMNS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" name="pivot_rows" id="reportsColumnsList" style="width :100%;" class="select2-container select2 col-lg-11 columns"  data-rule-required="true" multiple=""><?php  $_smarty_tpl->tpl_vars['PRIMARY_MODULE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PRIMARY_MODULE']->_loop = false;
...
" <?php if ($_smarty_tpl->tpl_vars['pivotColumns']->value[$_smarty_tpl->tpl_vars['FIELD_KEY']->value]==$_smarty_tpl->tpl_vars['FIELD_KEY']->value){?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['PRIMARY_MODULE_NAME']->value,$_smarty_tpl->tpl_vars['PRIMARY_MODULE_NAME']->value);?>
...
$_smarty_tpl->tpl_vars['FIELD_LABEL']->_loop = true;
 $_smarty_tpl->tpl_vars['FIELD_KEY']->value = $_smarty_tpl->tpl_vars['FIELD_LABEL']->key;
?><option value="<?php echo $_smarty_tpl->tpl_vars['FIELD_KEY']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['pivotColumns']->value[$_smarty_tpl->tpl_vars['FIELD_KEY']->value]==$_smarty_tpl->tpl_vars['FIELD_KEY']->value){?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->value,$_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->value);?>
 <?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_LABEL']->value,$_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->value);?>
</option><?php } ?></optgroup><?php } ?><?php } ?></select></div><div class="form-group" style="float:left; width: 30%;margin-right: 45px;"><label><?php echo vtranslate('LBL_SELECT_COLUMNS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
(<?php echo vtranslate('LBL_MAX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 3)</label><br><select data-placeholder="<?php echo vtranslate('LBL_ADD_MORE_COLUMNS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" name="pivot_columns" id="reportsRowList" style="width :100%;" class="select2-container select2 col-lg-11 columns"  data-rule-required="true" multiple=""><?php  $_smarty_tpl->tpl_vars['PRIMARY_MODULE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PRIMARY_MODULE']->_loop = false;
 $_smarty_tpl->tpl_vars['PRIMARY_MODULE_NAME'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['PRIMARY_MODULE_FIELDS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['PRIMARY_MODULE']->key => $_smarty_tpl->tpl_vars['PRIMARY_MODULE']->value){
$_smarty_tpl->tpl_vars['PRIMARY_MODULE']->_loop = true;
...
$_smarty_tpl->tpl_vars['FIELD_LABEL']->_loop = true;
 $_smarty_tpl->tpl_vars['FIELD_KEY']->value = $_smarty_tpl->tpl_vars['FIELD_LABEL']->key;
?><option value="<?php echo $_smarty_tpl->tpl_vars['FIELD_KEY']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['pivotRows']->value[$_smarty_tpl->tpl_vars['FIELD_KEY']->value]==$_smarty_tpl->tpl_vars['FIELD_KEY']->value){?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['PRIMARY_MODULE_NAME']->value,$_smarty_tpl->tpl_vars['PRIMARY_MODULE_NAME']->value);?>
 <?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_LABEL']->value,$_smarty_tpl->tpl_vars['PRIMARY_MODULE_NAME']->value);?>
</option><?php } ?></optgroup><?php } ?><?php } ?><?php  $_smarty_tpl->tpl_vars['SECONDARY_MODULE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['SECONDARY_MODULE']->_loop = false;
 $_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['SECONDARY_MODULE_FIELDS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
$_smarty_tpl->tpl_vars['FIELD_LABEL']->_loop = true;
 $_smarty_tpl->tpl_vars['FIELD_KEY']->value = $_smarty_tpl->tpl_vars['FIELD_LABEL']->key;
?><option value="<?php echo $_smarty_tpl->tpl_vars['FIELD_KEY']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['pivotRows']->value[$_smarty_tpl->tpl_vars['FIELD_KEY']->value]==$_smarty_tpl->tpl_vars['FIELD_KEY']->value){?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->value,$_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->value);?>
 <?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_LABEL']->value,$_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->value);?>
</option><?php } ?></optgroup><?php } ?><?php } ?></select></div><div class="form-group" style="float:left; width: 30%;margin-right: 45px;"><label><?php echo vtranslate('Select Data Fields',$_smarty_tpl->tpl_vars['MODULE']->value);?>
(<?php echo vtranslate('LBL_MAX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 3)</label><br><?php $_smarty_tpl->tpl_vars['FIELD_OPERATION_VALUES'] = new Smarty_variable(explode(',','SUM:2,AVG:3,MIN:4,MAX:5'), null, 0);?><select data-placeholder="<?php echo vtranslate('Click to select Data Fields',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" class="select2" name="pivot_datafield" id="operationField" style="width :100%;" class="select2-container select2 col-lg-11 columns"  data-rule-required="true" multiple=""><?php  $_smarty_tpl->tpl_vars['operationFieldValues_VALUE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['operationFieldValues_VALUE']->_loop = false;
 $_smarty_tpl->tpl_vars['operationFieldValues_KEY'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['operationFieldValues']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['operationFieldValues_VALUE']->key => $_smarty_tpl->tpl_vars['operationFieldValues_VALUE']->value){
$_smarty_tpl->tpl_vars['operationFieldValues_VALUE']->_loop = true;
 $_smarty_tpl->tpl_vars['operationFieldValues_KEY']->value = $_smarty_tpl->tpl_vars['operationFieldValues_VALUE']->key;
?><option value="<?php echo $_smarty_tpl->tpl_vars['operationFieldValues_KEY']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['pivotDatafield']->value[$_smarty_tpl->tpl_vars['operationFieldValues_KEY']->value]==$_smarty_tpl->tpl_vars['operationFieldValues_KEY']->value){?> selected <?php }?>><?php echo $_smarty_tpl->tpl_vars['operationFieldValues_VALUE']->value;?>
</option><?php } ?></select></div></div></div><br><br><br><br><?php }else{ ?><div class="report_step" style="padding:4%;"><div class="form-group"><label><?php echo vtranslate('LBL_SELECT_COLUMNS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
(<?php echo vtranslate('LBL_MAX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" <?php if (!empty($_smarty_tpl->tpl_vars['SELECTED_CALCULATION_FIELDS']->value)&&in_array($_smarty_tpl->tpl_vars['FIELD_CALCULATION_VALUE']->value,$_smarty_tpl->tpl_vars['SELECTED_CALCULATION_FIELDS']->value)){?> checked=""<?php }?> /></td><?php } ?></tr><?php } ?><?php } ?></table></div></div></div><?php }?><div class="modal-overlay-footer border1px clearfix"><div class="row clearfix"><div class="textAlignCenter col-lg-12 col-md-12 col-sm-12 "><button type="button" class="btn btn-soft-secondary backStep"><strong><?php echo vtranslate('LBL_BACK',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button>&nbsp;&nbsp;<button type="submit" class="btn btn-soft-secondary nextStep"><strong><?php echo vtranslate('LBL_NEXT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button>&nbsp;&nbsp;<a class="cancelLink btn btn-soft-danger" onclick="window.history.back()"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
