<?php /* Smarty version Smarty-3.1.7, created on 2025-03-12 10:34:50
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/ServiceOrders/partials/LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:181913945367d1634aa7f176-63436643%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd023e201626a68697a99e4af45044d65a65cacce' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/ServiceOrders/partials/LineItemsContent.tpl',
      1 => 1733391377,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '181913945367d1634aa7f176-63436643',
  'function' => 
  array (
  ),
  'variables' => 
...
<?php }?></div><?php }?></td><?php }?><td><?php if ($_smarty_tpl->tpl_vars['COMMENT_EDITABLE']->value){?><div><textarea  readonly style="pointer-events: none;background-color:#eeeeee" id="<?php echo $_smarty_tpl->tpl_vars['comment']->value;?>
" readonly name="<?php echo $_smarty_tpl->tpl_vars['comment']->value;?>
" class="lineItemCommentBox"><?php echo decode_html($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['comment']->value]);?>
</textarea></div><?php }?></td><td><input id="<?php echo $_smarty_tpl->tpl_vars['qty']->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars['qty']->value;?>
" type="text" class="qty smallInputBox inputElement"data-rule-positive=true data-rule-greater_than_zero=true value="<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value])){?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value];?>
...
<?php }else{ ?>0<?php }?></span><?php }?></td><input type="hidden" id="fildNamesOfCustFields" value=<?php echo ZEND_JSON::encode($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELDNAMES']->value);?>
...
" name="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" class="hide <?php echo $_smarty_tpl->tpl_vars['fieldName']->value;?>
"><?php echo decode_html($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value]);?>
</textarea></div><?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='16'){?><select style="min-width: 150px;" id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" class="select2-container inputElement select2 inputElement picklistfield" name="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
...
</option><?php } ?></select><?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='56'){?><input class="inputElement <?php echo $_smarty_tpl->tpl_vars['fieldName']->value;?>
 hide" id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
