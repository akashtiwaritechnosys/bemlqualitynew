<?php /* Smarty version Smarty-3.1.7, created on 2025-02-19 12:56:27
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Vtiger/ShowAllComments.tpl" */ ?>
<?php /*%%SmartyHeaderCode:77718988167b5d4fbe53668-05411391%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '210f3be86071940b2d25bee4f9f755dd4b89bf47' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Vtiger/ShowAllComments.tpl',
      1 => 1733391286,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '77718988167b5d4fbe53668-05411391',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_67b5d4fbe68ca',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_67b5d4fbe68ca')) {function content_67b5d4fbe68ca($_smarty_tpl) {?>
...
"></i>&nbsp;&nbsp;<?php }?><button class="btn btn-soft-success btn-sm saveComment" type="button" data-mode="add"><strong><?php echo vtranslate('LBL_POST',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
" rows="<?php echo $_smarty_tpl->tpl_vars['COMMENT_TEXTAREA_DEFAULT_ROWS']->value;?>
"></textarea></div></div><input type="hidden" name="is_private"><div class="pull-right row"><button class="btn btn-soft-success btn-sm saveComment" type="button" data-mode="edit"><strong><?php echo vtranslate('LBL_POST',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</strong></button><a href="javascript:void(0);" class="cursorPointer closeCommentBlock cancelLink btn btn-soft-danger" type="reset"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
