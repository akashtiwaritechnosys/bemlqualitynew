<?php /* Smarty version Smarty-3.1.7, created on 2026-02-27 09:45:36
         compiled from "C:\wamp64\www\bemlqualitynew\includes\runtime/../../layouts/v7\modules\Vtiger\ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18379186569a167c010aac1-83690126%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0a0871950a1c5bc6506f31bb52cca6d211189758' => 
    array (
      0 => 'C:\\wamp64\\www\\bemlqualitynew\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\ListViewContents.tpl',
      1 => 1733391286,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18379186569a167c010aac1-83690126',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69a167c0543fe',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69a167c0543fe')) {function content_69a167c0543fe($_smarty_tpl) {?>
...
<div class="col-sm-12 col-xs-12 table_UI">
	<?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='EmailTemplates'&&$_smarty_tpl->tpl_vars['SEARCH_MODE_RESULTS']->value!=true){?>
		...
		<div class="essentials-toggle btn btn-soft-dark" title="<?php echo vtranslate('LBL_LEFT_PANEL_SHOW_HIDE','Vtiger');?>
">
...
&nbsp;
							<?php if (!$_smarty_tpl->tpl_vars['NO_SORTING']->value){?>
								<?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value==$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')){?>
									<?php if ($_smarty_tpl->tpl_vars['FASORT_IMAGE']->value=='fa-sort-desc'){?><i class="fa fa-arrow-up"></i><?php }else{ ?> <i class="fa fa-arrow-down"></i> <?php }?> 
								<?php }else{ ?>
									&#8645;
								<?php }?>
							<?php }?>
				...
				<?php if ($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->isQuickSearchEnabled()&&!$_smarty_tpl->tpl_vars['SEARCH_MODE_RESULTS']->value){?>
                                    <tr class="searchRow listViewSearchContainer">
                                        <th class="inline-search-btn">
                                            <div class="table-actions">
                                                <button class="btn btn-soft-primary btn-sm <?php if (count($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value)>0){?>hide<?php }?>" data-trigger="listSearch">
                                                    <i class="fa fa-search"></i> &nbsp;
                                                    <span class="s2-btn-text"><?php echo vtranslate("LBL_SEARCH",$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span>
                                                </button>
                                                <button class="searchAndClearButton t-btn-sm btn btn-soft-danger <?php if (count($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value)==0){?>hide<?php }?>" data-trigger="clearListSearch"><i class="fa fa-close"></i>&nbsp;<?php echo vtranslate("LBL_CLEAR",$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button>
                                            </div>
                                        </th>
                                    <?php  $_smarty_tpl->tpl_vars['LISTVIEW_HEADER'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->_loop = false;
...
<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value;?>
										...
										<?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='phone'){?>
											<span class="whatsApp" pill style="background-color: rgb(78 78 204);color: rgb(255 255 255);padding: 3px;border-radius: 25px;" variant="dark"><?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value;?>
 </span>
