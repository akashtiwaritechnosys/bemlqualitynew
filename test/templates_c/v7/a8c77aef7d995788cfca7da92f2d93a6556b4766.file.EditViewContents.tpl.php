<?php /* Smarty version Smarty-3.1.7, created on 2023-11-16 08:56:01
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/HelpDesk/partials/EditViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8156263886348235c2a8c01-68676021%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a8c77aef7d995788cfca7da92f2d93a6556b4766' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/HelpDesk/partials/EditViewContents.tpl',
      1 => 1699267090,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8156263886348235c2a8c01-68676021',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_6348235c30a2d',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_6348235c30a2d')) {function content_6348235c30a2d($_smarty_tpl) {?><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
' /><?php }?><div name='editContent' class="details" style="padding-top: 30px;"><input type="hidden" disabled name="MANDATORYFIELDS" data-value='<?php echo htmlspecialchars(ZEND_JSON::encode($_smarty_tpl->tpl_vars['MANDATORYFIELDS']->value), ENT_QUOTES, 'UTF-8', true);?>
...
</div></div><?php }?><?php if ($_smarty_tpl->tpl_vars['SPECIAL_ERROR']->value){?><div class="fieldBlockContainer duplicationMessageContainer"><div class="duplicationMessageHeader"><b>Error</b></div><div><?php echo $_smarty_tpl->tpl_vars['SPECIAL_ERROR']->value;?>
...
?><?php if (count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)>0){?><div class='fieldBlockContainer fieldBlockHeader block' data-block="<?php echo $_smarty_tpl->tpl_vars['BLOCK_LABEL']->value;?>
"><h4 class="textOverflowEllipsis maxWidth50"><img class="cursorPointer alignMiddle blockToggle hide" src="<?php echo vimage_path('arrowRight.png');?>
" data-mode="hide"><img class="cursorPointer alignMiddle blockToggle" src="<?php echo vimage_path('arrowdown.png');?>
" data-mode="show">&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['BLOCK_LABEL']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
</h4><hr><div  class="container blockData"><div class="row"><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['FIELD_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FIELD_MODEL']->_loop = false;
...
?><?php $_smarty_tpl->tpl_vars["isReferenceField"] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType(), null, 0);?><?php $_smarty_tpl->tpl_vars['FIELD_INFO'] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldInfo(), null, 0);?><?php $_smarty_tpl->tpl_vars["refrenceList"] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getReferenceList(), null, 0);?><?php $_smarty_tpl->tpl_vars["refrenceListCount"] = new Smarty_variable(count($_smarty_tpl->tpl_vars['refrenceList']->value), null, 0);?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isEditable()==true){?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName()=='pincode'){?><h4 class="hide" id="currentEqLocationHolder">Current Equipment Location</h4><?php }?><div style="padding:10px;" id="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName();?>
hideOrShowId" class="col-sm-6 col-md-6 col-lg-6 parentTRDiv <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName()!='ticket_type'){?> hide <?php }?>"><div class="row"><div class="col-sm-5 col-md-5 col-lg-5" style="padding:10px;color: #2c3b49;opacity: 0.8;font-size: 14px;"><?php if ($_smarty_tpl->tpl_vars['MASS_EDITION_MODE']->value){?><input class="inputElement" id="include_in_mass_edit_<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName();?>
...
<?php }?><?php }else{ ?><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['MODULE']->value);?>
<?php }?><?php }?>&nbsp;<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()==true){?> <span class="redColor">*</span> <?php }?></div><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!='83'){?><div class="col-sm-7 col-md-7 col-lg-7"><div  id="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName();?>
hideOrShowInputId" <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
<?php $_tmp1=ob_get_clean();?><?php if (in_array($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype'),array('19','69'))||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=='description'||(($_smarty_tpl->tpl_vars['FIELD_NAME']->value=='recurringtype'||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=='reminder_time')&&in_array($_tmp1,array('Events','Calendar')))){?> class="fieldValueWidth80 <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName()!='ticket_type'){?> hide <?php }?>"  colspan="3" <?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?> <?php }elseif($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='56'){?> class="checkBoxType <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName()!='ticket_type'){?> hide <?php }?>" <?php }elseif($_smarty_tpl->tpl_vars['isReferenceField']->value=='reference'||$_smarty_tpl->tpl_vars['isReferenceField']->value=='multireference'){?> class="p-t-8 <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName()!='ticket_type'){?> hide <?php }?>" <?php }else{ ?>class="<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName()!='ticket_type'){?> hide <?php }?>" <?php }?>><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getUITypeModel()->getTemplateName(),$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
</div></div><?php }?><?php }?></hr></div></div><?php } ?><?php if ((1 & $_smarty_tpl->tpl_vars['COUNTER']->value)){?><div class="col-sm-6 col-md-6 col-lg-6"></div><div class="col-sm-6 col-md-6 col-lg-6"></div><?php }?></div></div></div><?php }?><?php } ?></div><script type="text/javascript" src="<?php echo vresource_url('layouts/v7/modules/Users/resources/intlTelInput.js');?>
"></script>
<?php }} ?>