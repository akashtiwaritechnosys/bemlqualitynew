<?php /* Smarty version Smarty-3.1.7, created on 2025-01-20 07:41:42
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/ServiceReports/LineItemsDetailShortDam1.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1285615582678dfe364ffc20-37332871%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '691f69accbb4c8a56a416755bd336be52f24059f' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/ServiceReports/LineItemsDetailShortDam1.tpl',
      1 => 1733391286,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1285615582678dfe364ffc20-37332871',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_678dfe36563b6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_678dfe36563b6')) {function content_678dfe36563b6($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['ITEM_DETAILS_BLOCK'] = new Smarty_variable($_smarty_tpl->tpl_vars['BLOCK_LIST']->value['LBL_ITEM_DETAILS'], null, 0);?>
...
<?php }?>
<?php if ($_smarty_tpl->tpl_vars['SERVICEREPORTTYPE']->value=='PRE-DELIVERY'||$_smarty_tpl->tpl_vars['SERVICEREPORTTYPE']->value=='ERECTION AND COMMISSIONING'){?>
    <?php $_smarty_tpl->tpl_vars['PRODUCT_VIEWABLE'] = new Smarty_variable(false, null, 0);?>
...
" class="lineItemBlockHeader">
                <?php $_smarty_tpl->tpl_vars['REGION_LABEL'] = new Smarty_variable(vtranslate('Major_Aggregates_Sl_No',$_smarty_tpl->tpl_vars['MODULE_NAME']->value), null, 0);?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['REGION_LABEL'] = new Smarty_variable($_tmp1." : ".($_smarty_tpl->tpl_vars['TAX_REGION_MODEL']->value->getName()), null, 0);?>
                    <?php }?>
                <?php }?>
                <h4><?php echo $_smarty_tpl->tpl_vars['REGION_LABEL']->value;?>
 </h4>
            </th>
            </thead>
            <tbody>
