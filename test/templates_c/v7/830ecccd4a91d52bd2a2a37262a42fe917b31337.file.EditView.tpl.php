<?php /* Smarty version Smarty-3.1.7, created on 2024-12-09 13:20:08
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/ServiceReports/EditView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:752657696756ee88aa35c5-97211391%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '830ecccd4a91d52bd2a2a37262a42fe917b31337' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/ServiceReports/EditView.tpl',
      1 => 1733391285,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '752657696756ee88aa35c5-97211391',
  'function' => 
  array (
  ),
  'variables' => 
...
" /><?php }?><input type="hidden" name="action" value="Save" /><input type="hidden" id="is_submitted" name="is_submitted" value="0" /><input type="hidden" name="record" value="<?php echo $_smarty_tpl->tpl_vars['RECORD_ID']->value;?>
...
" /><?php }?><input type="hidden" name="MANDATORYFIELDS" data-value='<?php echo htmlspecialchars(ZEND_JSON::encode($_smarty_tpl->tpl_vars['MANDATORYFIELDS']->value), ENT_QUOTES, 'UTF-8', true);?>
...
</div></div><div class='modal-overlay-footer clearfix'><div class="row clearfix"><div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '><button type='submit' class='btn btn-soft-success saveButton' onclick="document.getElementById('is_submitted').value = 0;<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_Edit_Js.deMandatoryDependency(event)"><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button>&nbsp;&nbsp;<button type='submit' class='btn btn-soft-success saveButton' onclick="document.getElementById('is_submitted').value = 1;<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_Edit_Js.handleMandatoryDependency(event)"><?php echo vtranslate('Submit And Close',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button>&nbsp;&nbsp;<a class='btn btn-soft-danger cancelLink' href="javascript:history.<?php if ($_smarty_tpl->tpl_vars['DUPLICATE_RECORDS']->value){?>go(-2)<?php }else{ ?>back()<?php }?>" type="reset"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
