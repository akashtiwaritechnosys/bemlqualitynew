<?php /* Smarty version Smarty-3.1.7, created on 2024-12-05 13:02:18
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Users/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12531054806751a45a8b5a93-65864985%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '422e00fae0f8398248220712a2d02735f442cfd3' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Users/ListViewContents.tpl',
      1 => 1733391286,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12531054806751a45a8b5a93-65864985',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6751a45a8e5fe',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6751a45a8e5fe')) {function content_6751a45a8e5fe($_smarty_tpl) {?>
...
&nbsp;<?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value==$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')){?><?php if ($_smarty_tpl->tpl_vars['FASORT_IMAGE']->value=='fa-sort-desc'){?><i class="fa fa-arrow-up"></i><?php }else{ ?> <i class="fa fa-arrow-down"></i> <?php }?><?php }else{ ?>&#8645;<?php }?></a><?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value==$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')){?><a href="#" class="removeSorting"><i class="fa fa-remove"></i></a><?php }?></th><?php }?><?php } ?></tr></thead><tbody class="overflow-y"><?php if ($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->isQuickSearchEnabled()&&!$_smarty_tpl->tpl_vars['SEARCH_MODE_RESULTS']->value){?><tr class="searchRow listViewSearchContainer"><th class="user-inline-search-btn"><div class="table-actions"><?php $_smarty_tpl->tpl_vars['HIDE_CLEAR_SEARCH'] = new Smarty_variable(false, null, 0);?><?php if (count($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value)==0||(is_array($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value[0])&&count($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value[0])==0&&count($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value)==1)){?><?php $_smarty_tpl->tpl_vars['HIDE_CLEAR_SEARCH'] = new Smarty_variable(true, null, 0);?><?php }?><button class="btn btn-soft-primary <?php if (!$_smarty_tpl->tpl_vars['HIDE_CLEAR_SEARCH']->value){?>hide<?php }?>" data-trigger="listSearch"><i class="fa fa-search"></i> &nbsp;<span class="s2-btn-text"><?php echo vtranslate("LBL_SEARCH",$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span></button><button class="searchAndClearButton btn btn-soft-danger btn-sm <?php if ($_smarty_tpl->tpl_vars['HIDE_CLEAR_SEARCH']->value){?>hide<?php }?>" data-trigger="clearListSearch"><i class="fa fa-close"></i>&nbsp;<?php echo vtranslate("LBL_CLEAR",$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
"></div><?php }?><?php } ?><?php if ($_smarty_tpl->tpl_vars['IMAGE_DETAILS']->value[0]['id']==null){?><div class='col-lg-2'><i class="fa fa-user abc userDefaultIcon"></i></div><?php }?><div class="usersinfo col-lg-9 textOverflowEllipsis" title="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get('last_name');?>
