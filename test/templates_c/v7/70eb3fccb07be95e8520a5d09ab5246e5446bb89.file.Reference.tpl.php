<?php /* Smarty version Smarty-3.1.7, created on 2025-04-08 13:00:39
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/StockTransferOrders/uitypes/Reference.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14470519367f51df7d147b7-58559283%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70eb3fccb07be95e8520a5d09ab5246e5446bb89' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/StockTransferOrders/uitypes/Reference.tpl',
      1 => 1733391378,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14470519367f51df7d147b7-58559283',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_67f51df7d2988',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_67f51df7d2988')) {function content_67f51df7d2988($_smarty_tpl) {?>
...
'<?php }?>/><?php if ($_smarty_tpl->tpl_vars['FIELD_NAME']->value=='equipment_id'||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=='ticket_id'){?><?php }else{ ?><a href="#" class="clearReferenceSelection <?php if ($_smarty_tpl->tpl_vars['FIELD_VALUE']->value==0){?>hide<?php }?>"> x </a><span class="input-group-addon relatedPopup cursorPointer" title="<?php echo vtranslate('LBL_SELECT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
