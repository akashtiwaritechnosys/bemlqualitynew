<?php /* Smarty version Smarty-3.1.7, created on 2026-02-27 10:20:56
         compiled from "C:\wamp64\www\bemlqualitynew\includes\runtime/../../layouts/v7\modules\Equipment\ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:105625024369a170088eefc3-02611265%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '66ed01dec373ae05feabee18863492018aaa61f0' => 
    array (
      0 => 'C:\\wamp64\\www\\bemlqualitynew\\includes\\runtime/../../layouts/v7\\modules\\Equipment\\ModuleHeader.tpl',
      1 => 1733391283,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '105625024369a170088eefc3-02611265',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69a17008c1123',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69a17008c1123')) {function content_69a17008c1123($_smarty_tpl) {?><div class="col-sm-11 col-xs-10 padding0 module-action-bar clearfix coloredBorderTop"><div class="module-action-content clearfix <?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
-module-action-content"><div class="col-lg-4 col-md-6 col-sm-4 col-xs-11 padding0 module-breadcrumb module-breadcrumb-<?php echo $_REQUEST['view'];?>
...
">&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
 &nbsp;&nbsp;</a></p><?php }?></div><div class="col-lg-8 col-md-6 col-sm-8 col-xs-1 padding0 pull-right"><div id="appnav" class="navbar-right"><nav class="navbar navbar-inverse border0 margin0"><div class="container-fluid"><div class="navbar-header marginTop5px"><button type="button" class="navbar-toggle collapsed margin0" data-toggle="collapse" data-target="#appnavcontent" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></button></div><div class="navbar-collapse collapse" id="appnavcontent" aria-expanded="false" style="height: 1px;"><ul class="nav navbar-nav"><?php if (count($_smarty_tpl->tpl_vars['MODULE_BASIC_ACTIONS']->value)>0){?><?php  $_smarty_tpl->tpl_vars['BASIC_ACTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BASIC_ACTION']->_loop = false;
...
" type="button" class="btn addButton btn-soft-info module-btn"<?php if (stripos($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(),'javascript:')===0){?>onclick='<?php echo substr($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(),strlen("javascript:"));?>
...
" type="button" class="btn addButton btn-soft-blue module-btn"<?php if (stripos($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(),'javascript:')===0){?>onclick='<?php echo substr($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(),strlen("javascript:"));?>
;'<?php }else{ ?>onclick='window.location.href = "<?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl();?>
&app=<?php echo $_smarty_tpl->tpl_vars['SELECTED_MENU_CATEGORY']->value;?>
"'<?php }?>><div class="fa <?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getIcon();?>
" aria-hidden="true"></div>&nbsp;&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button></li><?php }?><?php } ?><?php }?><?php if ($_smarty_tpl->tpl_vars['USER_MODEL']->value->isAdminUser()){?><?php if ($_REQUEST['view']=='List'){?><li><button id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_basicAction_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores('Sync All');?>
" type="button" class="btn addButton btn-soft-info module-btn"onclick="Equipment_List_Js.getAllAgregates(1)"><div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;Sync All Aggregates</button></li><li><button id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_basicAction_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores('Sync All');?>
" type="button" class="btn addButton btn-soft-info module-btn"onclick="Equipment_List_Js.syncToSAPEquipment(1)"><div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;Sync All Equipments</button></li><li><button id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_basicAction_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores('Sync All');?>
" type="button" class="btn addButton btn-soft-info module-btn"onclick="Equipment_List_Js.getUpdateWarrentyStatus()"><div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;Update Warrenty Status</button></li><li><button id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_basicAction_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores('Sync All');?>
" type="button" class="btn addButton btn-soft-info module-btn"onclick="Equipment_List_Js.getUpdateRunningContractYear()"><div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;Update Contract Year</button></li><li><button id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_basicAction_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores('Sync Recently Updated');?>
" type="button" class="btn addButton btn-soft-info module-btn"onclick="Equipment_List_Js.getUpdatedRecods('')"><div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;Sync Recently Updated</button></li><?php }?><?php }?><?php if (count($_smarty_tpl->tpl_vars['MODULE_SETTING_ACTIONS']->value)>0){?><li><div class="settingsIcon"><button type="button" class="btn btn-soft-dark dropdown-toggle module-btn" data-toggle="dropdown" aria-expanded="false" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</a></li><?php } ?></ul></div></li><?php }?></ul></div><!-- /.navbar-collapse --></div><!-- /.container-fluid --></nav></div></div></div><?php if ($_smarty_tpl->tpl_vars['FIELDS_INFO']->value!=null){?><script type="text/javascript">var uimeta = (function () {var fieldInfo = <?php echo $_smarty_tpl->tpl_vars['FIELDS_INFO']->value;?>
