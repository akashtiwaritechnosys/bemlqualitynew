<?php /* Smarty version Smarty-3.1.7, created on 2023-12-05 07:36:22
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/ReturnSaleOrders/LineItemsDetail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:160703211963a5a9aaddf3c4-40164201%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7b45c65a4963b54e1192e65016308a900621502a' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/ReturnSaleOrders/LineItemsDetail.tpl',
      1 => 1699267087,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '160703211963a5a9aaddf3c4-40164201',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_63a5a9aae2f98',
  'variables' => 
  array (
    'BLOCK_LIST' => 0,
...
<?php if ($_valid && !is_callable('content_63a5a9aae2f98')) {function content_63a5a9aae2f98($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['ITEM_DETAILS_BLOCK'] = new Smarty_variable($_smarty_tpl->tpl_vars['BLOCK_LIST']->value['LBL_ITEM_DETAILS'], null, 0);?>
...
?>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['fieldlabel']=='Present Status'||$_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['fieldlabel']=='Action Taken by DSM'){?>
                            <td><strong> <?php echo $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['fieldlabel'];?>
 Qty </strong></td>
                            <?php }?>
                    <?php } ?>
                </tr>
...
?>
                            ...
                            <td>
                                <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['fieldlabel']=='Present Status'){?>
...
?>
                                        <?php $_smarty_tpl->tpl_vars["subfieldName"] = new Smarty_variable($_smarty_tpl->tpl_vars['SUB_LINEITEM_CUSTOM_FIELD']->value['fieldname'], null, 0);?>
                                        <?php $_smarty_tpl->tpl_vars["subfieldLabel"] = new Smarty_variable($_smarty_tpl->tpl_vars['SUB_LINEITEM_CUSTOM_FIELD']->value['fieldlabel'], null, 0);?>
                                        <table>
                                            <tr>
                                                <td>
                                                    <label style="white-space: nowrap;margin-top:2px;"><?php echo $_smarty_tpl->tpl_vars['subfieldLabel']->value;?>
</label>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['fieldlabel']=='Action Taken by DSM'){?>
...
?>
                                        <?php $_smarty_tpl->tpl_vars["sub2fieldName"] = new Smarty_variable($_smarty_tpl->tpl_vars['SUB2_LINEITEM_CUSTOM_FIELD']->value['fieldname'], null, 0);?>
                                        <?php $_smarty_tpl->tpl_vars["sub2fieldLabel"] = new Smarty_variable($_smarty_tpl->tpl_vars['SUB2_LINEITEM_CUSTOM_FIELD']->value['fieldlabel'], null, 0);?>
                                        <table>
                                            <tr>
                                                <td>
                                                    <label style="white-space: nowrap;margin-top:2px;"><?php echo $_smarty_tpl->tpl_vars['sub2fieldLabel']->value;?>
</label>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='10'){?>
                                    <?php echo $_smarty_tpl->tpl_vars['LINE_ITEM_DETAIL']->value["vendor_name_Label".($_smarty_tpl->tpl_vars['INDEX']->value)];?>
...
?>
                                        <?php $_smarty_tpl->tpl_vars["subfieldName"] = new Smarty_variable($_smarty_tpl->tpl_vars['SUB_LINEITEM_CUSTOM_FIELD']->value['fieldname'], null, 0);?>
                                        <?php $_smarty_tpl->tpl_vars["subfieldLabel"] = new Smarty_variable($_smarty_tpl->tpl_vars['SUB_LINEITEM_CUSTOM_FIELD']->value['fieldlabel'], null, 0);?>
                                        <div id="<?php echo $_smarty_tpl->tpl_vars['subfieldName']->value;?>
DivCla">
                                            <table>
                                            <tr>
                                                <td>
                                                    <label style="white-space: nowrap;margin-top:2px;"><?php echo $_smarty_tpl->tpl_vars['LINE_ITEM_DETAIL']->value[($_smarty_tpl->tpl_vars['subfieldName']->value).($_smarty_tpl->tpl_vars['INDEX']->value)];?>
</label>
                                                </td>
                                            </tr>
                                        </table>
...
?>
                                        ...
                                        <tr>
                                            <td>
                                                <label style="white-space: nowrap;margin-top:2px;"><?php echo $_smarty_tpl->tpl_vars['LINE_ITEM_DETAIL']->value[($_smarty_tpl->tpl_vars['sub2fieldName']->value).($_smarty_tpl->tpl_vars['INDEX']->value)];?>
</label>
                                            </td>
                                        </tr>
                                    </table>
