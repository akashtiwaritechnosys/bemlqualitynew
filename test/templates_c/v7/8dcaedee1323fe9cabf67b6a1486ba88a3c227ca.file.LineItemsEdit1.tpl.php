<?php /* Smarty version Smarty-3.1.7, created on 2023-06-06 10:24:52
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/RecommissioningReports/partials/LineItemsEdit1.tpl" */ ?>
<?php /*%%SmartyHeaderCode:632857565635a7c5e3a4769-84327914%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8dcaedee1323fe9cabf67b6a1486ba88a3c227ca' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/RecommissioningReports/partials/LineItemsEdit1.tpl',
      1 => 1683545723,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '632857565635a7c5e3a4769-84327914',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_635a7c5e4d9be',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_635a7c5e4d9be')) {function content_635a7c5e4d9be($_smarty_tpl) {?><?php  $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->_loop = false;
...
</option></select></div></div></div></div></div><div class="lineitemTableContainer"><?php if ($_smarty_tpl->tpl_vars['REPORTTYPE']->value=='WARRANTY CLAIM FOR SUB ASSEMBLY / OTHER SPARE PARTS'){?><span class="btn btn-primary" id="SubAssemblyLookUP">Look For Availabel Sub Assembly</span></br></br><?php }?><table class="table table-bordered" id="lineItemTab1"><tr><td><strong><?php echo vtranslate('LBL_SLNO',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></td><?php } ?></tr><tr id="anorow0" class="hide lineItemCloneCopy" data-row-num="0"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsContent1.tpl",'RecommissioningReports'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>0,'data'=>array(),'IGNORE_UI_REGISTRATION'=>true), 0);?>
</tr><?php if (count($_smarty_tpl->tpl_vars['RELATED_PRODUCTS_OTHER']->value)>0){?><?php  $_smarty_tpl->tpl_vars['data'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['data']->_loop = false;
 $_smarty_tpl->tpl_vars['row_no'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['RELATED_PRODUCTS_OTHER']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
<?php }?>><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsContent1.tpl",'RecommissioningReports'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>$_smarty_tpl->tpl_vars['row_no']->value,'data'=>$_smarty_tpl->tpl_vars['data']->value), 0);?>
</tr><?php } ?><?php }?></table></div></div><?php }?></div><br><?php if ($_smarty_tpl->tpl_vars['SERVICEREPORTTYPE']->value!='SERVICE FOR SPARES PURCHASED'){?><div><div><?php if ($_smarty_tpl->tpl_vars['PRODUCT_ACTIVE']->value=='true'&&$_smarty_tpl->tpl_vars['SERVICE_ACTIVE']->value=='true'){?><div class="btn-toolbar"><span class="btn-group"><button type="button" class="btn btn-default" id="addProduct1" data-module-name="Products" ><i class="fa fa-plus"></i>&nbsp;&nbsp;<strong><?php echo vtranslate('LBL_ADD_PRODUCT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></button></span></div><?php }elseif($_smarty_tpl->tpl_vars['PRODUCT_ACTIVE']->value=='true'){?><div class="btn-group"><button type="button" class="btn btn-default" id="addProduct1" data-module-name="Products"><i class="fa fa-plus"></i><strong>&nbsp;&nbsp;<?php if ($_smarty_tpl->tpl_vars['SERVICEREPORTTYPE']->value=='PERIODICAL MAINTENANCE'){?><?php echo vtranslate('LBL_ADD_AGGREGATE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
<?php }else{ ?> <?php echo vtranslate('LBL_ADD_PRODUCT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 <?php }?></strong></button></div><?php }elseif($_smarty_tpl->tpl_vars['SERVICE_ACTIVE']->value=='true'){?><div class="btn-group"><button type="button" class="btn btn-default" id="addService" data-module-name="Services"><i class="fa fa-plus"></i><strong>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD_SERVICE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button></div><?php }?></div></div><br><?php }?><?php }} ?>