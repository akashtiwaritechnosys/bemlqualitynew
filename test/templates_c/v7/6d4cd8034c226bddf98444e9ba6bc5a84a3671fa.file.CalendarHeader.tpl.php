<?php /* Smarty version Smarty-3.1.7, created on 2022-08-07 11:09:33
         compiled from "C:\xampp\htdocs\beml\includes\runtime/../../layouts/v7\modules\Calendar\CalendarHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:41772756462ef9d6d8d39d1-59031170%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d4cd8034c226bddf98444e9ba6bc5a84a3671fa' => 
    array (
      0 => 'C:\\xampp\\htdocs\\beml\\includes\\runtime/../../layouts/v7\\modules\\Calendar\\CalendarHeader.tpl',
      1 => 1651513240,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '41772756462ef9d6d8d39d1-59031170',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62ef9d6d9bdc5',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62ef9d6d9bdc5')) {function content_62ef9d6d9bdc5($_smarty_tpl) {?>
...
"><div class="col-sm-12 col-xs-12 module-action-bar clearfix"><div class="module-action-content clearfix coloredBorderTop"><div class="col-lg-5 col-md-5"><span><?php $_smarty_tpl->tpl_vars["VIEW_HEADER_LABEL"] = new Smarty_variable("LBL_CALENDAR_VIEW", null, 0);?><?php if ($_smarty_tpl->tpl_vars['VIEW']->value==='SharedCalendar'){?><?php $_smarty_tpl->tpl_vars["VIEW_HEADER_LABEL"] = new Smarty_variable("LBL_SHARED_CALENDAR", null, 0);?><?php }?><a href='javascript:void(0)'><h4 class="module-title pull-left"><span style="cursor: default;"> <?php echo strtoupper(vtranslate($_smarty_tpl->tpl_vars['VIEW_HEADER_LABEL']->value,$_smarty_tpl->tpl_vars['MODULE']->value));?>
 </span></h4></a></span></div><div class="col-lg-7 col-md-7 pull-right"><div id="appnav" class="navbar-right"><ul class="nav navbar-nav"><?php if ($_smarty_tpl->tpl_vars['IS_CREATE_PERMITTED']->value){?><li><button id="calendarview_basicaction_addevent" type="button"class="btn addButton btn-soft-blue module-btn cursorPointer"onclick='Calendar_Calendar_Js.showCreateEventModal();'><div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD_EVENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><button id="calendarview_basicaction_addtask" type="button"class="btn addButton btn-soft-blue module-btn cursorPointer"onclick='Calendar_Calendar_Js.showCreateTaskModal();'><div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD_TASK',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button></li><?php }?><li><div class="settingsIcon"><button type="button" class="btn btn-soft-dark module-btn dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span class="fa fa-wrench" aria-hidden="true" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
