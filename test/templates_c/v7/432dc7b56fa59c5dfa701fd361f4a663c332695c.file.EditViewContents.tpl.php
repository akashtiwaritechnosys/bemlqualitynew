<?php /* Smarty version Smarty-3.1.7, created on 2022-10-04 08:11:54
         compiled from "/var/www/html/beml/includes/runtime/../../layouts/v7/modules/ServiceReports/partials/EditViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:356751256630519fa2e7c55-56781039%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '432dc7b56fa59c5dfa701fd361f4a663c332695c' => 
    array (
      0 => '/var/www/html/beml/includes/runtime/../../layouts/v7/modules/ServiceReports/partials/EditViewContents.tpl',
      1 => 1664869450,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '356751256630519fa2e7c55-56781039',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_630519fa311bf',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_630519fa311bf')) {function content_630519fa311bf($_smarty_tpl) {?><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
...
<?php }?><?php }else{ ?><?php if (count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)>0){?><div class='fieldBlockContainer' id="<?php echo $_smarty_tpl->tpl_vars['BLOCK_LABEL']->value;?>
...
"></script></div><input type="hidden" id="maxUploadSize" value="<?php echo $_smarty_tpl->tpl_vars['MAX_UPLOAD_SIZE']->value;?>
...
' /><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsEdit.tpl",'ServiceReports'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }} ?>