<?php /* Smarty version Smarty-3.1.7, created on 2026-01-14 06:53:18
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Calendar/TaskManagement.tpl" */ ?>
<?php /*%%SmartyHeaderCode:183895361569673d5e3c61a5-79629206%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f8f959b18c39428404731c335ce18476d79dfd45' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Calendar/TaskManagement.tpl',
      1 => 1733391283,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '183895361569673d5e3c61a5-79629206',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69673d5e3f220',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69673d5e3f220')) {function content_69673d5e3f220($_smarty_tpl) {?>

<div id="taskManagementContainer" class='fc-overlay-modal modal-content' style="height:100%;width: 98%; margin: auto;"><input type="hidden" name="colors" value='<?php echo json_encode($_smarty_tpl->tpl_vars['COLORS']->value);?>
'><div class="overlayHeader"><?php $_smarty_tpl->tpl_vars['HEADER_TITLE'] = new Smarty_variable("Todo List", null, 0);?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("ModalHeader.tpl",$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('TITLE'=>$_smarty_tpl->tpl_vars['HEADER_TITLE']->value), 0);?>
</div><hr style="margin:0px;"><div class='modal-body overflowYAuto'><div class='datacontent'><div class="data-header clearfix"><div class="btn-group dateFilters pull-left" role="group" aria-label="..."><button type="button" class="btn btn-soft-primary <?php if ($_smarty_tpl->tpl_vars['TASK_FILTERS']->value['date']=="all"){?>active<?php }?>" data-filtermode="all"><?php echo vtranslate('LBL_ALL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><button type="button" class="btn btn-soft-primary <?php if ($_smarty_tpl->tpl_vars['TASK_FILTERS']->value['date']=="today"){?>active<?php }?>" data-filtermode="today"><?php echo vtranslate('LBL_TODAY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><button type="button" class="btn btn-soft-primary <?php if ($_smarty_tpl->tpl_vars['TASK_FILTERS']->value['date']=="thisweek"){?>active<?php }?>" data-filtermode="thisweek"><?php echo vtranslate('LBL_THIS_WEEK',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><button type="button" class="btn btn-soft-primary dateRange dateField" data-calendar-type="range" data-filtermode="range"><i class="fa fa-calendar"></i></button><button type="button" class="btn btn-soft-primary hide rangeDisplay"><span class="selectedRange"></span>&nbsp;<i class="fa fa-times clearRange"></i></button></div><div id="taskManagementOtherFilters" class="otherFilters pull-right" style="width:550px;"><div class='field pull-left' style="width:250px;padding-right: 5px;"><?php echo $_smarty_tpl->getSubTemplate ("modules/Calendar/uitypes/OwnerFieldTaskSearchView.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('FIELD_MODEL'=>$_smarty_tpl->tpl_vars['OWNER_FIELD']->value), 0);?>
...
"><button value='<?php echo json_encode($_smarty_tpl->tpl_vars['CLASS']->value);?>
' class="<?php echo $_smarty_tpl->tpl_vars['CLASS']->value[$_smarty_tpl->tpl_vars['PRIORITY']->value];?>
"><span><?php echo $_smarty_tpl->tpl_vars['PRIORITY']->value;?>
</span></button></div><br><div class="<?php echo strtolower($_smarty_tpl->tpl_vars['PRIORITY']->value);?>
...
" aria-describedby="basic-addon1" style="width: 99%"><span class="quickTask input-group-addon js-task-popover-container more cursorPointer btn btn-soft-primary" id="basic-addon1" style="border: 1px solid #ddd; padding: 0 13px;"><a href="#" id="taskPopover" priority='<?php echo $_smarty_tpl->tpl_vars['PRIORITY']->value;?>
