<?php /* Smarty version Smarty-3.1.7, created on 2022-09-16 08:49:41
         compiled from "C:\xampp\htdocs\beml\includes\runtime/../../layouts/v7\modules\Settings\HelpDesk\HelpDeskMappingEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:502877607632438a530c7a0-26055566%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'abeeda2a2e218bd03d5e4b0bc14406894c1e0faf' => 
    array (
      0 => 'C:\\xampp\\htdocs\\beml\\includes\\runtime/../../layouts/v7\\modules\\Settings\\HelpDesk\\HelpDeskMappingEdit.tpl',
      1 => 1656095648,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '502877607632438a530c7a0-26055566',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_632438a53cf65',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_632438a53cf65')) {function content_632438a53cf65($_smarty_tpl) {?>
...
" <?php if ($_smarty_tpl->tpl_vars['FIELD_ID']->value==$_smarty_tpl->tpl_vars['MAPPING_ARRAY']->value['HelpDesk']['id']){?> selected <?php }?> label="<?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_OBJECT']->value->get('label'),$_smarty_tpl->tpl_vars['POTENTIALS_MODULE_MODEL']->value->getName());?>
...
</option><?php } ?><?php } ?></select></td><td width="15%" class="selectedFieldDataType"><?php echo vtranslate($_smarty_tpl->tpl_vars['MAPPING_ARRAY']->value['HelpDesk']['fieldDataType'],$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
$_smarty_tpl->tpl_vars['FIELD_OBJECT']->_loop = true;
 $_smarty_tpl->tpl_vars['FIELD_ID']->value = $_smarty_tpl->tpl_vars['FIELD_OBJECT']->key;
?><?php if ($_smarty_tpl->tpl_vars['MAPPING_ARRAY']->value['HelpDesk']['fieldDataType']==$_smarty_tpl->tpl_vars['FIELD_TYPE']->value){?><option data-type="<?php echo $_smarty_tpl->tpl_vars['FIELD_TYPE']->value;?>
" data-mengoti="<?php echo $_smarty_tpl->tpl_vars['MAPPING_ARRAY']->value['ServiceReports']['id'];?>
" <?php if ($_smarty_tpl->tpl_vars['FIELD_ID']->value==$_smarty_tpl->tpl_vars['MAPPING_ARRAY']->value['ServiceReports']['id']){?> selected <?php }?> label="<?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_OBJECT']->value->get('label'),$_smarty_tpl->tpl_vars['PROJECT_MODULE_MODEL']->value->getName());?>
" value="<?php echo $_smarty_tpl->tpl_vars['FIELD_ID']->value;?>
