<?php /* Smarty version Smarty-3.1.7, created on 2023-12-08 05:33:07
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Equipment/partials/LineItemsEdit2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:131280076663b42bd8140580-16597363%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4e5fdd5b018a9627da6aec77cd9f9dd9b2bf6505' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Equipment/partials/LineItemsEdit2.tpl',
      1 => 1699267090,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '131280076663b42bd8140580-16597363',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_63b42bd817725',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_63b42bd817725')) {function content_63b42bd817725($_smarty_tpl) {?><?php  $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->_loop = false;
...
><table id="lastPeriodialTable" class="table table-bordered fieldBlockContainer hide"><tbody></tbody></table><div name='editContent'><?php $_smarty_tpl->tpl_vars['LINE_ITEM_BLOCK_LABEL'] = new Smarty_variable("LBL_ITEM_DETAILS", null, 0);?><?php $_smarty_tpl->tpl_vars['BLOCK_FIELDS'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value[$_smarty_tpl->tpl_vars['LINE_ITEM_BLOCK_LABEL']->value], null, 0);?><?php $_smarty_tpl->tpl_vars['ITEMBLOCKNAMEANOTHER'] = new Smarty_variable('Contracts Avalibilty Values', null, 0);?><?php if (count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)>0||1==1){?><div class='fieldBlockContainer' id="ShortagefieldBlockContainer" ><div class="row"><div class="col-sm-6"><h4 class='fieldBlockHeader' style="margin-top:5px;"><?php echo vtranslate($_smarty_tpl->tpl_vars['ITEMBLOCKNAMEANOTHER']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
</h4></div></div><div class="lineitemTableContainerValuesHolder"><table class="table table-bordered hide" id="lineItemTab2"><thead><?php  $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->_loop = false;
...
</strong></td><?php } ?></thead><tbody class="appendRows"><tr id="row" class="hide lineItemCloneCopy" data-row-num="0"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsContent2.tpl",'Equipment'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>0,'data'=>array(),'IGNORE_UI_REGISTRATION'=>true), 0);?>
...
<?php }?>><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsContent2.tpl",'Equipment'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>$_smarty_tpl->tpl_vars['row_no']->value,'data'=>$_smarty_tpl->tpl_vars['data']->value), 0);?>
</tr><?php } ?><?php }?></tbody></table></div><div class="lineitemTableContainer"><table class="table table-bordered" id="lineItemTab2"><thead><?php  $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->_loop = false;
 $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELDKEY'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELDS_OTHER1']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->key => $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value){
$_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->_loop = true;
...
?><td data-td="<?php echo $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['fieldname'];?>
"><strong><?php echo vtranslate($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['fieldlabel'],$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></td><?php } ?></thead><tbody class="appendRows"><tr id="row" class="lineItemCloneCopy" data-row-num="0"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsContent2.tpl",'Equipment'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tabletdhiderVal'=>true,'row_no'=>0,'data'=>array(),'IGNORE_UI_REGISTRATION'=>true), 0);?>
</tr><?php if (count($_smarty_tpl->tpl_vars['RELATED_PRODUCTS_OTHER1']->value)>0){?><?php  $_smarty_tpl->tpl_vars['data'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['data']->_loop = false;
 $_smarty_tpl->tpl_vars['row_no'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['RELATED_PRODUCTS_OTHER1']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['data']->key => $_smarty_tpl->tpl_vars['data']->value){
...
" class="lineItemRow" <?php if ($_smarty_tpl->tpl_vars['data']->value["entityType".($_smarty_tpl->tpl_vars['row_no']->value)]=='Products'){?>data-quantity-in-stock=<?php echo $_smarty_tpl->tpl_vars['data']->value["qtyInStock".($_smarty_tpl->tpl_vars['row_no']->value)];?>
<?php }?>><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsContent2.tpl",'Equipment'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>$_smarty_tpl->tpl_vars['row_no']->value,'data'=>$_smarty_tpl->tpl_vars['data']->value), 0);?>
</tr><?php } ?><?php }?></tbody></table></div></div><?php }?></div><?php }} ?>