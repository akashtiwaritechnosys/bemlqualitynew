<?php /* Smarty version Smarty-3.1.7, created on 2023-11-30 05:54:12
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/SalesOrder/LineItemsDetail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:47921833663884e0b05b062-49845945%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fdbf6d49b3be769610a304063d1ec3e05535e702' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/SalesOrder/LineItemsDetail.tpl',
      1 => 1699267087,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '47921833663884e0b05b062-49845945',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_63884e0b09a41',
  'variables' => 
  array (
    'BLOCK_LIST' => 0,
...
<?php if ($_valid && !is_callable('content_63884e0b09a41')) {function content_63884e0b09a41($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['ITEM_DETAILS_BLOCK'] = new Smarty_variable($_smarty_tpl->tpl_vars['BLOCK_LIST']->value['LBL_ITEM_DETAILS'], null, 0);?>
...
" class="lineItemBlockHeader">
                <?php $_smarty_tpl->tpl_vars['REGION_LABEL'] = new Smarty_variable(vtranslate($_smarty_tpl->tpl_vars['ITEMBLOCKNAME']->value,$_smarty_tpl->tpl_vars['MODULE_NAME']->value), null, 0);?>
...
<?php $_tmp3=ob_get_clean();?><?php echo vtranslate($_tmp3,$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['QUANTITY_VIEWABLE']->value){?>
                        <td class="lineItemFieldName">
                            <strong><?php ob_start();?><?php echo 'LBL_QTY';?>
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['LINE_ITEM_DETAIL']->value["productName".($_smarty_tpl->tpl_vars['INDEX']->value)];?>
 ...
 <?php echo vtranslate('LBL_IS_DELETED_FROM_THE_SYSTEM_PLEASE_REMOVE_OR_REPLACE_THIS_ITEM',$_smarty_tpl->tpl_vars['MODULE']->value);?>
                                ...
                                <?php }?>
                                <?php $_smarty_tpl->tpl_vars['finalQty'] = new Smarty_variable((int)$_smarty_tpl->tpl_vars['LINE_ITEM_DETAIL']->value["final_qty".($_smarty_tpl->tpl_vars['INDEX']->value)], null, 0);?>
                                <?php $_smarty_tpl->tpl_vars['createdQty'] = new Smarty_variable((int)$_smarty_tpl->tpl_vars['LINE_ITEM_DETAIL']->value["rso_created_qty".($_smarty_tpl->tpl_vars['INDEX']->value)], null, 0);?>
                                <?php $_smarty_tpl->tpl_vars['creatableQTy'] = new Smarty_variable($_smarty_tpl->tpl_vars['finalQty']->value-$_smarty_tpl->tpl_vars['createdQty']->value, null, 0);?>
                                <?php if ($_smarty_tpl->tpl_vars['creatableQTy']->value>0&&$_smarty_tpl->tpl_vars['CAN_CREATE_RSO']->value==true){?>
                                    <h5>
                                        <a class="fieldValue" 
                                            href="index.php?module=ReturnSaleOrders&view=Edit&parent_line_itemid=<?php echo $_smarty_tpl->tpl_vars['LINE_ITEM_DETAIL']->value["igLineItemId".($_smarty_tpl->tpl_vars['INDEX']->value)];?>
&sale_order_id=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('id');?>
&ext_app_num_noti=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('po_no');?>
" target="_self">
