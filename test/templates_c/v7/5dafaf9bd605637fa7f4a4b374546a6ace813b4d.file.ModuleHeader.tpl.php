<?php /* Smarty version Smarty-3.1.7, created on 2026-02-27 10:11:40
         compiled from "C:\wamp64\www\bemlqualitynew\includes\runtime/../../layouts/v7\modules\ServiceEngineer\ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:184339548369a16ddc1e9c17-20893501%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5dafaf9bd605637fa7f4a4b374546a6ace813b4d' => 
    array (
      0 => 'C:\\wamp64\\www\\bemlqualitynew\\includes\\runtime/../../layouts/v7\\modules\\ServiceEngineer\\ModuleHeader.tpl',
      1 => 1738752009,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '184339548369a16ddc1e9c17-20893501',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_69a16ddc3f6a3',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_69a16ddc3f6a3')) {function content_69a16ddc3f6a3($_smarty_tpl) {?>
...
"'<?php }?>><div class="fa <?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getIcon();?>
" aria-hidden="true"></div>&nbsp;&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button></li><?php }?><?php } ?><li><button id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_basicAction_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores('Recalculate Equipments');?>
" type="button" class="btn addButton btn-soft-info module-btn"onclick="ServiceEngineer_List_Js.recalculateEquipments(1)"><div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;Recalculate Equipments</button></li><?php if (count($_smarty_tpl->tpl_vars['MODULE_SETTING_ACTIONS']->value)>0){?><li><div class="settingsIcon"><button type="button" class="btn btn-soft-dark dropdown-toggle module-btn" data-toggle="dropdown" aria-expanded="false" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
