<?php /* Smarty version Smarty-3.1.7, created on 2022-10-06 11:53:11
         compiled from "/var/www/html/beml/includes/runtime/../../layouts/v7/modules/ServiceEngineer/DetailViewHeaderFieldsView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2095241445633ec1a7ac2334-58982890%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '11f15009e00d4fd14f077100738daa85f8595535' => 
    array (
      0 => '/var/www/html/beml/includes/runtime/../../layouts/v7/modules/ServiceEngineer/DetailViewHeaderFieldsView.tpl',
      1 => 1665056729,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2095241445633ec1a7ac2334-58982890',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_633ec1a7affdd',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_633ec1a7affdd')) {function content_633ec1a7affdd($_smarty_tpl) {?>
...
" data-displayvalue='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getDisplayValue($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')));?>
' data-value="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue');?>
" /><?php }?></span><span class="action"><a href="#" onclick="return false;" class="editAction fa fa-pencil"></a></span><?php }?></div></div><?php }?><?php } ?><div class="info-row row headerAjaxEdit td"><div class="col-lg-7 fieldLabel"><span class=" value"><b> Approval Status : </b> <?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('approval_status');?>
