<?php /* Smarty version Smarty-3.1.7, created on 2026-01-08 12:13:43
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Vtiger/Export.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1532124403695f9f777e5369-45842329%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '073379fd9839e7f60bf57c2dc9d9fedf327ef1c6' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Vtiger/Export.tpl',
      1 => 1733391286,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1532124403695f9f777e5369-45842329',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_695f9f778301d',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_695f9f778301d')) {function content_695f9f778301d($_smarty_tpl) {?>
...
&nbsp;</div></div><?php }?></div><br></div></div><div class="col-lg-3"></div></div></div><div class="modal-overlay-footer clearfix"><div class="row clearfix"><div class=" textAlignCenter col-lg-12 col-md-12 col-sm-12 "><div><button type="submit" class="btn btn-soft-success btn-lg"><?php echo vtranslate('LBL_EXPORT','Vtiger');?>
&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['SOURCE_MODULE']->value,$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-soft-danger cancelLink" data-dismiss="modal" href="#"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
