<?php /* Smarty version Smarty-3.1.7, created on 2023-12-05 12:28:12
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Reports/ChartEditStep2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:89221617636d2beb7d8888-12519785%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '279ab7ab7d2ebd5e1937a3b38cd18480444d7526' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Reports/ChartEditStep2.tpl',
      1 => 1699267086,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '89221617636d2beb7d8888-12519785',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_636d2beb7eead',
  'variables' => 
  array (
    'MODULE' => 0,
    'RECORD_ID' => 0,
...
<?php if ($_valid && !is_callable('content_636d2beb7eead')) {function content_636d2beb7eead($_smarty_tpl) {?>
...
$_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value[$_smarty_tpl->tpl_vars['key']->value] = $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value;?><?php } ?><?php } ?><div class="report_step" padding:2%;"><div class="row"><div class="col-lg-12"><h4 class="report_step_h4"><strong><?php echo vtranslate('LBL_CHOOSE_FILTER_CONDITIONS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></h4></div><div class="col-lg-12"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path('AdvanceFilter.tpl'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('RECORD_STRUCTURE'=>$_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value,'ADVANCE_CRITERIA'=>$_smarty_tpl->tpl_vars['SELECTED_ADVANCED_FILTER_FIELDS']->value,'COLUMNNAME_API'=>'getReportFilterColumnName'), 0);?>
</div></div></div><br><div class="modal-overlay-footer border1px clearfix"><div class="row clearfix"><div class="textAlignCenter col-lg-12 col-md-12 col-sm-12 "><button type="button" class="btn btn-soft-secondary backStep"><strong><?php echo vtranslate('LBL_BACK',$_smarty_tpl->tpl_vars['MODULE']->value);?>
