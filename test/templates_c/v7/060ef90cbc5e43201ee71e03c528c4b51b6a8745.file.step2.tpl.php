<?php /* Smarty version Smarty-3.1.7, created on 2023-12-05 12:15:57
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Reports/step2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:98757709263b024f50a26d8-92831118%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '060ef90cbc5e43201ee71e03c528c4b51b6a8745' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Reports/step2.tpl',
      1 => 1699267087,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '98757709263b024f50a26d8-92831118',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_63b024f50da9e',
  'variables' => 
  array (
    'MODULE' => 0,
    'RECORD_ID' => 0,
...
<?php if ($_valid && !is_callable('content_63b024f50da9e')) {function content_63b024f50da9e($_smarty_tpl) {?>
...
"><input type="hidden" class="step" value="2" /><div class="report_step" style="padding:4%;"><div class="form-group"><label><?php echo vtranslate('LBL_SELECT_COLUMNS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" <?php if (!empty($_smarty_tpl->tpl_vars['SELECTED_CALCULATION_FIELDS']->value)&&in_array($_smarty_tpl->tpl_vars['FIELD_CALCULATION_VALUE']->value,$_smarty_tpl->tpl_vars['SELECTED_CALCULATION_FIELDS']->value)){?> checked=""<?php }?> /></td><?php } ?></tr><?php } ?><?php } ?></table></div></div></div><div class="modal-overlay-footer border1px clearfix"><div class="row clearfix"><div class="textAlignCenter col-lg-12 col-md-12 col-sm-12 "><button type="button" class="btn btn-soft-secondary backStep"><strong><?php echo vtranslate('LBL_BACK',$_smarty_tpl->tpl_vars['MODULE']->value);?>
