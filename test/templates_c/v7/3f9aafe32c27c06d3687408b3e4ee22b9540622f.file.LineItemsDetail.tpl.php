<?php /* Smarty version Smarty-3.1.7, created on 2023-12-05 07:22:53
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/ServiceOrders/LineItemsDetail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:908736549636dfd7580b122-97948103%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3f9aafe32c27c06d3687408b3e4ee22b9540622f' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/ServiceOrders/LineItemsDetail.tpl',
      1 => 1699267087,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '908736549636dfd7580b122-97948103',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_636dfd758360f',
  'variables' => 
  array (
    'BLOCK_LIST' => 0,
...
<?php if ($_valid && !is_callable('content_636dfd758360f')) {function content_636dfd758360f($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['ITEM_DETAILS_BLOCK'] = new Smarty_variable($_smarty_tpl->tpl_vars['BLOCK_LIST']->value['LBL_ITEM_DETAILS'], null, 0);?>
...
<?php $_tmp4=ob_get_clean();?><?php echo vtranslate($_tmp4,$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['PRODUCT_VIEWABLE']->value){?>
                        <td class="lineItemFieldName">
                            <strong><?php echo vtranslate('Remarks',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</strong>
                        </td>
                    <?php }?>
                </tr>
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['LINE_ITEM_DETAIL']->value["productName".($_smarty_tpl->tpl_vars['INDEX']->value)];?>
 ...
 <?php echo vtranslate('LBL_IS_DELETED_FROM_THE_SYSTEM_PLEASE_REMOVE_OR_REPLACE_THIS_ITEM',$_smarty_tpl->tpl_vars['MODULE']->value);?>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['QUANTITY_VIEWABLE']->value){?>
                            <td>
                                <?php echo $_smarty_tpl->tpl_vars['LINE_ITEM_DETAIL']->value["lid_remarks".($_smarty_tpl->tpl_vars['INDEX']->value)];?>
