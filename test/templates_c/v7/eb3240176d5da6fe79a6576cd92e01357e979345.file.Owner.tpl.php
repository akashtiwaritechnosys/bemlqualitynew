<?php /* Smarty version Smarty-3.1.7, created on 2022-09-16 07:11:21
         compiled from "C:\xampp\htdocs\beml\includes\runtime/../../layouts/v7\modules\HelpDesk\uitypes\Owner.tpl" */ ?>
<?php /*%%SmartyHeaderCode:207839812563124a38469766-95992228%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eb3240176d5da6fe79a6576cd92e01357e979345' => 
    array (
      0 => 'C:\\xampp\\htdocs\\beml\\includes\\runtime/../../layouts/v7\\modules\\HelpDesk\\uitypes\\Owner.tpl',
      1 => 1663312274,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '207839812563124a38469766-95992228',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_63124a384fb24',
  'variables' => 
  array (
    'FIELD_MODEL' => 0,
    'FIELD_INFO' => 0,
    ...
    'OWNER_ID' => 0,
    'OWNER_NAME' => 0,
    'OWNERASSIGNEDCOUNTLIST' => 0,
    'OWNERLEAVESTATUSLIST' => 0,
...
"  data-name=' <?php echo $_smarty_tpl->tpl_vars['OWNER_NAME']->value;?>
'data-number='<?php echo $_smarty_tpl->tpl_vars['OWNERASSIGNEDCOUNTLIST']->value[$_smarty_tpl->tpl_vars['OWNER_ID']->value];?>
 <?php echo $_smarty_tpl->tpl_vars['OWNERLEAVESTATUSLIST']->value[$_smarty_tpl->tpl_vars['OWNER_ID']->value];?>
...
</option><?php } ?></optgroup></select><script>function formatState (state) {var number=$(state.element).attr("data-number");if( $(state.element).attr("data-number")!=undefined && number != " "){var $state = $(state.text+' '+'<span class="badge bg-primary">'+ number+'</span>');return $state;}var $state = $(state.text+' '+'<span ></span>');return $state;};$(".ownerClass").select2({templateResult: formatState,width: '100%'});</script><?php }?>
<?php }} ?>