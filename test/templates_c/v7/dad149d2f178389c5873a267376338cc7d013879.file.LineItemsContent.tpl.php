<?php /* Smarty version Smarty-3.1.7, created on 2023-11-30 05:49:47
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/FailedParts/partials/LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:200729271563625c1c2451c9-38590028%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dad149d2f178389c5873a267376338cc7d013879' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/FailedParts/partials/LineItemsContent.tpl',
      1 => 1699267090,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '200729271563625c1c2451c9-38590028',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_63625c1c29bc4',
  'variables' => 
  array (
    'row_no' => 0,
    'entityIdentifier' => 0,
...
$_smarty_tpl->tpl_vars['listPriceValues']->value[$_smarty_tpl->tpl_vars['currency_details']->value['currency_id']] = $_smarty_tpl->tpl_vars['currency_details']->value['conversionrate']*$_smarty_tpl->tpl_vars['purchaseCost']->value;?><?php } ?><?php }?><td style="text-align:center;">&nbsp;<a><img src="<?php echo vimage_path('drag.png');?>
...
"data-rule-required=true <?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['productName']->value])){?> disabled="disabled" <?php }?>><?php if (!$_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['productDeleted']->value]){?><?php }?><input type="hidden" id="<?php echo $_smarty_tpl->tpl_vars['igLineItemId']->value;?>
...
" class="selectedModuleId lokiii"/><input type="hidden" id="<?php echo $_smarty_tpl->tpl_vars['hdnProductId']->value;?>
...
<?php }?></div><?php }?></td><?php }?><td><?php if ($_smarty_tpl->tpl_vars['COMMENT_EDITABLE']->value){?><div><textarea readonly style="background-color:#eeeeee!important" id="<?php echo $_smarty_tpl->tpl_vars['comment']->value;?>
...
</textarea></div><?php }?></td><td><input type="text" data-extraname="qty" id="<?php echo $_smarty_tpl->tpl_vars['qty']->value;?>
" style="background-color:#eeeeee!important" name="<?php echo $_smarty_tpl->tpl_vars['qty']->value;?>
" class="qty smallInputBox inputElement <?php echo $_smarty_tpl->tpl_vars['qty']->value;?>
"readonly data-rule-required=true data-rule-positive=true data-rule-greater_than_zero=true value="<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value])){?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value];?>
...
<?php }else{ ?>0<?php }?></span><?php }?></td><?php $_smarty_tpl->tpl_vars["dateFormat"] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('date_format'), null, 0);?><?php $_smarty_tpl->tpl_vars["total_excluded_qty"] = new Smarty_variable(("total_excluded_qty").($_smarty_tpl->tpl_vars['row_no']->value), null, 0);?><input hidden data-extraname="total_excluded_qty" id="<?php echo $_smarty_tpl->tpl_vars['total_excluded_qty']->value;?>
" value="<?php echo decode_html($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars[('total_excluded_qty')]->value]);?>
" class="total_excluded_qty inputElement <?php echo $_smarty_tpl->tpl_vars['total_excluded_qty']->value;?>
"></input><?php  $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->_loop = false;
...
'<?php }?>  data-rule-date="true" /><?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['editable']!=0){?> <span class="input-group-addon"><i class="fa fa-calendar "></i></span><?php }?></div><?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='21'||$_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='2'){?><div id="<?php echo $_smarty_tpl->tpl_vars['fieldName']->value;?>
DivCla" <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['hideInitialDisplay']=='true'){?> class="hide" <?php }?>><textarea <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['editable']==0){?> disabled style="pointer-events: none;" <?php }?> id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
...
</textarea></div><?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='7'){?><div><input data-extraname="<?php echo $_smarty_tpl->tpl_vars['fieldName']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['editable']==0){?> readonly style="pointer-events: none;background-color:#eeeeee" <?php }?> id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
...
" class="<?php echo $_smarty_tpl->tpl_vars['fieldName']->value;?>
 inputElement" style="min-width: 100px;" data-rule-positive=true></input></div><?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='16'){?><select <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['editable']==0){?> disabled style="pointer-events: none;" <?php }?> style="min-width: 150px;" id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" class="select2-container inputElement select2 inputElement picklistfield <?php echo $_smarty_tpl->tpl_vars['fieldName']->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
...
</option><?php } ?></select><?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='56'){?><input <?php if ($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['editable']==0){?> disabled style="pointer-events: none;" <?php }?> class="inputElement" id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
