<?php /* Smarty version Smarty-3.1.7, created on 2023-05-15 09:32:37
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Vtiger/EmailPreview.tpl" */ ?>
<?php /*%%SmartyHeaderCode:900789753638f1b78ef9ac7-05435420%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cc5cd3c2843b366d5a022f405c4a20383fe06740' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Vtiger/EmailPreview.tpl',
      1 => 1683545718,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '900789753638f1b78ef9ac7-05435420',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_638f1b78f269b',
  'variables' => 
  array (
    'PARENT_RECORD' => 0,
    'RECORD_ID' => 0,
...
<?php if ($_valid && !is_callable('content_638f1b78f269b')) {function content_638f1b78f269b($_smarty_tpl) {?>
...
</li><?php } ?></ul></span><?php }?></span></span></span></div></div><div class="col-lg-6"><div class="email-preview-toolbar pull-right"><?php if ($_smarty_tpl->tpl_vars['RECORD']->value->getEmailFlag()!='SAVED'){?><button type="button" name="previewReply" class="btn btn-sm btn-soft-primary" data-mode="emailReply"><?php echo vtranslate('LBL_REPLY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><?php if (count($_smarty_tpl->tpl_vars['TO']->value)>1||!empty($_smarty_tpl->tpl_vars['CC']->value)||!empty($_smarty_tpl->tpl_vars['BCC']->value)){?><button type="button" name="previewReplyAll" class="btn btn-sm btn-soft-primary" data-mode="emailReplyAll"><?php echo vtranslate('LBL_REPLY_ALL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><?php }?><?php }?><button type="button" name="previewForward" class="btn btn-sm btn-soft-primary" data-mode="emailForward"><?php echo vtranslate('LBL_FORWARD',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><?php if ($_smarty_tpl->tpl_vars['RECORD']->value->getEmailFlag()=='SAVED'){?><button type="button" name="previewEdit" class="btn btn-sm btn-soft-primary" data-mode="emailEdit"><?php echo vtranslate('LBL_EDIT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><?php }?><button type="button" name="previewPrint" class="btn btn-sm btn-soft-primary" data-mode="previewPrint"><?php echo vtranslate('LBL_PRINT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
