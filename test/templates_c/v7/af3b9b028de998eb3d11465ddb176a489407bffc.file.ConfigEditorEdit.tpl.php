<?php /* Smarty version Smarty-3.1.7, created on 2023-05-30 07:31:31
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Settings/Vtiger/ConfigEditorEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7292351236350ed7d59bec3-97127384%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af3b9b028de998eb3d11465ddb176a489407bffc' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/Settings/Vtiger/ConfigEditorEdit.tpl',
      1 => 1685431884,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7292351236350ed7d59bec3-97127384',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_6350ed7d5bd0b',
  'variables' => 
  array (
    'MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_6350ed7d5bd0b')) {function content_6350ed7d5bd0b($_smarty_tpl) {?>
...
" method="POST"><?php $_smarty_tpl->tpl_vars['WIDTHTYPE'] = new Smarty_variable($_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('rowheight'), null, 0);?><?php $_smarty_tpl->tpl_vars['FIELD_VALIDATION'] = new Smarty_variable(array('HELPDESK_SUPPORT_EMAIL_ID'=>'data-rule-email="true"','upload_maxsize'=>'data-rule-range=[1,41] data-rule-positive="true" data-rule-wholeNumber="true"','history_max_viewed'=>'data-rule-range=[1,5] data-rule-positive="true" data-rule-wholeNumber="true"','listview_max_textlength'=>'data-rule-range=[1,100] data-rule-positive="true" data-rule-wholeNumber="true"','list_max_entries_per_page'=>'data-rule-range=[1,100] data-rule-positive="true" data-rule-wholeNumber="true"'), null, 0);?><div><h4><?php echo vtranslate('LBL_CONFIG_EDITOR',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
