<?php /* Smarty version Smarty-3.1.7, created on 2025-04-08 13:00:39
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/StockTransferOrders/partials/LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:180240417267f51df7e7e113-09919061%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8ea28d4e50b0ec53572e50dc13689792aa20512b' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/StockTransferOrders/partials/LineItemsContent.tpl',
      1 => 1733391378,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '180240417267f51df7e7e113-09919061',
  'function' => 
  array (
  ),
  'variables' => 
...
<?php }?></div><?php }?></td><?php }?><td><?php if ($_smarty_tpl->tpl_vars['COMMENT_EDITABLE']->value){?><div><textarea id="<?php echo $_smarty_tpl->tpl_vars['comment']->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars['comment']->value;?>
" readonly style="pointer-events: none;background-color:#eeeeee" class="lineItemCommentBox"><?php echo decode_html($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['comment']->value]);?>
...
" class="qty inputElement" style="min-width: 100px;"></input></div><?php }elseif($_smarty_tpl->tpl_vars['LINEITEM_CUSTOM_FIELD']->value['uitype']=='16'){?><select style="min-width: 250px;" id="<?php echo $_smarty_tpl->tpl_vars[($_smarty_tpl->tpl_vars['fieldName']->value)]->value;?>
