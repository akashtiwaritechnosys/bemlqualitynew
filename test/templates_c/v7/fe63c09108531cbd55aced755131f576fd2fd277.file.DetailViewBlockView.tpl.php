<?php /* Smarty version Smarty-3.1.7, created on 2023-12-05 07:29:23
         compiled from "/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/RecommissioningReports/DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11105442816357e42668bdb7-40410301%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fe63c09108531cbd55aced755131f576fd2fd277' => 
    array (
      0 => '/var/www/html/bemlquality/includes/runtime/../../layouts/v7/modules/RecommissioningReports/DetailViewBlockView.tpl',
      1 => 1699267086,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11105442816357e42668bdb7-40410301',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_6357e4267004b',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_6357e4267004b')) {function content_6357e4267004b($_smarty_tpl) {?>
...
?><?php $_smarty_tpl->tpl_vars['BLOCK'] = new Smarty_variable($_smarty_tpl->tpl_vars['BLOCK_LIST']->value[$_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value], null, 0);?><?php if ($_smarty_tpl->tpl_vars['BLOCK']->value==null||count($_smarty_tpl->tpl_vars['FIELD_MODEL_LIST']->value)<=0||$_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value=='LBL_PRICING_INFORMATION'){?><?php continue 1?><?php }?><?php if ($_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value=='Major_Aggregates_Sl_No'||$_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value=='Shortages_And_Damages'||$_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value=='LBL_ITEM_DETAILS'){?><?php if ($_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value=='Shortages_And_Damages'){?><?php if (in_array($_smarty_tpl->tpl_vars['SERVICEREPORTTYPE']->value,$_smarty_tpl->tpl_vars['EXTRALINEITEMREQUIREDTYPES']->value)){?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("LineItemsDetailShortDam.tpl",'RecommissioningReports'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php continue 1?><?php }?><?php if (in_array($_smarty_tpl->tpl_vars['REPORTTYPE']->value,$_smarty_tpl->tpl_vars['EXTRALINEITEMREQUIREDSUBTYPES']->value)){?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("LineItemsDetailShortDam.tpl",'RecommissioningReports'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php continue 1?><?php }?><?php }elseif($_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value=='Major_Aggregates_Sl_No'){?><?php if ($_smarty_tpl->tpl_vars['SERVICEREPORTTYPE']->value=='PRE-DELIVERY'||$_smarty_tpl->tpl_vars['SERVICEREPORTTYPE']->value=='ERECTION AND COMMISSIONING'){?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("LineItemsDetailShortDam1.tpl",'RecommissioningReports'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php continue 1?><?php }?><?php }elseif($_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value=='LBL_ITEM_DETAILS'){?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("LineItemsDetail.tpl",'RecommissioningReports'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php continue 1?><?php }?><?php }else{ ?><div class="block block_<?php echo $_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value;?>
...
"><ul id="imageContainer" class="imageSlider"><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='HelpDesk'||$_smarty_tpl->tpl_vars['MODULE_NAME']->value=='RecommissioningReports'){?><?php  $_smarty_tpl->tpl_vars['IMAGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['IMAGE_INFO']->_loop = false;
 $_smarty_tpl->tpl_vars['ITER'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['IMAGE_DETAILS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['IMAGE_INFO']->key => $_smarty_tpl->tpl_vars['IMAGE_INFO']->value){
$_smarty_tpl->tpl_vars['IMAGE_INFO']->_loop = true;
 $_smarty_tpl->tpl_vars['ITER']->value = $_smarty_tpl->tpl_vars['IMAGE_INFO']->key;
?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()==$_smarty_tpl->tpl_vars['IMAGE_INFO']->value['fieldNameFromDB']){?><?php if ((strpos($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'],'.png')>=1||strpos($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'],'.jpeg')>=1||strpos($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'],'.jpg')>=1)){?><li><span><a onclick="Vtiger_Header_Js.fileView(<?php echo $_smarty_tpl->tpl_vars['RECORDID']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['id'];?>
...
"  title="<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'];?>
"/><span><a onclick="Vtiger_Header_Js.fileView(<?php echo $_smarty_tpl->tpl_vars['RECORDID']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['id'];?>
);"><?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'];?>
</a></span></li><?php }?><?php }?><?php } ?><?php }else{ ?><?php  $_smarty_tpl->tpl_vars['IMAGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['IMAGE_INFO']->_loop = false;
 $_smarty_tpl->tpl_vars['ITER'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['IMAGE_DETAILS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['IMAGE_INFO']->key => $_smarty_tpl->tpl_vars['IMAGE_INFO']->value){
$_smarty_tpl->tpl_vars['IMAGE_INFO']->_loop = true;
...
<?php $_tmp5=ob_get_clean();?><?php if (!empty($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['url'])&&!empty($_tmp5)){?><?php if ((strpos($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'],'.png')>=1||strpos($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'],'.jpeg')>=1||strpos($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'],'.jpg')>=1)){?><li><img src="<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['url'];?>
...
"><?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['name'];?>
</a></span></li><?php }?><?php }?><?php } ?><?php }?></ul></td><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=="20"||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=="19"||$_smarty_tpl->tpl_vars['fieldDataType']->value=='reminder'||$_smarty_tpl->tpl_vars['fieldDataType']->value=='recurrence'){?><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value=='1'){?><td class="fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
