<?php /* Smarty version Smarty-3.1.7, created on 2025-12-10 11:26:19
         compiled from "/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Reports/ChartReportHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:888351769693958db5fae47-15263745%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c650c84c6f747816c139613819bed32446e0853f' => 
    array (
      0 => '/var/www/html/bemlqualitynew/includes/runtime/../../layouts/v7/modules/Reports/ChartReportHeader.tpl',
      1 => 1733391285,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '888351769693958db5fae47-15263745',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_693958db615ea',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_693958db615ea')) {function content_693958db615ea($_smarty_tpl) {?>
...
" /><input type="hidden" name="secondary_modules" value=<?php echo ZEND_JSON::encode($_smarty_tpl->tpl_vars['SECONDARY_MODULES']->value);?>
 ...
 /><!--Pivot Report--><input type="hidden" name="type" id="type" value="<?php echo $_smarty_tpl->tpl_vars['report_type']->value;?>
" /><input type="hidden" name='groupbyfield1' value=<?php echo $_smarty_tpl->tpl_vars['CHART_MODEL']->value->getGroupByField1();?>
 /><!--Pivot Report--><input type="hidden" name='datafields' value=<?php echo Zend_JSON::encode($_smarty_tpl->tpl_vars['CHART_MODEL']->value->getDataFields());?>
...
</span><span class="redColor">*</span></div><br><div><select id='groupbyfield' name='groupbyfield' class="col-lg-10" data-validation-engine="validate[required]" style='min-width:300px;'></select></div></span><!--Pivot Report--><?php if ($_smarty_tpl->tpl_vars['report_type']->value=='Pivot'){?><span class="col-lg-4"><div><span><?php echo vtranslate('Select Column Field',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span><span class="redColor">*</span></div><br><div class="row"><select id='groupbyfield1' name='groupbyfield1' class="validate[required]" data-validation-engine="validate[required]" style='min-width:300px;'></select></div></span><?php }?><!--Pivot Report--><span class="col-lg-4"><div><span><?php echo vtranslate('LBL_SELECT_DATA_FIELD',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</div></div></div><div><?php $_smarty_tpl->tpl_vars['filterConditionNotExists'] = new Smarty_variable((count($_smarty_tpl->tpl_vars['SELECTED_ADVANCED_FILTER_FIELDS']->value[1]['columns'])==0&&count($_smarty_tpl->tpl_vars['SELECTED_ADVANCED_FILTER_FIELDS']->value[2]['columns'])==0), null, 0);?><button class="btn btn-soft-blue" name="modify_condition" data-val="<?php echo $_smarty_tpl->tpl_vars['filterConditionNotExists']->value;?>
...
</div><?php if ($_smarty_tpl->tpl_vars['REPORT_MODEL']->value->isEditableBySharing()){?><div class="row textAlignCenter hide reportActionButtons"><button class="btn btn-soft-success  generateReportChart" data-mode="save" value="<?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
