<?php /* Smarty version Smarty-3.1.19, created on 2024-12-11 11:38:14
         compiled from "/var/www/html/bemlqualitynew/customerportal/layouts/default/templates/Portal/Login.tpl" */ ?>
<?php /*%%SmartyHeaderCode:142400398767592c4ea8f917-44467285%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9c2d28ee53af0d5f7fc9a7f5ccddb2bbfc153e03' => 
    array (
      0 => '/var/www/html/bemlqualitynew/customerportal/layouts/default/templates/Portal/Login.tpl',
      1 => 1733391372,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '142400398767592c4ea8f917-44467285',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_67592c4ea947a4_87655602',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_67592c4ea947a4_87655602')) {function content_67592c4ea947a4_87655602($_smarty_tpl) {?>﻿
    ...
    <script type="text/ng-template" id="forgotPassword.template">
        ...
        <form name="forgotPassword"  ng-submit="updatePassword()" class="form-horizontal" role="form">
            <div class="modal-body">
                <div class="form-group">
                    <label class="col-sm-4 control-label">{{'UserName'|translate}}</label>
                    <div class="col-sm-5">
                        <input ng-model="data.username" name="username" class="form-control" required></input>
                        <span class="text-danger"  ng-show="data.username===undefined">Enter a valid UserName</span>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                <button ng-if="data.email" ng-if="data.username" class="btn btn-soft-success" type="submit">{{'Submit'|translate}}</button>
            </div>
        </form>
    </script>
