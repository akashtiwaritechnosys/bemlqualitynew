...
class Vtiger_Functions {
    ...
    */
	...
	static function displayTimeSecondsReadbleFormat($seconds) {
	...
	static function getDisplayDateTimeValueTemplate($dateTime) {
		$date = new DateTimeField($dateTime);
		global $current_user;
		return $date->getDisplayDateTimeValueMobile();
	}
	...
	static function getDropDownValuesOfDependentField($value) {
		$TypeOfLine = substr($value, -3);
		return $TypeOfLine;
	}
