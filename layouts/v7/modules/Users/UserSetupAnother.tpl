{strip}
	...
	<style>
		...
		.loginDiv {
			...
			border-radius: 10px;
			box-shadow: #cdcdcd 0px 5px 15px;
			text-align: center;
			padding: 20px;
		}
		...
		#SignUpFormDiv .submit_btn buttonn {
			font-size: 13px;
			line-height: 20px;
			font-weight: 400;
		...
		.main-dashboard-content.dashboard-content-full {
			padding-left: 0%;
		}
	</style>
	...
	<div class="container-fluid loginPageContainer">
		{* <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 login_title">
			<h1 style="margin: 0px" class="text-center">Welcome To CRM Doctor Portal</h1>
		</div> *}
		<input type="hidden" name="OFFICETOROLEDEPENDENCY"
			data-value='{ZEND_JSON::encode($OFFICETOROLEDEPENDENCY)|escape}' />
		...
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 login_beml">
			...
			<form class="form-horizontal" id="SignUpFormDiv" name="SignUpFormDiv">
				<div class="loginDiv widgetHeight ">
					<img src="layouts/v7/resources/Images/reset-password.svg" alt="CRM Illustration" class="hero-image">

					<div class="bg-pattern">
						<div>
							<h4 class="mb-4 mt-3 auto_text">Set a New Password</h4>
							<div>
							...
							<div id="user_password">
								<label for="user_password" class=""> Password <span class="redColor">*</span></label>
								<div class="">
									<input id="password_1" data-rule-required="true"
										{literal}data-specific-rules='[{"name":"passwordmix"},{"name" : "maxsizeInSignUP", "params":"18"},{"name" : "allowOnlyCertainSpecialCharcters"}]'
										{/literal} type="password" class="form-control" name="user_password"
										autofill="autofill">
							...
							<div id="confirm_password">
								<label for="confirm_password" class="mt-3">Confirm Password <span
										class="redColor">*</span></label>
								<div class="">
									<input id="password_2" data-rule-required="true"
										{literal}data-specific-rules='[{"name":"passwordmix"},{"name" : "maxsizeInSignUP", "params":"18"},{"name" : "checkPasswordMatching"},{"name" : "allowOnlyCertainSpecialCharcters"}]'
										{/literal} type="password" class="form-control" name="confirm_password"
										autofill="autofill">
					...
					<div class="submit_btn mt-3" style="padding-bottom : 0px;padding-top : 0px">
						<button id="SignUPSubmitButton" class="button crm_btn btn btn-primary">Reset Password</button><br>
					</div>
				</div>
			</form>
			<div class="forgot_pwd">
				<a style="display:none" href="forgotPasswordDiv" class="forgotPasswordLink text-white-50"
					style="color: #15c;">Forgot password?</a>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" id="SignUpFormDiv1" name="signupform1">
						...
						<div>
							<button id="OTPSubmit" class="button crm_btn btn btn-primary">Submit</button><br>
						</div>
						<div id="time">
						...
						<div id="resendOtpDiv" style="display:none">
							<button id="resendOtp" class="button crm_btn btn btn-primary">Resend OTP</button><br>
						</div>
					</form>
				</div>
