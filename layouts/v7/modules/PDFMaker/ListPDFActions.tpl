    ...
    <div class="row">
        <div class="col-md-3">
            <div class="btn-group listViewMassActions" role="group">
                    {if php7_count($LISTVIEW_MASSACTIONS) gt 0 || $LISTVIEW_LINKS['LISTVIEW']|php7_count gt 0}
                            ...
                            <ul class="dropdown-menu">
                                    {if php7_count($LISTVIEW_MASSACTIONS) gt 0}
                                        ...
                                        {if $LISTVIEW_LINKS['LISTVIEW']|php7_count gt 0}<li class="divider"></li> {/if}
                                    {/if}
                                    
                                    {if $LISTVIEW_LINKS['LISTVIEW']|php7_count gt 0}
