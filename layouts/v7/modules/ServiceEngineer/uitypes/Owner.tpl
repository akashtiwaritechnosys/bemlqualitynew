...
{if $FIELD_MODEL->get('uitype') eq '53'}
	...
	{/if}
	<select {if $READONLYFIELD eq true}disabled="disabled"{/if} class="inputElement select2" type="owner" data-fieldtype="owner" data-fieldname="{$ASSIGNED_USER_ID}" data-name="{$ASSIGNED_USER_ID}" name="{$ASSIGNED_USER_ID}" 
