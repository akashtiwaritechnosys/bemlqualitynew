						...
						<div class="container-fluid">
							...
							<div class="navbar-collapse collapse" id="appnavcontent" aria-expanded="false" style="height: 1px;">
								<ul class="nav navbar-nav">
									...
									{/foreach}
									<li>
										<button id="{$MODULE}_basicAction_{Vtiger_Util_Helper::replaceSpaceWithUnderScores('Recalculate Equipments')}" type="button" class="btn addButton btn-soft-info module-btn"
											onclick="ServiceEngineer_List_Js.recalculateEquipments(1)">
											<div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;
											Recalculate Equipments
										</button>
									</li>
