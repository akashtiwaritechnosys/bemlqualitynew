    ...
    <div class="module-filters" id="module-filters">
        <div class="sidebar-container lists-menu-container">
            <div class="sidebar-header clearfix">
                ...
                <button id="createFilter" data-url="{CustomView_Record_Model::getCreateViewUrl($SOURCE_MODULE_NAME)}" class="btn btn-sm btn-default pull-right sidebar-btn" title="{vtranslate('LBL_CREATE_LIST',$SOURCE_MODULE_NAME)}">
            ...
            <div class="menu-scroller scrollContainer" style="position:relative; top:0; left:0;">
                <div class="list-menu-content">
                    ...
                    {if $SOURCE_CUSTOM_VIEWS && php7_count($SOURCE_CUSTOM_VIEWS) > 0}
                                ...
                                <ul class="lists-menu">
                                    ...
                                    {foreach item=CUSTOM_VIEW from=$GROUP_CUSTOM_VIEWS name=customView}
                                        ...
                                        {foreach key=GROUP_LABEL item="MEMBER_LIST" from=$MEMBERS}
                                            ...
                                            {/if}
                                        {/foreach}
                                        <li style="font-size:12px;" class='listViewFilter {if $VIEWID eq $CUSTOM_VIEW_ID && ($CURRENT_TAG eq '')} active {if $smarty.foreach.customView.iteration gt 10} {assign var=count value=1} {/if} {elseif $smarty.foreach.customView.iteration gt 10} filterHidden hide{/if} '>
                                            ...
                                            <a class="filterName listViewFilterElipsis" href="{$MODULE_MODEL->getKanbanUrl($SOURCE_MODULE_NAME, $CUSTOM_VIEW_ID)}" data-filter-id="{$CUSTOM_VIEW_ID}" title="{$VIEWNAME|@escape:'html'}">{$VIEWNAME|@escape:'html'}</a>
