...
{strip}
	<div id="taskManagementContainer" class='fc-overlay-modal modal-content'>
			...
			<div class='datacontent'>
				<div class="data-header clearfix">
					...
					<div id="taskManagementOtherFilters" class="otherFilters pull-right">
						...
						<div class='field pull-left taskmanagement-field'>
				...
				<div class="data-body row mt-3">
					...
					{foreach item=PRIORITY from=$PRIORITIES}
						<div class="col-sm-4 col-md-4 contentsBlock {strtolower($PRIORITY)} ui-droppable" data-priority='{$PRIORITY}' data-page="{$PAGE}">
