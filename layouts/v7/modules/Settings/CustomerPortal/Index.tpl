			...
			<form id="customerPortalForm" name="customerPortalForm" action="index.php" method="POST" class="form-horizontal">
				...
				<div class="col-sm-12 col-xs-12 input-group">					
					<div class="form-group">
						<label for="defaultAssignee" class="col-lg-3 col-md-4 col-sm-4 control-label fieldLabel"><span>{vtranslate('LBL_DEFAULT_ASSIGNEE', $QUALIFIED_MODULE)}</span></label>
						<div class="fieldValue col-lg-6 col-md-8 col-sm-8 input-group">
				...
				<div class="col-sm-12 col-xs-12 input-group">
					<div class="form-group">
						<label for="portal-url" class="col-lg-3 col-md-4 col-sm-3 control-label fieldLabel">{vtranslate('LBL_PORTAL_URL', $QUALIFIED_MODULE)}</label>
						<div class="col-lg-6 col-md-8 col-sm-9">
							<a target="_blank" href="{$PORTAL_URL}" class="help-inline" style="width: 100%;">{$PORTAL_URL}</a>
				...
				<div class="row" style="margin-bottom: 20px; margin-top: 20px;">
					<div class="col-lg-3 col-md-5 col-sm-5 cp-portal-menu">
							...
							{foreach key=TAB_ID item=MODEL from=$MODULES_MODELS name=moduleModels}
								...
								<li class="portalModuleRow bgColor cp-tabs" {if $smarty.foreach.moduleModels.last} {/if}
									...
									<a href="javascript:void(0);" class="cp-modules" style="width:100%;">
										<span class="checkbox portal-module-list">
											...
											<p>&nbsp;&nbsp;{vtranslate($MODULE_NAME, $MODULE_NAME)}</p>
										</span>
									</a>
								</li>
							{/foreach}
					...
					<div class="textAlignCenter col-lg-12 col-md-12 col-sm-12">
						<button type="submit" class="btn btn-submit saveButton pull-right" style="margin-top:10px;" id="savePortalInfo" name="savePortalInfo" type="submit" disabled>{vtranslate('LBL_SAVE', $MODULE)}</button>&nbsp;&nbsp;
					</div>
