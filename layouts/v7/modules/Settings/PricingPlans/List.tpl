...
<div class="container-fluid">
  <div class="pricing-plan">
    ...
    <div class="contents-modern">
          ...
          <div id="currentSubscriptionBanner" class="current-subscription-banner" style="display: none;">
            <div class="current-plan-info">
              <h3 id="bannerPlanName">Current Plan: -</h3>
              <p>No.of Users: <strong id="bannerUserCount">-</strong></p>
              <p>Status: <span class="status-badge" id="bannerStatus">-</span> | 
                 Billing: <span id="bannerBilling">-</span></p>
              <p class="days-info" id="bannerDaysRemaining">-</p>
              <p class="amount-info">Current Amount: <strong id="bannerAmount">-</strong></p>
            </div>
            <button class="upgrade-btn" id="upgradeModeBtn">
              <span class="btn-icon">⬆</span> Upgrade Plan
            </button>
          </div>
      <div class="payment-container">
        <div class="section-container">
          ...
          <div id="upgradeInstructions" class="upgrade-instructions" style="display: none;">
            <h4>📋 How Subscription Upgrade Works:</h4>
            <ul>
              <li><strong>Add-on Based:</strong> Your original subscription stays active with add-ons for upgrades</li>
              <li><strong>Prorated Billing:</strong> You'll only pay the difference for remaining days</li>
              <li><strong>Unused Credit:</strong> Current plan's unused amount is automatically credited</li>
              <li><strong>Next Renewal:</strong> New plan amount applies from your next billing cycle</li>
              <li><strong>User Increase:</strong> Additional user charges are calculated proportionally</li>
            </ul>
            <div class="upgrade-note-box">
              <strong>Note:</strong> Select a plan below to see the exact upgrade cost breakdown
            </div>
          </div>
          ...
          <div class="plan-section" id="planSection">
            ...
            <div class="plans-container">
              ...
              <div class="plan-card {if $plan@iteration == 2}popular{/if}" id="planCard-{$plan.subscription_id}">
                {if $plan@iteration == 2}
                ...
                {assign var=quarterPrice value=''} 
                {assign var=yearPrice value=''}
                {assign var=quarterfreq value=''} 
                {assign var=yearfreq value=''}
                {assign var=qpid value=''} 
                {assign var=ypid value=''} 
                {foreach from=$plan.price item=p} 
                  {if $p.frequency == 'Quarter'} 
                    {assign var=quarterPrice value=$p.price} 
                    {assign var=quarterfreq value=$p.frequency}
                    {assign var=qpid value=$p.pricebook_id} 
                  {/if} 
                  {if $p.frequency == 'Year'} 
                    {assign var=yearPrice value=$p.price}
                    {assign var=yearfreq value=$p.frequency}
                    {assign var=ypid value=$p.pricebook_id} 
                  {/if} 
                {/foreach}
         ...
         <!-- Summary Section -->
          <div class="summary-section" id="summarySection">
            <!-- Upgrade Summary -->
            <div id="upgradeSummary" class="upgrade-summary" style="display: none;">
              <h4>📊 Upgrade Calculation Details</h4>
              <div class="upgrade-method-badge" id="upgradeMethod">-</div>
              <div class="upgrade-details">
                <div class="detail-section">
                  <h5>Current Subscription</h5>
                  <div class="detail-row">
                    <span>Plan:</span>
                    <span><strong id="currentPlanName">-</strong></span>
                  </div>
                  <div class="detail-row">
                    <span>Amount:</span>
                ...
                <div class="detail-section">
                  ...
                  <div class="detail-row">
                    <span>Plan:</span>
                    <span><strong id="newPlanName">-</strong></span>
                  </div>
                  <div class="detail-row">
                    <span>Amount:</span>
                    <span id="newAmount">-</span>
                  </div>
                  <div class="detail-row">
                    <span>Users:</span>
                ...
                <div class="detail-section calculation-section">
                  ...
                  <div class="detail-row">
                    ...
                    <span id="daysRemaining">- days</span>
                  </div>
                  <div class="detail-row">
                    <span>Unused Credit:</span>
                    <span class="credit-amount" id="unusedCredit">-</span>
                  </div>
                  <div class="detail-row">
                    <span>Prorated New Plan:</span>
                    <span id="proratedAmount">-</span>
                  </div>
                  <div class="detail-row upgrade-total">
                    <span><strong>Upgrade Amount (Pay Now via Add-on):</strong></span>
                    <span class="upgrade-price"><strong id="upgradeAmount">-</strong></span>
                  </div>
                </div>
              </div>
              <div class="upgrade-note">
                ...
                <div class="note-content">
                  ...
                  • Your original subscription remains active<br>
                  • An add-on will be created for the upgrade charge (<span id="upgradeCharge">-</span>)<br>
                  • Next billing on <strong id="nextBillingDate">-</strong> will charge the full new amount: <strong id="fullNewAmount">-</strong><br>
                ...
                <form id="billingForm">
                  <div class="form-row">
                    <div class="form-group">
                      <label for="fullName">Billing Name / Company Name <span class="redColor">*</span></label>
                      <input type="text" id="fullName" class="form-control inputElement" required />
                    </div>
                    <div class="form-group">
                      <label for="phone">Phone <span class="redColor">*</span></label>
                      <input type="text" id="phone" class="form-control inputElement" required />
                    </div>
                  </div>

                  <div class="form-group">
                    <label for="address">Street Address <span class="redColor">*</span></label>
                    <input type="text" id="address" class="form-control inputElement" required />
                  </div>

                  <div class="form-row">
                    <div class="form-group">
                      <label for="city">City <span class="redColor">*</span></label>
                      <input type="text" id="city" class="form-control inputElement" required />
                    </div>

                    <div class="form-group">
                      <label for="state">State <span class="redColor">*</span></label>
                  ...
                  <div class="form-row">
                    <div class="form-group">
                      <label for="zip">ZIP Code <span class="redColor">*</span></label>
                      <input type="text" id="zip" class="form-control inputElement" required />
                    </div>

                    <div class="form-group">
                      <label for="country">Country <span class="redColor">*</span></label>
          ...
          <div id="paymentSection" class="payment-section">
            <div class="payment-card">
              ...
              <div id="upgradePaymentNote" class="upgrade-payment-note" style="display: none;">
                <div class="upgrade-payment-content">
                  <div class="upgrade-icon">⬆️</div>
                  <div class="upgrade-details">
                    <strong class="upgrade-title">Subscription Upgrade via Add-on</strong>
                    <p>Upgrading from: <strong id="upgradeFromPlan">-</strong></p>
                    <p>Upgrading to: <strong id="upgradeToPlan">-</strong></p>
                    <p>User Count: <strong id="upgradeUserCount">-</strong></p>
                    <p>Days Remaining: <strong id="upgradeDaysRemaining">-</strong></p>
                    <div class="upgrade-how-it-works">
                      <strong>How it works:</strong>
                      <ul>
                        <li>Your original subscription stays active</li>
                        <li>Add-on created for upgrade charges: <span id="upgradeChargeAmount">-</span></li>
                        <li>Next renewal (<span id="upgradeNextBilling">-</span>): Full new amount <span id="upgradeFullAmount">-</span></li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div class="payment-summary-grid">
                ...
                <div class="summary-card">
                  ...
                  <div class="payment-actions">
                    ...
                    <button class="pay-button" id="payNowButton">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
