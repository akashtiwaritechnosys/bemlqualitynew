		...
		<div class="module-action-content clearfix">
			<div class="col-lg-6 col-md-6 ">
				{if $USER_MODEL->isAdminUser()}
					...
					&nbsp;<span class="fa fa-angle-right pull-left {if $VIEW eq 'Index' && $MODULE eq 'Vtiger'} hide {/if}" aria-hidden="true" style="padding-left: 5px; padding-right: 5px;"></span>
				{/if}
			...
			<div class="col-lg-6 col-md-6 pull-right">
				<div id="appnav" class="navbar-right">
					<ul class="nav navbar-nav">
						...
						{/foreach}
						{if !empty($LISTVIEW_LINKS['LISTVIEWSETTING']) && ($LISTVIEW_LINKS['LISTVIEWSETTING']|php7_count gt 0)}
						...
						{if !empty($LISTVIEW_LINKS['LISTVIEWBASIC']) and ($LISTVIEW_LINKS['LISTVIEWBASIC']|php7_count gt 0) and (!in_array($MODULE, $RESTRICTED_MODULE_LIST))}
