...
{strip}
    {if php7_count($DATA.matrix) gt 0 }
        <style>
            ...
            .heatmap-low { background-color: #ffe0b2; }   /* Light Orange */
            .heatmap-med { background-color: #ffb74d; }   /* Medium Orange */
            .heatmap-high { background-color: #ff9800; color: white; }  /* Orange */
            .heatmap-max { background-color: #f57c00; color: white; font-weight: bold; }   /* Dark Orange */
        </style>
            ...
            <div class="col-lg-12">
                ...
                <div class="widgetChartContainer" style="height:auto; min-width:300px; margin: 0 auto">
                    <table class="heatmap-table">
                        <thead>
                            <tr>
                                <th style="text-align: left; min-width: 100px;">Age \ Amount</th>
