...
<div id="PotentialsByAgeAndAmount" class="dashboardWidgetContent">
	{include file="dashboards/PotentialsByAgeAndAmountContents.tpl"|@vtemplate_path:$MODULE_NAME}
</div>
            ...
            <div class="col-sm-12">
                ...
                <div class="col-lg-7">
                    <div class="input-daterange input-group dateRange widgetFilter" id="datepicker" name="createdtime">
                        ...
                        <input type="text" class="input-sm form-control to-input" name="end" style="height:30px;"/>
                    </div>
                </div>
            </div>
        </div>
