      ...
      <div class="row">
        ...
        <div class="col-sx-6 col-sm-6 col-md-4 col-lg-3">
          <div class="highlight-card">
            ...
            <div class="card-footer">
              <div class="status">
                <span>
                  {if $CardDetails[1] == 'New'}New
                  {elseif $CardDetails[1] > 0}+{$CardDetails[1]}%
                  {elseif $CardDetails[1] < 0}{$CardDetails[1]}%
                  {else}0%
                  {/if}
                </span> than last week
        ...
        <div class="col-sx-6 col-sm-6 col-md-4 col-lg-3">
          ...
          <div class="card-footer">
            <div class="status">
              <span>
                {if $LeadCardDetails[1] == 'New'}New
                {elseif $LeadCardDetails[1] > 0}+{$LeadCardDetails[1]}%
                {elseif $LeadCardDetails[1] < 0}{$LeadCardDetails[1]}%
                {else}0%{/if}
      ...
      <div class="col-sx-6 col-sm-6 col-md-4 col-lg-3">
        <div class="highlight-card">
          <div class="highlight-card-header">
            ...
            <div class="highlight-card-content">
              <div>
                <p class="highlight-title">Invoice </p>
              </div>
              <div>
